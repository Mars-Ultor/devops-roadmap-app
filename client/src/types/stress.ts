...
export interface StressEvent {
  eventId: string;
  type: 'distraction' | 'time_warning' | 'documentation_blocked' | 'copy_paste_blocked' | 'external_resource_blocked';
  timestamp: Date;
  message: string;
...
export const STRESS_CONFIG = {
  ...
  documentationUrls: {
    full: ['kubernetes.io', 'docs.docker.com', 'aws.amazon.com', 'terraform.io'],
    core: ['kubernetes.io/docs', 'docs.docker.com/reference', 'aws.amazon.com/console'],
