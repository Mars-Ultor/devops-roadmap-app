          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Real-world incident troubleshooting simulations
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-white font-semibold mb-1">
                  Realistic Incident Response
                </h3>
                <p className="text-sm text-gray-300">
                  Practice diagnosing and resolving production incidents. Each
                  scenario simulates a real-world outage with symptoms,
                ...
                {["all", "beginner", "intermediate", "advanced", "expert"].map(
                  (diff) => (
                    <button
                      key={diff}
                      onClick={() =>
                        setDifficultyFilter(diff as ScenarioDifficulty | "all")
                      }
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <div
                      className={`inline-block px-2 py-1 rounded text-xs font-medium border ${getDifficultyColor(scenario.difficulty)}`}
                    >
                ...
                <div className="bg-gray-900/50 rounded p-3 mb-4">
                  <div className="flex items-center gap-2 mb-1">
                    <AlertTriangle
                      className={`w-4 h-4 ${getImpactColor(scenario.rootCause.impact)}`}
                    />
