...
export default function Lab() {
        ...
        if (weekSnap.exists()) {
          ...
          if (lab) {
            ...
            if (lab.steps && lab.steps.length > 0) {
              ...
              const defaultSteps: LabStep[] = lab.tasks.map(
  ...
  const handleTCSStandardCheck = (standardId: string, met: boolean) => {
    setTcsStandards((prev) =>
      prev.map((std) => (std.id === standardId ? { ...std, met } : std)),
    );
  };
          ...
          <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs font-medium ${
                    labData.difficulty === "beginner"
                      ? "bg-green-600/20 text-green-400"
                      : labData.difficulty === "intermediate"
            ...
            <div className="text-right">
              ...
              <div className="text-sm text-gray-400">
                {labData.estimatedTime} min estimate
              </div>
              <div className="text-sm text-yellow-400 mt-1">
                ⏱️ {Math.floor(timeSpent / 60)}:
                {(timeSpent % 60).toString().padStart(2, "0")} elapsed
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-green-300">
                  You earned {labData.xp} XP! Progress will be saved after AAR
                  completion.
                </p>
              </div>
            </div>
          ...
          <div
            ...
            onKeyDown={(e) => {
              if (e.key === "Escape") {
                ...
                e.stopPropagation();
                alert(
                  "⚠️ AAR is mandatory. Complete it to save your progress.",
                );
              }
            }}
          >
              ...
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-red-300">
                    Complete your AAR to save progress and unlock navigation
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-red-200 text-xs">
                      You cannot leave this page until the AAR is completed.
                      This ensures you reflect on your learning and build better
                      problem-solving skills. Attempting to close or refresh
