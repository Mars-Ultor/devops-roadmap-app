    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "DevOps aims to shorten the development lifecycle while delivering features, fixes, and updates frequently in close alignment with business objectives.",
      },
      {
        question: "Which Linux directory contains user home directories?",
        options: ["/usr", "/var", "/home", "/etc"],
        correctAnswer: 2,
        explanation:
          "The /home directory contains individual home directories for each user on the system.",
      },
      {
        question:
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "DevOps emphasizes automation, not manual-only deployments. Automation reduces human error and speeds up processes.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "The root user is the superuser with unrestricted access to all commands, files, and resources on the system.",
      },
      {
        question:
          "Which directory typically contains system-wide configuration files?",
        options: ["/bin", "/tmp", "/etc", "/opt"],
        correctAnswer: 2,
        explanation:
          "The /etc directory contains system-wide configuration files for the operating system and installed software.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "CI/CD stands for Continuous Integration and Continuous Delivery, key practices in DevOps for automating software development.",
      },
      {
        question: "Which Linux distribution is optimized for AWS?",
        options: ["Ubuntu", "CentOS", "Amazon Linux", "Debian"],
        correctAnswer: 2,
        explanation:
          "Amazon Linux is a distribution specifically optimized for running on Amazon Web Services (AWS).",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "An absolute path starts with / and specifies the complete path from the root directory (e.g., /home/user/file.txt).",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Linux is crucial for DevOps because it's open-source, powers most servers worldwide, offers stability, security, and flexibility.",
      },
    ],
  },
  "week2-quiz": {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "git pull fetches changes from remote AND merges them, while git fetch only downloads changes without merging.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A branch in Git is a parallel version of the repository, allowing you to work on features independently.",
      },
      {
        ...
        correctAnswer: 3,
        explanation:
          'Both "git checkout -b feature" and "git switch --create feature" create and switch to a new branch in one command.',
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A merge conflict occurs when Git cannot automatically merge changes because the same lines were modified in different ways.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          ".gitignore specifies files and folders that Git should not track or commit (like node_modules, .env files).",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A Pull Request is a GitHub feature that allows you to notify others about changes you've pushed and request code review before merging.",
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "git clone downloads a complete copy of a remote repository to your local machine, including all history and branches.",
      },
    ],
  },
  "week3-quiz": {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "EC2 (Elastic Compute Cloud) provides resizable virtual servers (instances) in AWS cloud.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "S3 (Simple Storage Service) is an object storage service for storing and retrieving any amount of data.",
      },
      {
      ...
      },
      {
        ...
        options: ["us-west-1", "us-east-1", "eu-west-1", "ap-south-1"],
        correctAnswer: 1,
        explanation:
          "us-east-1 is the region code for US East (N. Virginia), often the default region for AWS services.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "AWS Free Tier provides limited free access to AWS services for 12 months to help you explore and learn.",
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "An S3 bucket is a container for storing objects (files) in Amazon S3. Each bucket has a unique name.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "CloudWatch monitors AWS resources and applications, collecting metrics, logs, and setting alarms.",
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "An AMI (Amazon Machine Image) is a template containing the software configuration for launching EC2 instances.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Least privilege means granting only the minimum permissions required for users to perform their tasks, improving security.",
      },
    ],
  },
  "week4-quiz": {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "An IP address is a unique numerical label assigned to each device on a network for identification and communication.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "HTTPS is HTTP with encryption using SSL/TLS, securing data transmission between client and server.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "A CDN (Content Delivery Network) is a geographically distributed network of servers that deliver content to users faster.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Route 53 is AWS's scalable DNS web service for domain registration and routing internet traffic.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "TTL (Time To Live) specifies how long DNS records should be cached before refreshing.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "CloudFront is AWS's CDN that caches content at edge locations worldwide for faster delivery.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "SSL/TLS certificates encrypt data in transit and verify the identity of websites, enabling HTTPS.",
      },
    ],
  },
  "week5-quiz": {
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "Python is known for its clean, readable syntax and versatility across automation, web dev, data science, and DevOps.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          'pip is a recursive acronym for "Pip Installs Packages" - Python\'s package installer.',
      },
      {
      ...
      },
      {
        ...
        options: ["http-lib", "requests", "urllib3-only", "fetch"],
        correctAnswer: 1,
        explanation:
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "boto3 is the AWS SDK for Python, allowing you to interact with AWS services programmatically.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          'Use "import module_name" to import modules in Python (e.g., import requests, import boto3).',
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Python is popular for DevOps due to readable syntax, extensive libraries (boto3, requests), and cross-platform compatibility.",
      },
    ],
  },
  "week6-quiz": {
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "Serverless means the cloud provider manages infrastructure, allowing you to focus on code without server management.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "Lambda pricing is based on the number of requests and compute time (GB-seconds) your functions consume.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A trigger is an event (like S3 upload, API call, schedule) that invokes a Lambda function.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "DynamoDB is a fully managed NoSQL database service that provides fast, predictable performance with seamless scalability.",
      },
      {
        question: "What is the maximum execution time for a Lambda function?",
        options: ["5 seconds", "1 minute", "15 minutes", "Unlimited"],
        correctAnswer: 2,
        explanation:
          "Lambda functions can run for a maximum of 15 minutes before timing out.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Lambda supports multiple languages including Python, Node.js, Java, Go, Ruby, .NET, and custom runtimes.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Cold start is the latency that occurs when Lambda initializes a new execution environment for a function that hasn't run recently.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "API Gateway is an AWS service for creating, publishing, maintaining, and securing APIs at scale, often used with Lambda.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Key benefits include pay-per-use pricing, automatic scaling, and no server management overhead.",
      },
    ],
  },
  "week10-quiz": {
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "CI stands for Continuous Integration - automatically building and testing code changes.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "CI aims to automatically build and test code changes frequently to catch issues early.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A GitHub Actions workflow is an automated process defined in YAML that runs in response to events.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Workflows can be triggered by various events including push, pull_request, schedule (cron), and manual triggers.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A runner is a server (GitHub-hosted or self-hosted) that executes jobs in your workflows.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Continuous Delivery means code is automatically deployed to staging environments, with manual approval for production.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Continuous Deployment automatically deploys every change that passes tests directly to production without manual intervention.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A build artifact is the output of a build process, such as compiled code, packaged applications, or Docker images.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Automated testing in CI/CD catches bugs early, ensures code quality, and provides confidence when deploying.",
      },
    ],
  },
  "week11-quiz": {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A container is a lightweight, standalone executable package containing everything needed to run an application.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "docker build creates an image from a Dockerfile (e.g., docker build -t myapp .).",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Docker Hub is a cloud-based registry service for sharing and storing Docker images.",
      },
      {
        question:
        ...
        correctAnswer: 1,
        explanation:
          "ENTRYPOINT sets the main command to run, while CMD provides default arguments that can be overridden.",
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "docker run creates and starts a container from an image (e.g., docker run -p 8080:80 nginx).",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Multi-stage builds create smaller production images by excluding build tools and intermediate files.",
      },
      {
    ...
    questions: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "Monitoring involves tracking system performance, availability, and health through metrics, logs, and alerts.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "The three pillars of observability are Logs (events), Metrics (measurements), and Traces (request flows).",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A CloudWatch alarm monitors a metric and triggers actions (notifications, auto-scaling) when thresholds are breached.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Terraform is an IaC tool that allows you to define and provision infrastructure using declarative configuration files.",
      },
      {
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Log aggregation centralizes logs from multiple services/servers for easier searching, analysis, and monitoring.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A monitoring dashboard visualizes key metrics, performance data, and alerts in real-time for quick insights.",
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "SRE is a discipline that applies software engineering practices to infrastructure and operations problems.",
      },
    ],
  },
};
