...
const LEADERSHIP_SCENARIOS: LeadershipScenario[] = [
  {
    ...
    description:
      "Lead communication during a major production outage affecting 1M+ users. Manage stakeholder expectations, coordinate cross-functional teams, and maintain team morale.",
    ...
    decisionPoints: [
      {
        id: "initial-response",
        situation:
          "Major outage detected. Engineering team is panicking. CEO is demanding immediate answers. What do you do first?",
        options: [
          {
          ...
          },
          {
            ...
            impact: "neutral",
            explanation:
              "Balances information gathering with timely communication",
          },
        ],
      ...
      },
      {
        id: "team-conflict",
        situation:
          "Two senior engineers are arguing about the root cause publicly in Slack. The debate is demoralizing the team. How do you handle this?",
        options: [
          {
            id: "take-offline",
            ...
            impact: "positive",
            explanation:
              "Maintains professionalism and team morale while allowing technical discussion",
          },
          {
            id: "pick-side",
          ...
          },
          {
            ...
            impact: "negative",
            explanation:
              "Passive leadership allows conflict to damage team morale",
          },
        ],
      ...
      },
      {
        id: "customer-update",
        situation:
          'It\'s been 45 minutes. Customers are demanding updates. Engineering says they need "just 15 more minutes". What do you communicate?',
        options: [
          {
            ...
            impact: "positive",
            explanation:
              "Builds trust through transparency while managing expectations",
          },
          {
            id: "delay-update",
      ...
      },
      {
        ...
        situation:
          "A junior engineer wants to help but doesn't have production access. The DBA is overwhelmed. What do you do?",
        options: [
          {
            ...
            impact: "neutral",
            explanation:
              "Balances help with risk, but may violate security policies",
          },
          {
          ...
          },
          {
            ...
            impact: "negative",
            explanation:
              "Wastes available resources and demotivates team member",
          },
        ],
      ...
      },
      {
        ...
        situation:
          "Issue is resolved! How do you close out the incident communication?",
        options: [
          {
            ...
            impact: "positive",
            explanation:
              "Professional closure with accountability and recognition",
          },
          {
            id: "quick-message",
            ...
            impact: "neutral",
            explanation:
              "Gets the job done but misses opportunity for team recognition",
          },
          {
            id: "blame-message",
            ...
            impact: "negative",
            explanation:
              "Blame culture damages team trust and psychological safety",
          },
        ],
        correctOptionId: "comprehensive-closeout",
        timePressure: 90,
        leadershipPrinciple:
          "Close incidents with recognition and accountability",
      },
    ],
  },
  {
    ...
    description:
      "Manage a complex incident requiring specialized expertise. Delegate effectively while maintaining oversight and accountability.",
    difficulty: "advanced",
    ...
    decisionPoints: [
      {
        id: "database-expert",
        situation:
          "Database corruption detected. Your DBA is overwhelmed. Junior engineer offers to help but lacks experience.",
        options: [
          {
            id: "take-over",
            ...
            impact: "negative",
            explanation:
              "Micromanaging prevents team growth and creates bottleneck",
          },
          {
            id: "pair-programming",
      ...
      },
      {
        ...
        situation:
          "Half your team is in different time zones. The on-call person in India needs guidance but it's 3 AM their time. How do you coordinate?",
        options: [
          {
            id: "wake-everyone",
            ...
            impact: "negative",
            explanation:
              "Burns out the team and creates unsustainable on-call culture",
          },
          {
            id: "async-command",
            ...
            impact: "positive",
            explanation:
              "Empowers global team with clear authority and boundaries",
          },
          {
            id: "wait-morning",
            ...
            impact: "negative",
            explanation:
              "Delays response and shows lack of trust in remote team",
          },
        ],
      ...
      },
      {
        id: "expertise-gap",
        situation:
          "The issue requires Kubernetes expertise but your K8s expert is on vacation. What do you do?",
        options: [
          {
            id: "recall-expert",
            ...
            impact: "negative",
            explanation:
              "Disrupts work-life balance and indicates poor succession planning",
          },
          {
            id: "vendor-support",
            ...
            impact: "positive",
            explanation:
              "Leverages external expertise while developing team skills",
          },
          {
            id: "trial-error",
      ...
      },
      {
        ...
        situation:
          "Multiple critical tasks need attention: database recovery, log analysis, customer communication, and vendor coordination. You have 4 people. How do you delegate?",
        options: [
          {
            id: "clear-assignment",
      ...
      },
      {
        ...
        situation:
          "Your lead engineer wants to roll back the deployment, but the product manager insists on trying a quick fix first. They're asking you to decide.",
        options: [
          {
          ...
          },
          {
            ...
            impact: "negative",
            explanation:
              "Overriding technical judgment during crisis damages trust",
          },
        ],
        correctOptionId: "technical-authority",
        timePressure: 90,
        leadershipPrinciple:
          "Trust technical expertise during technical crises",
      },
    ],
  },
  {
    ...
    description:
      "Navigate complex stakeholder dynamics during a critical incident. Balance technical reality with business expectations.",
    difficulty: "expert",
    ...
    decisionPoints: [
      {
        id: "revenue-impact",
        situation:
          "Outage costing $50K/minute. CFO demands immediate revenue restoration. Engineering says it needs 2 hours for proper fix.",
        options: [
          {
            id: "rush-fix",
          ...
          },
          {
            ...
            impact: "positive",
            explanation:
              "Balances business needs with technical best practices",
          },
          {
            id: "compromise",
      ...
      },
      {
        ...
        situation:
          "CEO wants you to present to the board in 30 minutes about the outage. You're still managing the incident. What do you do?",
        options: [
          {
            ...
            impact: "positive",
            explanation:
              "Balances stakeholder management with operational needs",
          },
          {
            id: "decline-meeting",
            ...
            impact: "negative",
            explanation:
              "May be technically correct but damages executive relationships",
          },
          {
            id: "split-attention",
      ...
      },
      {
        id: "media-inquiry",
        situation:
          "Tech media outlet is running a story about the outage. PR team asks for technical details. What information do you share?",
        options: [
          {
          ...
          },
          {
            ...
            impact: "negative",
            explanation:
              "Too much technical detail confuses public and may expose vulnerabilities",
          },
          {
            id: "no-comment",
        ...
        timePressure: 180,
        leadershipPrinciple:
          "Coordinate external communications professionally",
      },
      {
        id: "customer-escalation",
        situation:
          "Your largest enterprise customer (40% of revenue) is threatening to leave. Their CEO is on the phone demanding personal attention. What do you do?",
        options: [
          {
            ...
            impact: "positive",
            explanation:
              "Strategic customer management without compromising incident response",
          },
          {
            id: "treat-equal",
            ...
            impact: "negative",
            explanation:
              "Technically fair but ignores business reality of key accounts",
          },
          {
            id: "prioritize-fix",
            ...
            impact: "negative",
            explanation:
              "Damages critical business relationship during vulnerable moment",
          },
        ],
        correctOptionId: "personal-attention",
        timePressure: 150,
        leadershipPrinciple:
          "Balance technical response with strategic relationships",
      },
      {
        id: "blame-accountability",
        situation:
          'CFO demands to know "who is responsible for this disaster". The issue was caused by a process gap, not individual error. How do you respond?',
        options: [
          {
            id: "systems-thinking",
            ...
            impact: "positive",
            explanation:
              "Demonstrates leadership accountability and systems thinking",
          },
          {
            id: "name-engineer",
          ...
          },
          {
            ...
            impact: "negative",
            explanation:
              "Deflects responsibility instead of showing leadership",
          },
        ],
        correctOptionId: "systems-thinking",
        timePressure: 120,
        leadershipPrinciple:
          "Take leadership accountability for systemic issues",
      },
    ],
  },
];
...
export default function LeadershipCommand() {
  ...
  const [selectedScenario, setSelectedScenario] =
    useState<LeadershipScenario | null>(null);
  const [currentAttempt, setCurrentAttempt] =
    useState<LeadershipAttempt | null>(null);
  const [currentDecisionPoint, setCurrentDecisionPoint] =
    useState<DecisionPoint | null>(null);
  ...
  const makeDecision = (optionId: string) => {
    ...
    const selectedOption = currentDecisionPoint.options.find(
      (o) => o.id === optionId,
    );
    if (selectedOption) {
  ...
  const updateLeadershipMetrics = (option: LeadershipOption) => {
    ...
    Object.keys(updates).forEach((key) => {
      updates[key as keyof typeof updates] = Math.max(
        0,
        Math.min(100, updates[key as keyof typeof updates]),
      );
    });
  ...
  const calculateLeadershipScore = (): number => {
    ...
    const correctDecisions = decisions.filter((decision) => {
      const dp = selectedScenario.decisionPoints.find(
        (p) => p.id === decision.decisionPointId,
      );
    ...
    const avgMetrics =
      (leadershipMetrics.communication +
        leadershipMetrics.delegation +
        leadershipMetrics.decisionMaking +
        leadershipMetrics.teamMorale) /
      4;
  ...
  const generateLeadershipFeedback = (): string => {
    ...
    if (leadershipMetrics.communication > 70)
      strengths.push("excellent communication skills");
    else if (leadershipMetrics.communication < 40)
      improvements.push("communication effectiveness");

    if (leadershipMetrics.delegation > 70)
      strengths.push("strong delegation abilities");
    else if (leadershipMetrics.delegation < 40)
      improvements.push("delegation and trust in team");

    if (leadershipMetrics.decisionMaking > 70)
      strengths.push("effective decision-making under pressure");
    else if (leadershipMetrics.decisionMaking < 40)
      improvements.push("decision-making confidence");

    if (leadershipMetrics.teamMorale > 70)
      strengths.push("team morale management");
    else if (leadershipMetrics.teamMorale < 40)
      improvements.push("team motivation and morale");
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-200">
              Phase 2.6: Advanced Leadership & Incident Command
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Master incident command, team leadership, and crisis
                communication
              </p>
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-gray-300 space-y-1">
                        {scenario.communicationChallenges
                          .slice(0, 3)
                          .map((challenge) => (
                            <li
                              key={challenge}
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl font-bold">
                    Leadership Command Briefing
                  </h2>
                  <p className="text-gray-400">
                    Prepare to lead through crisis and command
                  </p>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-slate-700 p-3 rounded">
                        <div className="text-2xl font-bold text-green-400">
                          {Math.floor(selectedScenario.timeLimit / 60)}m
                        </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-slate-700/50 p-4 rounded">
                      ...
                      <p className="text-sm text-gray-300">
                        Clear, concise, and timely information flow
                      </p>
                    </div>
                    <div className="bg-slate-700/50 p-4 rounded">
                      <h4 className="font-semibold text-yellow-400 mb-2">
                      ...
                      <p className="text-sm text-gray-300">
                        Balance speed with quality under pressure
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {currentDecisionPoint ? (
                <div className="bg-slate-800/80 backdrop-blur rounded-xl p-8 border border-red-500">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Time pressure: {currentDecisionPoint.timePressure}s
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-red-900/20 border border-red-500 rounded-lg p-6 mb-6">
                    ...
                    <p className="text-red-200 text-lg leading-relaxed">
                      {currentDecisionPoint.situation}
                    </p>
                  </div>

                  <div className="space-y-4">
                    <h4 className="text-xl font-semibold">
                      Choose your leadership approach:
                    </h4>
                        ...
                        <div className="flex items-start gap-4">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <span
                                className={`px-2 py-1 rounded text-xs ${getLeadershipStyleClassName(option.leadershipStyle)}`}
                              >
                                {option.leadershipStyle}
                              </span>
                              <span
                                className={`px-2 py-1 rounded text-xs ${getImpactClassName(option.impact)}`}
                              >
                ...
                <div className="bg-slate-800/80 backdrop-blur rounded-xl p-8 border border-green-500 text-center">
                  ...
                  <p className="text-gray-300">
                    Processing your leadership decisions...
                  </p>
                </div>
              )}
            </div>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-slate-700 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${leadershipMetrics.decisionMaking}%`,
                        }}
                      />
                    </div>
                  </div>
                    ...
                    <div className="w-full bg-slate-700 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full transition-all ${
                          leadershipMetrics.teamMorale > 70
                            ? "bg-green-500"
                            : leadershipMetrics.teamMorale > 40
                              ? "bg-yellow-500"
                              : "bg-red-500"
                        }`}
              ...
              <div className="bg-slate-800/80 backdrop-blur rounded-xl p-4 border border-purple-500">
                ...
                <div className="max-h-64 overflow-y-auto space-y-2">
                  {decisions.map((decision) => {
                    ...
                    return (
                      <div
                        key={`${decision.decisionPointId}-${decision.selectedOptionId}`}
                        className="bg-slate-700/50 p-2 rounded text-sm"
                      >
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-2xl text-gray-400">
                  Final Score: {currentAttempt.score}/100
                </p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-gray-300 space-y-1">
                      ...
                      <li>
                        • Study different leadership styles and their
                        applications
                      </li>
                      <li>
                        • Focus on building trust and psychological safety in
                        teams
                      </li>
