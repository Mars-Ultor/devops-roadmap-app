...
export default function Projects() {
  const [cloudResumeChallenge, setCloudResumeChallenge] =
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300">
            Build real-world projects that demonstrate your DevOps expertise to
            employers
          </p>
        </div>
          ...
          <div className="mb-12 bg-gradient-to-br from-indigo-900/50 via-purple-900/50 to-pink-900/50 rounded-2xl p-8 border-2 border-indigo-500/50 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-gray-200 text-lg mb-8 leading-relaxed">
                {cloudResumeChallenge.description}
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {cloudResumeChallenge.phases?.map((phase: unknown) => (
                  <div
                    key={`phase-${(phase as { phase: number }).phase}`}
                    className="bg-slate-800/80 rounded-xl p-6 border border-slate-600 hover:border-indigo-400 transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/20"
                  >
                      ...
                      <div>
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="text-xs text-gray-400 font-medium">
                            Week {(phase as { week: number }).week}
                          </span>
                        </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {cloudResumeChallenge.skills?.map((skill: string) => (
                    <span
                      key={skill}
                      className="bg-gradient-to-r from-indigo-600/40 to-purple-600/40 text-indigo-200 px-4 py-2 rounded-lg text-sm border border-indigo-500/50 font-medium hover:border-indigo-400 transition"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {otherProjects.map((project) => (
              <div
                key={project.id}
                className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 border border-slate-700 hover:border-green-500 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/10 hover:scale-105"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs text-gray-400 font-medium bg-slate-700 px-2 py-1 rounded">
                        Week {project.week}
                      </span>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Generate resume bullets, LinkedIn summary, and portfolio website
                content from your completed projects.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span className="text-gray-300">
                    ATS-optimized resume bullets tailored to DevOps roles
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span className="text-gray-300">
                    LinkedIn profile sections highlighting your projects
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                  <span className="text-gray-300">
                    Portfolio website generator with deployment guide
                  </span>
                </li>
              </ul>
