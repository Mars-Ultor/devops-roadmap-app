...
export default function CapstoneSimulation() {
  ...
  const startSimulation = () => {
    ...
    if (newAttempt) {
      ...
      addCommunication({
        ...
        message:
          "🚨 CRITICAL: Global production outage detected. All services down.",
        priority: "critical",
      });
    }
  };
  ...
  const addCommunication = (
    comm: Omit<CommunicationLog, "id" | "timestamp">,
  ) => {
  ...
  const completeObjective = (objectiveId: string) => {
    if (!completedObjectives.includes(objectiveId)) {
      ...
      addTimelineEntry(
        `Objective completed: ${selectedScenario?.objectives[Number.parseInt(objectiveId.split("_")[1])]}`,
      );
    }
  };
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-purple-200">
              4-hour production incident command simulation
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Lead the response to a catastrophic production incident as
                Incident Commander
              </p>
            </div>
                ...
                >
                  ...
                  <div className="bg-red-900/20 border border-red-500 rounded-lg p-4">
                    ...
                    <p className="text-red-200 text-sm">
                      This simulation represents a real production disaster.
                      Your decisions will determine business continuity,
                      customer trust, and millions in revenue. Act decisively.
                    </p>
                  </div>
                </div>
              ))}
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    You are now in command of this critical incident
                  </p>
                </div>
              </div>
            ...
            <div className="xl:col-span-3 space-y-6">
              ...
              <div className="bg-slate-800/80 backdrop-blur rounded-xl p-6 border border-red-500">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-red-400">
                      {incidentMetrics.affectedUsers.toLocaleString()}
                    </div>
                    <div className="text-sm text-gray-400">Users Affected</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-yellow-400">
                      ${incidentMetrics.revenueImpact.toLocaleString()}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-400">
                      {Math.floor(
                        (Date.now() - incidentMetrics.startTime.getTime()) /
                          (1000 * 60),
                      )}
                      m
                    </div>
              ...
              <div className="bg-slate-800/80 backdrop-blur rounded-xl p-6 border border-green-500">
                <h3 className="text-xl font-bold mb-4 text-green-400 flex items-center gap-2">
                  ...
                  Critical Objectives ({completedObjectives.length}/
              ...
              <div className="bg-slate-800/80 backdrop-blur rounded-xl p-4 border border-purple-500">
                ...
                <div className="max-h-48 overflow-y-auto space-y-1">
                  {incidentTimeline.slice(-8).map((entry) => (
                    <div
                      key={entry}
                      className="text-xs text-gray-300 py-1 border-l border-purple-500 pl-2"
                    >
                      {entry}
                    </div>
                  ))}
            ...
            >
              <div className="text-center mb-8">
                ...
                <h2 className="text-4xl font-bold mb-2">
                  {attempt.passed
                    ? "Incident Commander Victory!"
                    : "Incident Escalated"}
                </h2>
                <p className="text-2xl text-gray-400">
                  Final Score: {attempt.score}/100
                </p>
              </div>
              ...
              <div className="bg-slate-800/50 p-6 rounded mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-gray-300 space-y-1">
                      <li>
                        • Incident command requires clear communication channels
                      </li>
                      <li>
                        • Stakeholder expectations must be managed proactively
                      </li>
                      <li>
                        • Technical decisions impact business outcomes
                        significantly
                      </li>
                      <li>
                        • Team morale and confidence are critical during
                        extended incidents
                      </li>
                    </ul>
                  </div>
