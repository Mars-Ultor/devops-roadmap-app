                ...
                <div className="mb-4 max-h-24 overflow-hidden relative">
                  <ReactMarkdown
                    components={{
                      h1: (props) => (
                        <h1
                          className="text-lg font-bold text-white my-1"
                          {...props}
                        />
                      ),
                      h2: (props) => (
                        <h2
                          className="text-base font-bold text-white my-1"
                          {...props}
                        />
                      ),
                      h3: (props) => (
                        <h3
                          className="text-sm font-semibold text-white my-0.5"
                          {...props}
                        />
                      ),
                      h4: (props) => (
                      ...
                      p: (props) => (
                        <p
                          className="text-slate-300 text-sm leading-relaxed my-0.5"
                          {...props}
                        />
                      ),
                      strong: (props) => (
                      ...
                      code: (props: React.HTMLAttributes<HTMLElement>) => (
                        <code
                          className="text-indigo-300 bg-slate-900 px-1 py-0.5 rounded text-xs font-mono"
                          {...props}
                        />
                      ),
                      ul: (props) => (
                        <ul className="my-0.5 pl-4 list-disc" {...props} />
                      ),
                      ol: (props) => (
                        <ol className="my-0.5 pl-4 list-decimal" {...props} />
                      ),
                      li: (props) => (
                        <li className="text-slate-300 text-sm" {...props} />
                      ),
                      a: (props) => (
                        <a className="text-indigo-400" {...props} />
                      ),
                      blockquote: (props) => (
                        <blockquote
                          className="text-slate-400 border-l-2 border-indigo-500 pl-2"
                          {...props}
                        />
                      ),
                    }}
