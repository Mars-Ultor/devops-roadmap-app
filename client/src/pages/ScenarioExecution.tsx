...
export default function ScenarioExecution() {
  ...
  const getPhaseIndicatorClassName = (
    phaseName: string,
    currentPhase: string,
    index: number,
  ): string => {
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex items-center gap-2 mb-6 overflow-x-auto">
          {[
            ...
            >
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${getPhaseCircleClassName(p, phase, index)}`}
              >
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                {scenario.symptoms.map((symptom) => (
                  <div
                    key={`${symptom.type}-${symptom.description}`}
                    className="bg-gray-900/50 border border-gray-700 rounded p-4"
                  >
          ...
          <div className="space-y-6">
            <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4">
              ...
              <p className="text-gray-300">
                Complete investigation steps to gather information. Use hints
                wisely - each one costs points!
              </p>
            </div>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-400">
                          ...
                          <span>
                            Est. {Math.floor(step.timeEstimate / 60)} min
                          </span>
                        </div>
                      </div>
                      {completed && (
            ...
            >
              Proceed to Diagnosis ({selectedSteps.size}/
              {scenario.investigationSteps.length} steps completed)
            </button>
          </div>
        )}
        ...
        {phase === "diagnosis" && (
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
            ...
            <p className="text-gray-300 mb-6">
              Based on your investigation, what is the root cause of this
              incident?
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-4">
                Lessons Learned (minimum 20 characters each)
              </h3>
            ...
            <button
              ...
              disabled={
                selectedSteps.size <
                  scenario.investigationSteps.length +
                    scenario.resolutionSteps.length ||
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-gray-900/50 rounded-lg p-4 text-center">
                ...
                <div className="text-3xl font-bold text-blue-400">
                  {currentAttempt.efficiency}%
                </div>
              </div>
              <div className="bg-gray-900/50 rounded-lg p-4 text-center">
                <div className="text-gray-400 text-sm mb-1">Accuracy</div>
                <div className="text-3xl font-bold text-green-400">
                  {currentAttempt.accuracyScore}%
                </div>
              </div>
            </div>
