...
export default function Resources() {
  ...
  const cheatSheets = [
    ...
    },
    {
      ...
      commands: [
        ...
        { cmd: 'docker run -p 8080:80 image', desc: 'Run container with port mapping' },
    ...
    },
    {
      ...
      commands: [
        ...
        { cmd: 'aws s3 sync ./dist s3://bucket/', desc: 'Sync directory to S3' },
        { cmd: 'aws ec2 describe-instances', desc: 'List EC2 instances' },
        { cmd: 'aws lambda list-functions', desc: 'List Lambda functions' },
        { cmd: 'aws lambda invoke --function-name <name>', desc: 'Invoke Lambda' },
        { cmd: 'aws iam list-users', desc: 'List IAM users' },
        { cmd: 'aws logs tail <log-group> --follow', desc: 'Tail CloudWatch logs' },
  ...
  const glossary = [
    { term: 'API', definition: 'Application Programming Interface - allows programs to communicate with each other' },
    { term: 'CI/CD', definition: 'Continuous Integration/Continuous Delivery - automated software delivery pipeline' },
    { term: 'Container', definition: 'Lightweight, standalone package that includes application code and dependencies' },
    { term: 'Deployment', definition: 'Process of making software available for use' },
    ...
    { term: 'IAM', definition: 'Identity and Access Management - controls who can access what in AWS' },
    { term: 'IaC', definition: 'Infrastructure as Code - managing infrastructure through code files' },
    { term: 'Kubernetes', definition: 'Container orchestration platform for automating deployment and scaling' },
    { term: 'Lambda', definition: 'AWS serverless compute service - run code without managing servers' },
    { term: 'Load Balancer', definition: 'Distributes incoming traffic across multiple servers' },
    { term: 'Microservices', definition: 'Architectural style with small, independent services' },
    { term: 'Monitoring', definition: 'Observing system performance and health metrics' },
    { term: 'S3', definition: 'Simple Storage Service - AWS object storage' },
    { term: 'Serverless', definition: 'Cloud execution model where provider manages infrastructure' },
    { term: 'SSH', definition: 'Secure Shell - encrypted network protocol for secure remote login' },
    { term: 'VPC', definition: 'Virtual Private Cloud - isolated network in AWS' }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Essential interview questions, command cheat sheets, and DevOps terminology to help you succeed
          </p>
        </div>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">Common Interview Questions</h2>
          </div>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">Command Cheat Sheets</h2>
          </div>
        ...
        <section className="mt-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">DevOps Resume Templates</h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {/* Entry-Level Resume */}
            <div className="bg-slate-800 rounded-lg p-6 border border-slate-700 hover:border-indigo-500 transition">
              <h3 className="text-xl font-semibold text-indigo-400 mb-4">Entry-Level DevOps Engineer</h3>
              <div className="space-y-4 text-sm text-slate-300">
                <div>
                  <p className="font-semibold text-white mb-2">Summary Example:</p>
                  <p className="text-slate-400 italic bg-slate-900 p-3 rounded">
                    "Recent graduate with hands-on experience in AWS, Docker, and CI/CD pipelines. Completed Cloud Resume Challenge demonstrating proficiency in serverless architecture, Infrastructure as Code (Terraform), and automated deployments. Passionate about automation and continuous learning in DevOps practices."
                  </p>
                </div>
                
                <div>
                  <p className="font-semibold text-white mb-2">Skills Section:</p>
                  <ul className="list-disc list-inside text-slate-400 space-y-1 ml-2">
                    <li><strong>Cloud:</strong> AWS (EC2, S3, Lambda, DynamoDB, CloudFront, Route 53)</li>
                    <li><strong>Containers:</strong> Docker, Docker Compose</li>
                    <li><strong>CI/CD:</strong> GitHub Actions, automated testing & deployment</li>
                    <li><strong>IaC:</strong> Terraform, CloudFormation basics</li>
                    <li><strong>Languages:</strong> Python, Bash, JavaScript (basic)</li>
                    <li><strong>Version Control:</strong> Git, GitHub</li>
                    <li><strong>OS:</strong> Linux (Ubuntu, Amazon Linux)</li>
                  </ul>
                </div>

                <div>
                  <p className="font-semibold text-white mb-2">Project Example:</p>
                  <div className="bg-slate-900 p-3 rounded text-slate-400">
                    <p className="font-semibold text-indigo-400">Cloud Resume Challenge</p>
                    <ul className="list-disc list-inside mt-2 space-y-1 ml-2">
                      <li>Built serverless resume website with visitor counter using AWS Lambda, DynamoDB, and CloudFront</li>
                      <li>Implemented CI/CD pipeline with GitHub Actions for automated deployments</li>
                      <li>Provisioned infrastructure using Terraform (S3, CloudFront, Lambda, API Gateway)</li>
                      <li>Achieved 99.9% uptime with CloudWatch monitoring and automated alerts</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-800 rounded-lg p-6 border border-slate-700 hover:border-green-500 transition">
              <h3 className="text-xl font-semibold text-green-400 mb-4">Mid-Level DevOps Engineer</h3>
              <div className="space-y-4 text-sm text-slate-300">
                <div>
                  <p className="font-semibold text-white mb-2">Summary Example:</p>
                  <p className="text-slate-400 italic bg-slate-900 p-3 rounded">
                    "DevOps Engineer with 2+ years of experience automating deployments and managing cloud infrastructure. Proven track record of reducing deployment time by 60% through CI/CD pipeline optimization. Skilled in Kubernetes, Terraform, and AWS with strong focus on security and cost optimization."
                  </p>
                </div>
                
                <div>
                  <p className="font-semibold text-white mb-2">Achievement Examples:</p>
                  <ul className="list-disc list-inside text-slate-400 space-y-2 ml-2">
                    <li>Reduced deployment time from 45 minutes to 15 minutes by implementing parallel testing and optimized Docker builds</li>
                    <li>Cut AWS costs by 35% through resource rightsizing, reserved instances, and automated shutdown schedules</li>
                    <li>Achieved 99.95% uptime SLA by implementing comprehensive monitoring and automated failover</li>
                    <li>Migrated 15 microservices to Kubernetes, improving scalability and resource utilization by 40%</li>
                  </ul>
                </div>

                <div>
                  <p className="font-semibold text-white mb-2">Advanced Skills:</p>
                  <ul className="list-disc list-inside text-slate-400 space-y-1 ml-2">
                    <li><strong>Orchestration:</strong> Kubernetes (EKS), Helm, ArgoCD</li>
                    <li><strong>Monitoring:</strong> Prometheus, Grafana, ELK Stack, CloudWatch</li>
                    <li><strong>Security:</strong> IAM, Secrets management (Vault), security scanning</li>
                    <li><strong>Automation:</strong> Ansible, Python scripting, Bash</li>
                    <li><strong>Databases:</strong> RDS, DynamoDB, Redis</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 bg-blue-900/20 border border-blue-600/30 rounded-lg p-6">
            <h4 className="text-lg font-semibold text-blue-400 mb-3">💡 Resume Tips for DevOps Roles</h4>
            <ul className="space-y-2 text-sm text-slate-300">
              <li className="flex items-start gap-2">
                <span className="text-blue-400 mt-1">✓</span>
                <span><strong>Quantify achievements:</strong> Use metrics (% reduction, time saved, uptime %, cost savings)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-400 mt-1">✓</span>
                <span><strong>Use action verbs:</strong> Automated, Implemented, Optimized, Reduced, Migrated, Designed</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-400 mt-1">✓</span>
                <span><strong>Show tools & technologies:</strong> List specific tools you've used (Docker, Kubernetes, Terraform, etc.)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-400 mt-1">✓</span>
                <span><strong>Include certifications:</strong> AWS, Azure, CKA, CKAD boost credibility</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-400 mt-1">✓</span>
                <span><strong>Link to projects:</strong> GitHub, deployed apps, portfolio sites (Cloud Resume!)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-400 mt-1">✓</span>
                <span><strong>Tailor to job description:</strong> Match keywords from the job posting</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="mt-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-white">12-Week Study Schedule</h2>
          </div>

          <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
            <p className="text-slate-300 mb-6">
              Follow this schedule to complete the DevOps Roadmap program in 3 months. Adjust the pace based on your availability.
            </p>

            <div className="space-y-6">
              {/* Schedule Overview */}
              <div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 border border-yellow-600/30 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-yellow-400 mb-4">Recommended Time Commitment</h3>
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div className="bg-slate-900 rounded-lg p-4">
                    <p className="text-yellow-400 font-semibold mb-2">Full-Time (40h/week)</p>
                  ...
                  <div className="bg-slate-900 rounded-lg p-4">
                    <p className="text-green-400 font-semibold mb-2">Part-Time (20h/week)</p>
                  ...
                  <div className="bg-slate-900 rounded-lg p-4">
                    <p className="text-blue-400 font-semibold mb-2">Casual (10h/week)</p>
              ...
              {/* Weekly Breakdown */}
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-white">Week-by-Week Plan (Part-Time Schedule)</h3>
                
                {[
                  { week: 1, title: 'DevOps Foundations & Linux', hours: '15-20h', tasks: ['Complete all 3 lessons', 'Finish 3 labs', 'Take Week 1 quiz (70%+ required)', 'Set up AWS free tier account'] },
                  { week: 2, title: 'Version Control with Git & GitHub', hours: '15-20h', tasks: ['Learn Git fundamentals', 'Create GitHub account & repos', 'Complete 3 labs', 'Pass Week 2 quiz'] },
                  { week: 3, title: 'Cloud Fundamentals with AWS', hours: '15-20h', tasks: ['Launch EC2 instances', 'Work with S3 buckets', 'Understand IAM', 'Complete labs & quiz'] },
                  { week: 4, title: 'Networking & DNS Basics', hours: '15-20h', tasks: ['Learn networking concepts', 'Configure Route 53', 'Understand CDN (CloudFront)', 'Labs & quiz'] },
                  { week: 5, title: 'Python for DevOps', hours: '20-25h', tasks: ['Python basics & syntax', 'boto3 AWS SDK', 'Automation scripts', 'Labs & quiz'] },
                  { week: 6, title: 'Serverless Computing with Lambda', hours: '15-20h', tasks: ['Create Lambda functions', 'DynamoDB basics', 'API Gateway', 'Labs & quiz'] },
                  { week: 7, title: 'Cloud Resume Challenge - Part 1', hours: '20-25h', tasks: ['HTML/CSS resume', 'Deploy to S3', 'CloudFront distribution', 'Custom domain setup'] },
                  { week: 8, title: 'Cloud Resume Challenge - Part 2', hours: '20-25h', tasks: ['JavaScript visitor counter', 'Lambda backend', 'DynamoDB database', 'CORS configuration'] },
                  { week: 9, title: 'Infrastructure as Code with Terraform', hours: '25-30h', tasks: ['Terraform basics', 'Provision AWS resources', 'State management', 'Refactor Cloud Resume with IaC'] },
                  ...
                  <div key={idx} className="bg-slate-900 rounded-lg p-4 border border-slate-700 hover:border-yellow-500 transition">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-slate-400">{item.hours} estimated time</p>
                      </div>
              ...
              <div className="bg-green-900/20 border border-green-600/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-green-400 mb-4">📚 Study Tips for Success</h3>
                <div className="grid md:grid-cols-2 gap-4 text-sm text-slate-300">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Consistency over intensity:</strong> Daily 2-hour sessions beat weekend cramming</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Hands-on practice:</strong> Don't skip the labs - they're crucial for retention</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Use spaced repetition:</strong> Review lessons when due to maximize retention</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Document your learning:</strong> Blog posts or notes help solidify knowledge</span>
                    </li>
                  </ul>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Join communities:</strong> r/devops, DevOps Discord servers for support</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Build in public:</strong> Share your Cloud Resume progress on LinkedIn/Twitter</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Take breaks:</strong> Pomodoro technique (25 min work, 5 min break) works well</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-1">✓</span>
                      <span><strong>Track progress:</strong> Use the dashboard streak feature to build momentum</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="mt-16">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-8 text-center">
            ...
            <p className="text-xl text-indigo-100 mb-6 max-w-2xl mx-auto">
              Complete the Cloud Resume Challenge to build a portfolio project that demonstrates all these skills!
            </p>
            <a
              href="/projects"
