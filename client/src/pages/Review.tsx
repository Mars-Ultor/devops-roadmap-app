  ...
  const loadFlashCards = useCallback(async () => {
    ...
    try {
      ...
      progressSnapshot.docs.forEach((doc, index) => {
        ...
        const category = lessonId.includes("w1")
          ? "Linux & DevOps"
          : lessonId.includes("w2")
            ? "Git & GitHub"
            : lessonId.includes("w3")
              ? "AWS Cloud"
              : lessonId.includes("w4")
                ? "Networking"
                : lessonId.includes("w5")
                  ? "Python"
                  : lessonId.includes("w6")
                    ? "Serverless"
                    : "General";
        ...
        if (lessonId === "w1-l1") {
          ...
          cards.push({
            ...
            answer:
              "To shorten the development lifecycle and deliver features, fixes, and updates frequently while maintaining high quality and reliability.",
          });
        }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-300">
            Review lessons at optimal intervals using the SM-2 algorithm.
        ...
        <div className="mt-8 bg-blue-900/20 border border-blue-600/30 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-sm text-slate-300">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Try to answer before revealing:</strong> Actively
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                ...
                self-assessment optimizes review scheduling
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              <span>
                <strong>Review regularly:</strong> Short daily sessions beat
                long cramming
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              <span>
                <strong>Mix topics:</strong> Interleaved practice improves
                long-term retention
              </span>
            </li>
          </ul>
