...
const diagnosticQuestions: Question[] = [
  ...
  },
  {
    id: "aws-2",
    question:
      "What service would you use to run containers without managing servers?",
  ...
  const getRecommendation = () => {
    ...
    if (percentage >= 70) {
      return {
        ...
        startWeek: 5,
        message:
          "You have strong foundational knowledge! We recommend starting at Week 5 and using Express Mode to move quickly through familiar concepts.",
      ...
      return {
        ...
        startWeek: 3,
        message:
          "You have some experience! Start at Week 3 and use Express Mode, but feel free to review earlier weeks if needed.",
        color: "text-blue-400",
      };
    } else {
      return {
        ...
        startWeek: 1,
        message:
          "Welcome to DevOps! Start from Week 1 with Deep Dive Mode for comprehensive learning and hands-on practice.",
          ...
          <div className="bg-slate-800 rounded-lg p-8 border border-slate-700">
            ...
            <div className="flex gap-4">
              <button
                onClick={() =>
                  navigate(
                    `/training?tab=curriculum&startWeek=${recommendation.startWeek}`,
                  )
                }
