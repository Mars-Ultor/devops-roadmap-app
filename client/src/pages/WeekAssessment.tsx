...
const weekAssessments: Record<
  number,
  { pre: AssessmentQuestion[]; post: AssessmentQuestion[] }
> = {
  1: {
    pre: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "DevOps is a cultural and technical practice that combines software development (Dev) and IT operations (Ops).",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          'The "ls" command is used to list directory contents in Linux/Unix systems.',
        topic: "Linux Basics",
      },
      {
        id: "pre-3",
    ...
    post: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "chmod (change mode) is used to modify file permissions in Linux.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "sudo (superuser do) allows users to run programs with the security privileges of another user.",
        topic: "Linux Administration",
      },
      {
        id: "post-3",
        ...
        correctAnswer: 0,
        explanation:
          "/etc/passwd contains basic user account information in Linux systems.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "PATH is an environment variable that tells the shell which directories to search for executable files.",
  ...
  2: {
    pre: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Git is just the name chosen by Linus Torvalds; it doesn't stand for anything specific.",
        topic: "Git History",
      },
    ],
    post: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "git add stages changes, preparing them to be included in the next commit.",
        topic: "Git Workflow",
      },
      {
        id: "post-2",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "git pull fetches remote changes and merges them, while git fetch only downloads changes without merging.",
    ...
    pre: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "Cloud computing is the delivery of computing services (servers, storage, databases, etc.) over the internet.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "AWS stands for Amazon Web Services, a comprehensive cloud platform by Amazon.",
        topic: "AWS Basics",
      },
    ],
    post: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "CloudFront is AWS's Content Delivery Network (CDN) service for fast content distribution.",
  ...
  4: {
    pre: [
      {
        ...
        correctAnswer: 0,
        explanation:
          "Containerization packages applications with their dependencies into isolated, portable units.",
    ...
    post: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A Docker image is a read-only template, while a container is a runnable instance of that image.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "docker build creates a Docker image from a Dockerfile and context.",
  ...
  5: {
    ...
    post: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "A workflow file (.github/workflows/*.yml) defines the automation steps, triggers, and jobs for GitHub Actions.",
        topic: "Workflow Configuration",
      },
      {
        id: "post-3",
        question:
          'What does the "on" key specify in a GitHub Actions workflow?',
        options: [
        ...
        correctAnswer: 1,
        explanation:
          'The "on" key specifies which events (like push, pull_request) will trigger the workflow.',
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "A job is a set of steps that execute on the same runner, representing a single task within a workflow.",
  ...
  6: {
    pre: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "Infrastructure as Code (IaC) is the practice of managing and provisioning infrastructure through machine-readable code.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Terraform is an open-source IaC tool by HashiCorp that allows you to define and provision infrastructure.",
    ...
    post: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A provider is a plugin that enables Terraform to interact with cloud platforms, services, and other APIs.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "terraform plan shows what changes Terraform will make to reach the desired state defined in configuration.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Terraform state is a file that tracks which resources Terraform manages and their current state.",
  ...
  7: {
    pre: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A Pod is the smallest and simplest Kubernetes object, representing a single instance of a running process in a cluster.",
    ...
    post: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A ConfigMap is used to store non-confidential configuration data that can be consumed by Pods.",
  ...
  8: {
    pre: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Prometheus is an open-source systems monitoring and alerting toolkit with a dimensional data model.",
    ...
    post: [
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "The three pillars of observability are Metrics (measurements), Logs (events), and Traces (request flows).",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Centralized logging aggregates logs from multiple sources into a single, searchable system for analysis.",
        topic: "Logging",
      },
      {
        id: "post-4",
        ...
        correctAnswer: 1,
        explanation:
          "An alert is an automatic notification sent when monitoring conditions are met or thresholds are exceeded.",
        topic: "Alerting",
      },
    ],
  },
  9: {
    pre: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Container vulnerability scanning identifies security vulnerabilities in container images before deployment.",
    ...
    post: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "HashiCorp Vault is a tool for securely accessing secrets, including authentication, authorization, and encryption.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A security policy defines rules and procedures for implementing security controls and practices.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Infrastructure security scanning identifies misconfigurations and security issues in infrastructure setups.",
    ...
    post: [
      {
        ...
        correctAnswer: 0,
        explanation:
          "A StatefulSet manages the deployment and scaling of a set of Pods with stable identities and persistent storage.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "mTLS (mutual TLS) is a security protocol where both client and server authenticate each other using certificates.",
        topic: "Security",
      },
      {
        id: "post-3",
        ...
        correctAnswer: 0,
        explanation:
          "A CRD extends the Kubernetes API with custom resources, allowing users to define their own resource types.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "The Operator pattern automates the management of complex applications on Kubernetes using custom controllers.",
  ...
  11: {
    pre: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "ArgoCD is a declarative, GitOps continuous delivery tool for Kubernetes that follows the GitOps pattern.",
        topic: "ArgoCD",
      },
    ],
    post: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "Declarative configuration describes what the desired state should be, rather than how to achieve it.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A Terraform module is a container for multiple resources that are used together, allowing code reuse.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Continuous reconciliation ensures that the actual state of infrastructure matches the desired state defined in Git.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Platform engineering involves building self-service platforms that enable teams to deploy and manage applications independently.",
    ...
    pre: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "A capstone project is a culminating academic project that demonstrates the integration of skills and knowledge.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "A technical portfolio should showcase projects, documentation, architecture decisions, and problem-solving approaches.",
    ...
    post: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "CI/CD pipeline security involves implementing security checks, scans, and controls throughout the entire pipeline.",
        topic: "DevSecOps",
      },
      {
        id: "post-2",
        ...
        correctAnswer: 1,
        explanation:
          "Infrastructure monitoring tracks the performance, availability, and health of infrastructure components.",
        topic: "Monitoring",
      },
      {
        id: "post-3",
        ...
        correctAnswer: 1,
        explanation:
          "Production deployment strategies include blue-green, canary, and rolling deployments with rollback capabilities.",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Incident response is a structured approach to detecting, responding to, and learning from system incidents.",
...
export default function WeekAssessment() {
  ...
  const [assessmentType, setAssessmentType] = useState<"pre" | "post">(
    typeFromUrl || "pre",
  );
  ...
  const [preAssessmentScore, setPreAssessmentScore] = useState<number | null>(
    null,
  );
  const [postAssessmentScore, setPostAssessmentScore] = useState<number | null>(
    null,
  );
  ...
  const loadPreviousResults = useCallback(async () => {
    ...
    try {
      const preDoc = await getDoc(
        doc(db, "assessments", `${user.uid}_week${weekNumber}_pre`),
      );
      if (preDoc.exists()) {
      ...
      const postDoc = await getDoc(
        doc(db, "assessments", `${user.uid}_week${weekNumber}_post`),
      );
      if (postDoc.exists()) {
      ...
      try {
        await setDoc(
          doc(
            db,
            "assessments",
            `${user.uid}_week${weekNumber}_${assessmentType}`,
          ),
          {
            ...result,
            userId: user.uid,
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                {preAssessmentScore !== null && (
                  <div
                    className={`text-2xl font-bold ${getScoreColor(preAssessmentScore)}`}
                  >
                    {preAssessmentScore}%
                  </div>
                )}
              ...
              <p className="text-slate-300 mb-4">
                Take this before starting Week {week} to gauge your current
                knowledge.
              </p>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                {postAssessmentScore !== null && (
                  <div
                    className={`text-2xl font-bold ${getScoreColor(postAssessmentScore)}`}
                  >
                    {postAssessmentScore}%
                  </div>
                )}
              ...
              <p className="text-slate-300 mb-4">
                Take this after completing Week {week} to measure your
                improvement.
              </p>
            ...
            <div className="mt-8 bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-green-600/30 rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  ...
                  <div
                    className={`text-3xl font-bold ${getScoreColor(preAssessmentScore)}`}
                  >
                    {preAssessmentScore}%
                  </div>
                </div>
                <div>
                  ...
                  <div
                    className={`text-3xl font-bold ${getScoreColor(postAssessmentScore)}`}
                  >
                    {postAssessmentScore}%
                  </div>
                </div>
                <div>
                  ...
                  <div
                    className={`text-3xl font-bold ${getImprovement()! >= 0 ? "text-green-400" : "text-red-400"}`}
                  >
                    {getImprovement()! >= 0 ? "+" : ""}
                    {getImprovement()}%
                  </div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold text-white">
                Week {week} {assessmentType === "pre" ? "Pre" : "Post"}
                -Assessment
              </h1>
