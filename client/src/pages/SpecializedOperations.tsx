...
const SPECIALIZED_SCENARIOS: SpecializedScenario[] = [
  {
    ...
    difficulty: "expert",
    description:
      "Respond to a critical zero-day vulnerability affecting production systems across multiple services.",
    objectives: [
...
**Your Role:** Lead Security Incident Commander`,
    challenges: [
      ...
      },
      {
        ...
        description:
          "How do you contain the breach while minimizing business impact?",
        type: "decision",
        options: [
      ...
      },
      {
        ...
        description:
          "How do you communicate with different stakeholder groups?",
        type: "decision",
        options: [
      ...
      },
      {
        ...
        description:
          "How do you eradicate the vulnerability from your infrastructure?",
        type: "decision",
        options: [
      ...
      },
      {
        ...
        description:
          "How do you verify systems are clean and return to normal operations?",
        type: "decision",
        options: [
  ...
  },
  {
    ...
    difficulty: "advanced",
    description:
      "Diagnose and resolve a complex performance degradation affecting multiple microservices.",
    objectives: [
...
**Your Role:** Performance Engineering Lead`,
    challenges: [
      {
        ...
        description:
          "What is your systematic approach to diagnosing the performance issues?",
        type: "decision",
        options: [
      ...
      },
      {
        ...
        description:
          "Based on the metrics, what appears to be the primary bottleneck?",
        type: "decision",
        options: [
      ...
      },
      {
        ...
        description:
          "What scaling approach provides immediate relief while maintaining cost efficiency?",
        type: "decision",
        options: [
  ...
  },
  {
    ...
    difficulty: "expert",
    description:
      "Lead a complex platform migration while maintaining service availability and managing technical debt.",
    objectives: [
...
**Your Role:** Platform Engineering Director`,
    challenges: [
      ...
      },
      {
        ...
        description:
          "What rollback strategy ensures you can safely revert if issues arise?",
        type: "decision",
        options: [
      ...
      },
      {
        ...
        description:
          "How do you validate migration success and gain stakeholder confidence?",
        type: "decision",
        options: [
...
export default function SpecializedOperations() {
  ...
  const [selectedScenario, setSelectedScenario] =
    useState<SpecializedScenario | null>(null);
  const [currentAttempt, setCurrentAttempt] =
    useState<SpecializedAttempt | null>(null);
  ...
  const completeScenario = (
    finalScore: number,
    finalDecisions: SpecializedDecision[],
  ) => {
      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-400">
            Please log in to access specialized operations training.
          </p>
        </div>
      </div>
    );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-400 mt-2">
                Phase 2.7: Domain-specific advanced training for specialized
                DevOps roles
              </p>
            </div>
            <button
            ...
            {SPECIALIZED_SCENARIOS.map((scenario) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div
                    className={`flex items-center px-3 py-1 rounded-full border ${getDomainColor(scenario.domain)}`}
                  >
                  ...
                  <span
                    className={`text-sm font-medium ${getDifficultyColor(scenario.difficulty)}`}
                  >
                    {scenario.difficulty}
                  </span>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-slate-800 rounded-lg border border-slate-700 p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <div
                  className={`flex items-center px-3 py-1 rounded-full border ${getDomainColor(selectedScenario.domain)}`}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-slate-700 rounded-lg p-4">
                  ...
                  <p
                    className={`font-semibold ${getDifficultyColor(selectedScenario.difficulty)}`}
                  >
                ...
                <div className="bg-slate-700 rounded-lg p-4">
                  ...
                  <p className="text-white font-semibold">
                    {selectedScenario.specialization}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <TimerCountdown
                    ...
                    onTimeUp={() =>
                      completeScenario(currentAttempt.score, decisions)
                    }
                          ...
                          <p className="text-slate-300">
                            💡{" "}
                            {
                              currentChallenge.hints[
                                Math.floor(
                                  Math.random() * currentChallenge.hints.length,
                                )
                              ]
                            }
                          </p>
              ...
              <div className="text-center mb-8">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 ${
                    currentAttempt.score >=
                    selectedScenario.challenges.reduce(
                      (sum, c) => sum + c.points,
                      0,
                    ) *
                      0.8
              ...
              <div className="mb-8">
                ...
                <div className="space-y-3">
                  {decisions.map((decision) => {
                    ...
                    return (
                      <div
                        key={`${decision.challengeId}-${decision.selectedAnswer}`}
