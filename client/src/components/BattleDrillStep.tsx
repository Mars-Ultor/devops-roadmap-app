...
import {
  ...
  ValidationFeedback,
  HintsPanel,
} from "./battle-drill/BattleDrillStepComponents";
...
export const BattleDrillStep: React.FC<BattleDrillStepProps> = ({
  ...
  return (
    <div
      className={`bg-slate-800 rounded-lg border-2 p-5 transition-all ${isCompleted ? "border-green-500" : "border-slate-700"}`}
    >
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div className="flex-1">
            ...
            <ValidationCriteria
              criteria={step.validationCriteria}
              validationResult={validationResult}
            />
          </div>
        </div>
