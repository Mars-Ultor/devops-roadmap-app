...
export const SEVERITIES: { value: FailureSeverity; label: string; color: string }[] = [
...
export function generateRunbook(params: RunbookParams): string {
  const { title, description, errorMessage, rootCause, whatTried, category, severity } = params;
