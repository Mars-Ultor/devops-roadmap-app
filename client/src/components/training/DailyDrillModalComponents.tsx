  ...
  return (
    <div className="bg-blue-900/20 rounded-lg p-3 border border-blue-700 text-sm">
      <div className="flex items-center gap-2 text-blue-300">
        ...
        <span>
          Content from {candidate.daysSinceCompletion} days ago (spaced
          repetition)
        </span>
      </div>
    </div>
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex items-center gap-2 text-slate-400">
            ...
            <span className="text-sm">
              {Math.round(drill.targetTimeSeconds / 60)} min
            </span>
          </div>
        </div>
    ...
    <div className="flex items-center justify-between pt-4">
      {!canDismiss && (
        <p className="text-sm text-amber-400 flex items-center gap-2">
          <span className="text-lg">⚠️</span>Must complete to continue
        </p>
      )}
      {canDismiss && (
        <button
