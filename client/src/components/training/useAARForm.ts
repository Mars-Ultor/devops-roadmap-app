...
export function useAARForm({
  ...
  return {
    ...
    improvements,
    transferableKnowledge,
    setTransferableKnowledge,
    submitting,
    showValidation,
    isValid,
    // Handlers
    handleSubmit,
    updateWhatWorked: (i: number, v: string) =>
      updateArrayField(whatWorked, setWhatWorked, i, v),
    addWhatWorked: () => addArrayField(whatWorked, setWhatWorked),
    updateWhatDidntWork: (i: number, v: string) =>
      updateArrayField(whatDidntWork, setWhatDidntWork, i, v),
    addWhatDidntWork: () => addArrayField(whatDidntWork, setWhatDidntWork),
    updateRootCauses: (i: number, v: string) =>
      updateArrayField(rootCauses, setRootCauses, i, v),
    addRootCauses: () => addArrayField(rootCauses, setRootCauses),
    updateImprovements: (i: number, v: string) =>
      updateArrayField(improvements, setImprovements, i, v),
