  ...
  return (
    <div className="bg-yellow-900/30 border-2 border-yellow-600 rounded-lg p-6 mb-6">
      <div className="flex items-start space-x-3">
        <div className="flex-shrink-0"><AlertTriangle className="w-6 h-6 text-yellow-400 mt-1" /></div>
        <div className="flex-1">
          <p className="text-yellow-100 text-lg font-medium mb-3"><strong>Why Daily Drills Matter:</strong></p>
  ...
  return (
    <div className="bg-slate-900/50 rounded-lg p-6 mb-6">
      <h3 className="text-white font-semibold mb-4 flex items-center gap-2">
        <Clock className="w-5 h-5 text-blue-400" />Daily Drill Details
      </h3>
      <div className="grid grid-cols-2 gap-4 text-sm">
        <div className="bg-slate-700/50 p-3 rounded"><div className="text-gray-400 mb-1">Time Limit</div><div className="text-white font-semibold">10 minutes</div></div>
        <div className="bg-slate-700/50 p-3 rounded"><div className="text-gray-400 mb-1">Difficulty</div><div className="text-white font-semibold">Run-Independent Only</div></div>
        <div className="bg-slate-700/50 p-3 rounded"><div className="text-gray-400 mb-1">Questions</div><div className="text-white font-semibold">Spaced Repetition Mix</div></div>
        <div className="bg-slate-700/50 p-3 rounded"><div className="text-gray-400 mb-1">Passing Score</div><div className="text-white font-semibold">70% or higher</div></div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-slate-900/50 rounded-lg p-4 mb-6">
      <h4 className="text-white font-medium mb-2 flex items-center gap-2">
        <Calendar className="w-4 h-4 text-purple-400" />Spaced Repetition Algorithm
      </h4>
...
export function GateFooter({ onStart }: GateFooterProps) {
  return (
    <div className="flex justify-between items-center pt-6 border-t border-slate-700">
      <div className="text-sm text-gray-400">⚠️ Training content is locked until drill completion</div>
      <button onClick={onStart} className="px-8 py-3 bg-yellow-600 text-white rounded-lg font-bold text-lg hover:bg-yellow-700 flex items-center gap-3 shadow-lg hover:shadow-yellow-600/50 transition-all">
        <Target className="w-6 h-6" />Start Daily Drill
      </button>
    </div>
  );
}
