...
export const RecertificationHeader: React.FC<HeaderProps> = ({
  certificationCount,
  passedDrillsCount,
}) => (
    ...
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-blue-100 mt-2">
          Maintain your DevOps expertise through continuous learning and
          recertification
        </p>
      </div>
    ...
    <div className="bg-red-900/50 border border-red-700 rounded-lg p-6">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-semibold text-red-300">
          Urgent Recertification Required
        </h2>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center space-x-3">
                <div
                  className={`px-3 py-1 rounded-full text-sm font-medium ${getCertificationColor(cert.certificationLevel)}`}
                >
          ...
          return (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 text-sm text-gray-400">
                ...
                <div>
                  <span className="font-medium">Last Recertified:</span>{" "}
                  {cert.lastRecertifiedAt.toLocaleDateString()}
                </div>
                <div>
                  <span className="font-medium">Consecutive Passes:</span>{" "}
                  {cert.consecutivePasses}
                </div>
                <div>
...
export const AvailableDrillsList: React.FC<AvailableDrillsListProps> = ({
  drills,
  onSelectDrill,
}) => (
  <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg shadow-xl p-6 border border-slate-700">
    <div className="flex items-center mb-6">
      ...
      <h2 className="text-xl font-semibold text-white">
        Available Recertification Drills
      </h2>
    </div>
    ...
    <div className="space-y-4">
      {drills.map((drill) => (
        <div
          key={drill.id}
          className="border border-slate-600 rounded-lg p-4 hover:border-blue-500 transition-colors bg-slate-800/50"
        >
          <div className="flex items-start justify-between mb-3">
            ...
            <div
              className={`px-3 py-1 rounded-full text-sm font-medium ${getCertificationColor(drill.certificationLevel)}`}
            >
      ...
      {drills.length === 0 && (
        <div className="text-center py-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Complete prerequisite certifications to unlock more recertification
            drills
          </p>
        </div>
      )}
...
export const RecentAttemptsList: React.FC<RecentAttemptsListProps> = ({
  attempts,
  drills,
}) => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg shadow-xl p-6 border border-slate-700">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-xl font-semibold text-white">
          Recent Recertification Attempts
        </h2>
      </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    ...
                    {Math.round(attempt.timeSpentMinutes)} minutes
                  </p>
                </div>
              </div>
              <div className="text-right">
                <div
                  className={`text-lg font-bold ${attempt.passed ? "text-green-600" : "text-red-600"}`}
                >
                  {attempt.score}%
                </div>
                <div className="text-sm text-gray-400">
  ...
  <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-6">
    <div className="flex items-center mb-4">
      ...
      <h2 className="text-xl font-semibold text-blue-300">
        Knowledge Retention & Recertification
      </h2>
    </div>
