...
export function writeWelcomeBanner(
  ...
  term.writeln(
    "\x1b[36m║        DevOps Terminal Command Simulation (TCS)            ║\x1b[0m",
  );
  term.writeln(
    "\x1b[36m╚══════════════════════════════════════════════════════════════╝\x1b[0m",
  );
  ...
  if (timeLimit) {
    term.writeln(
      `\x1b[31m⏱️  Time Limit: ${Math.floor(timeLimit / 60)} minutes\x1b[0m`,
    );
    term.writeln("");
  }
  term.writeln(
    '\x1b[90mType "help" for available commands, "hint" for task hints\x1b[0m',
  );
  term.writeln("");
}
