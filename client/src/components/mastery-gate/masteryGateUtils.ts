...
export const getContainerClasses = (isMastered: boolean, unlocked: boolean): string => {
...
export const getColorClass = (isMastered: boolean, color: string, type: 'text' | 'bg' | 'border'): string => {
  if (isMastered) {
...
export const getDotClass = (index: number, perfectCompletions: number, color: string): string => {
