...
export const AARModalHeader: React.FC<ModalHeaderProps> = ({
  labTitle,
  passed,
}) => (
  ...
  <div className="bg-red-900/20 border-b border-red-700 px-6 py-3">
    <div className="flex items-start">
      ...
      <p className="text-sm text-red-200">
        <strong>Mandatory Reflection:</strong> You must complete this AAR before
        continuing. No navigation, no skipping, no shortcuts. Reflection builds
        competence.
      </p>
    </div>
  </div>
    ...
    <div className="space-y-2">
      <label className="block">
        <div className="flex items-start justify-between mb-2">
          ...
          <span
            className={`text-sm flex items-center ${isValid ? "text-green-400" : "text-slate-400"}`}
          >
