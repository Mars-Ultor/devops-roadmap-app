...
} from "./recertification/recertificationDrillUtils";
    ...
    <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <div
            className={`px-3 py-1 rounded-full text-sm font-medium ${getCertificationColor(certLevel)}`}
          >
          ...
          {timeRemaining !== undefined && (
            <div className="flex items-center text-white">
              ...
              <span
                className={timeRemaining < 300 ? "text-red-300 font-bold" : ""}
              >
  ...
  return (
    <div className="flex space-x-4">
      <button
        ...
        className={`flex-1 p-4 rounded-lg border-2 transition-all ${trueClass}`}
      >
        <span className="font-medium text-white">True</span>
      </button>
      <button
        onClick={() => onSelect(false)}
        className={`flex-1 p-4 rounded-lg border-2 transition-all ${falseClass}`}
      >
...
export function DrillResultsStats({
  score,
  passed,
  timeSpentMinutes,
}: ResultsStatsProps) {
...
export function DrillRequirementsCheck({
  score,
  timeSpentMinutes,
  certLevel,
  timeLimit,
}: RequirementsCheckProps) {
    ...
    <div className="bg-slate-800 rounded-lg p-4 mb-6 border border-slate-700">
      ...
      <div className="space-y-2">
        <div className="flex justify-between">
          ...
          <span
            className={
              score >= requirements.minScore ? "text-green-400" : "text-red-400"
            }
          >
        ...
        <div className="flex justify-between">
          ...
          <span
            className={
              timeSpentMinutes <= timeLimit ? "text-green-400" : "text-red-400"
            }
          >
