...
export default function StruggleSessionManager(props: StruggleSessionManagerProps) {
  const {
    session,
    currentPhase,
    showStruggleLogForm,
  ...
  if (currentPhase === 'completed') return <SessionCompleteDisplay session={session} />;
  ...
  return (
    <div className="space-y-6">
      ...
      {currentHint && <CurrentHintDisplay hint={currentHint} hintNumber={session.timerState.hintsUsed} />}
      <StruggleTimer
