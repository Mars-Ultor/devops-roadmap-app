...
const MasteryLevelCard: React.FC<{ analytics: AnalyticsData }> = ({
  analytics,
}) => {
...
const SkillsMasteryCard: React.FC<{ analytics: AnalyticsData }> = ({
  analytics,
}) => {
...
const StreaksCard: React.FC<{ analytics: AnalyticsData }> = ({ analytics }) => {
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
      <div className="flex items-center gap-3 mb-4">
...
const MasteryProgression: React.FC<MasteryProgressionProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <MasteryLevelCard analytics={analytics} />
      <SkillsMasteryCard analytics={analytics} />
