...
export const ADAPTIVE_SCENARIOS: AdaptiveScenario[] = [
  {
    ...
    description:
      "Respond to escalating production incidents while the AI adapts complexity based on your decisions",
    scenario:
      "Your e-commerce platform is experiencing intermittent 500 errors. Initial monitoring shows database connection pool exhaustion. Customer reports are flooding in, and it's peak shopping hours. The AI will adjust incident complexity based on how you handle each phase.",
    challenges: [
      {
        id: "initial-assessment",
        phase: "Initial Assessment",
        situation:
          "Error rate spiked from 0.1% to 15% in the last 5 minutes. Database CPU is at 85%. What's your first action?",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Restarting without understanding root cause could make things worse. Always investigate first.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Excellent! Understanding the problem before acting prevents misguided interventions.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "While scaling helps, you should first identify if it's a code issue causing connection leaks.",
      ...
      },
      {
        ...
        situation:
          "CEO just pinged asking for status. You have partial information. How do you respond?",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Perfect balance of honesty, timeline, and commitment to updates.",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Too vague. Leadership needs timeframes and next steps.",
      ...
      },
      {
        ...
        situation:
          "You found a new deployment 2 hours ago added N+1 queries. How do you proceed?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Smart! Restore service first, then fix properly with testing.",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Too risky. Hotfixing under pressure can introduce new issues.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Treating symptom not cause. Inefficient queries should be fixed.",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Too reactive. Need structured post-mortem and prevention.",
            skillsAssessed: ["Communication"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Perfect! Learn from incidents and systematically prevent recurrence.",
            skillsAssessed: [
              "Process Improvement",
              "Technical Analysis",
              "Leadership",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Documentation is good, but need active prevention measures.",
  ...
  },
  {
    ...
    description:
      "Lead multiple teams through a cascading failure affecting critical infrastructure",
    scenario:
      "A routine deployment triggered a cascading failure across three microservices. Your team is stressed, customers are impacted, and executives are demanding answers. The AI will increase pressure based on your leadership effectiveness.",
    challenges: [
      {
        id: "team-coordination",
        phase: "Team Coordination",
        situation:
          "You have 3 teams (Platform, Security, Data) all pointing fingers. How do you unify them?",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Blame-focused approach damages team morale and slows resolution.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Excellent leadership! Crisis requires unity and clear structure.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Silos slow down crisis response. Coordination is critical.",
      ...
      },
      {
        ...
        situation:
          'CTO demands: "Why wasn\'t this caught in testing? Someone needs to answer for this." Your response?',
        correctOptionId: "pressure-opt-1",
        learningObjective:
          "Shield team from blame while maintaining accountability",
        options: [
          {
            id: "pressure-opt-1",
            ...
            outcome: "optimal",
            explanation:
              "Perfect! Deflect blame, protect team morale, commit to accountability later.",
            skillsAssessed: [
              "Leadership",
              "Communication",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Throwing team members under the bus destroys trust and culture.",
            skillsAssessed: ["Leadership"],
          },
          {
            id: "pressure-opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Too passive. Need to redirect focus while showing leadership.",
            skillsAssessed: ["Communication"],
          },
        ],
      },
      {
        ...
        situation:
          'You\'re being pulled in 5 directions. Junior engineer asks "What should I do?"',
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Clear, actionable task with autonomy. Great delegation!",
      ...
      },
      {
        ...
        situation:
          "Customer support reports 500+ angry tickets. How do you help them?",
  ...
  },
  {
    ...
    description:
      "Respond to active security breach while preserving evidence and minimizing damage",
    scenario:
      "Security alerts indicate unauthorized access to production databases. Unusual data exfiltration patterns detected. You need to contain the threat, preserve forensic evidence, and coordinate with legal/compliance. AI adapts based on your security acumen.",
    challenges: [
      {
        id: "initial-containment",
        phase: "Threat Containment",
        situation:
          "Active data exfiltration detected. Attacker has database credentials. What's your priority?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "suboptimal",
            explanation:
              "While stopping access is important, you need to preserve evidence of attack vectors first.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Perfect security response! Preserve evidence while containing the threat.",
            skillsAssessed: [
              "Security Operations",
              "Forensic Investigation",
              "Technical Analysis",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Too extreme. Surgical containment is better than scorched earth.",
            skillsAssessed: ["Security Operations"],
          },
        ],
      },
      {
        ...
        situation:
          "Logs show attacker used compromised API key. How do you handle data loss? Wait, how deep is the breach?",
        correctOptionId: "opt-1",
        learningObjective:
          "Systematic threat assessment and blast radius analysis",
        options: [
          {
            id: "opt-1",
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive approach! Understanding full breach scope is critical.",
            skillsAssessed: [
              "Forensic Investigation",
              "Threat Analysis",
              "Security Operations",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Tunnel vision. Attackers often establish multiple footholds.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Premature mitigation. Need to understand breach scope first.",
            skillsAssessed: ["Security Operations"],
          },
        ],
      },
      {
        ...
        situation:
          'Legal asks: "Do we need to report this breach to customers?" You have 2 hours to decide.',
        correctOptionId: "opt-1",
        learningObjective:
          "Navigate legal/compliance requirements under pressure",
        options: [
          {
            id: "opt-1",
            ...
            outcome: "optimal",
            explanation:
              "Methodical compliance assessment! Data-driven decisions for legal obligations.",
            skillsAssessed: [
              "Threat Analysis",
              "Communication",
              "Decision Making",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Dangerous! Compliance violations have severe penalties. Need definitive answer.",
            skillsAssessed: ["Decision Making"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Over-notification causes unnecessary panic. Make evidence-based decision.",
      ...
      },
      {
        ...
        situation:
          "Breach contained. What long-term security measures do you implement?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Defense in depth! Multiple layers of security improvements.",
            skillsAssessed: [
              "Security Operations",
              "Process Improvement",
              "Technical Analysis",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Band-aid solution. Need systematic security improvements.",
            skillsAssessed: ["Security Operations"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Single layer. Modern security requires multiple controls.",
            skillsAssessed: ["Security Operations"],
          },
        ],
      },
  ...
  },
  {
    ...
    description:
      "Design and implement a developer platform that scales to 500+ engineers",
    scenario:
      "Your company is growing from 50 to 500 engineers. Current ad-hoc deployment process won't scale. You need to design a self-service platform that maintains developer velocity while ensuring reliability. AI adapts based on your platform design decisions.",
    challenges: [
      {
        id: "platform-vision",
        phase: "Platform Strategy",
        situation:
          "Product teams want different tech stacks. How do you handle diversity vs. standardization?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Too rigid. Stifles innovation and ignores valid use cases.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Perfect balance! Provide great defaults while allowing innovation.",
            skillsAssessed: [
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Creates operational nightmare. Need some standardization.",
            skillsAssessed: ["Platform Engineering"],
          },
        ],
      },
      {
        ...
        situation:
          'Engineers complain: "Deploying takes 45 minutes and requires 5 approvals." How do you fix this?',
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Modern CI/CD! Replace manual gates with automated safety.",
            skillsAssessed: [
              "Platform Engineering",
              "Process Improvement",
              "Technical Analysis",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Too risky. Need automated safeguards, not just access.",
            skillsAssessed: ["Decision Making"],
          },
        ],
      },
      {
        ...
        situation:
          "Teams can't debug issues because logs are scattered across 12 systems. Your solution?",
        correctOptionId: "opt-2",
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Excellent! Observability as first-class platform capability.",
            skillsAssessed: [
              "Platform Engineering",
              "System Design",
              "Technical Analysis",
      ...
      },
      {
        ...
        situation:
          "Cloud costs hit $2M/month. Teams don't know their spend. How do you address this?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "FinOps best practices! Visibility drives accountability.",
            skillsAssessed: [
              "Platform Engineering",
              "Cost Optimization",
              "Process Improvement",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Quotas without visibility create conflicts. Transparency first.",
            skillsAssessed: ["Process Improvement"],
          },
        ],
      },
  ...
  },
  {
    ...
    description:
      "Diagnose and resolve complex performance issues across distributed systems",
    scenario:
      "Your API latency has degraded from p95 200ms to 2000ms over the past week. No recent deployments. Users are complaining. Find and fix the root cause. AI adapts based on your performance analysis skills.",
    challenges: [
      {
        id: "performance-investigation",
        phase: "Initial Diagnosis",
        situation:
          "P95 latency is 10x normal. Where do you start investigating?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive approach! Check all potential bottlenecks systematically.",
            skillsAssessed: [
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Scaling without diagnosis wastes resources and may not help.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Might temporarily help but doesn't address root cause.",
            skillsAssessed: ["Decision Making"],
          },
        ],
      },
      {
        ...
        situation:
          "Traces show database queries taking 1.5s (was 50ms). What's your hypothesis?",
        correctOptionId: "opt-2",
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Methodical database troubleshooting! Multiple potential causes.",
            skillsAssessed: [
              "Performance Engineering",
              "Technical Analysis",
              "Profiling",
      ...
      },
      {
        ...
        situation:
          "You found missing indexes on high-traffic tables. How do you apply the fix?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Safe production changes! Test, non-blocking add, verify impact.",
            skillsAssessed: [
              "Performance Engineering",
              "Technical Analysis",
              "Decision Making",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Risky! Index creation can lock tables and cause outages.",
            skillsAssessed: ["Decision Making"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Too slow. Users are suffering now. Safe immediate fixes exist.",
            skillsAssessed: ["Performance Engineering"],
          },
        ],
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Documentation doesn't prevent recurrence. Need active monitoring.",
            skillsAssessed: ["Process Improvement"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Too slow. Want real-time alerts, not periodic reviews.",
            skillsAssessed: ["Process Improvement"],
          },
        ],
      },
  ...
  },
  {
    ...
    description:
      "Fix a critical CI/CD pipeline failure blocking all deployments",
    scenario:
      "Your CI/CD pipeline has been failing for 3 hours. 15 teams are blocked from deploying. Tests are timing out, builds are inconsistent, and the infrastructure team says nothing changed. AI adapts based on your pipeline debugging skills.",
    challenges: [
      {
        id: "pipeline-diagnosis",
        phase: "Initial Investigation",
        situation:
          "Pipeline fails at different stages randomly. Where do you start?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Restarting without diagnosis may not fix intermittent issues.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive approach! Intermittent failures often indicate resource or network issues.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "May work, but you won't learn what broke or prevent recurrence.",
      ...
      },
      {
        ...
        situation:
          "Runners are hitting CPU limits during parallel test execution. How do you fix this?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Perfect! Immediate mitigation plus long-term optimization.",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Expensive solution that doesn't address inefficient tests.",
            skillsAssessed: ["CI/CD"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Slows down everyone. Need to scale infrastructure properly.",
            skillsAssessed: ["Process Improvement"],
          },
        ],
      },
      {
        ...
        situation:
          "Teams are angry about the 3-hour outage. How do you communicate the fix?",
        correctOptionId: "opt-2",
        learningObjective:
          "Transparent communication with actionable follow-up",
        options: [
          {
            id: "opt-1",
            ...
            outcome: "poor",
            explanation:
              "Too brief. Teams need context and assurance it won't recur.",
            skillsAssessed: ["Communication"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Excellent transparency! Builds trust and prevents recurrence.",
            skillsAssessed: [
              "Communication",
              "Process Improvement",
              "Leadership",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Blame destroys collaboration. Focus on systemic improvements.",
            skillsAssessed: ["Communication"],
          },
        ],
      },
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive prevention! Monitoring, automation, and quality gates.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Too slow. Automated monitoring catches issues faster.",
            skillsAssessed: ["Process Improvement"],
          },
        ],
      },
  ...
  },
  {
    ...
    description:
      "Scale infrastructure to handle 10x traffic spike from viral marketing campaign",
    scenario:
      "Marketing just announced a viral campaign starting in 2 hours. Expected traffic: 10x normal. Current infrastructure: barely handling current load. Budget approved for emergency scaling. AI adapts based on your scaling decisions.",
    challenges: [
      {
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Wasteful and may hit cloud quotas. Need targeted scaling.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Smart! Focus on bottlenecks and use auto-scaling for efficiency.",
            skillsAssessed: [
              "Infrastructure",
              "Scalability",
              "Cloud Architecture",
      ...
      },
      {
        ...
        situation:
          "Database CPU hits 95%. Read replicas at capacity. How do you scale?",
        correctOptionId: "opt-1",
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Expensive and still has limits. Caching is more scalable.",
            skillsAssessed: ["Infrastructure"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Helps reads but primary still bottlenecked. Need caching.",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Too narrow. Need comprehensive metrics and user impact.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Complete picture! Technical and business metrics together.",
      ...
      },
      {
        ...
        situation:
          "Traffic spike over. Cloud bill is 8x normal. How do you optimize?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Smart cost management! Prepared for spikes but not wasteful.",
            skillsAssessed: [
              "Cost Optimization",
              "Infrastructure",
              "Cloud Architecture",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Too expensive. Use auto-scaling instead of static over-provisioning.",
  ...
  },
  {
    ...
    description:
      "Design and execute onboarding for 5 new engineers joining the team",
    scenario:
      "You're hiring 5 engineers over the next month. Current onboarding is ad-hoc: senior devs are pulled away from work for days, new hires feel lost, and time-to-productivity is 8 weeks. AI adapts based on your onboarding design skills.",
    challenges: [
      {
        id: "onboarding-structure",
        phase: "Program Design",
        situation:
          "Design a scalable onboarding program. What's your approach?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive onboarding! Self-service plus human support.",
            skillsAssessed: [
              "Team Management",
              "Process Design",
              "Documentation",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Too sink-or-swim. Structured onboarding accelerates productivity.",
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Perfect! Low-risk tasks that teach the codebase and tools.",
      ...
      },
      {
        ...
        situation:
          "Key system knowledge is in senior devs' heads. How do you capture it?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Multi-format knowledge sharing! Different learning styles.",
            skillsAssessed: [
              "Documentation",
              "Process Design",
              "Team Management",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Doesn't scale. Documentation makes knowledge accessible to all.",
            skillsAssessed: ["Team Management"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Good start, but static docs get stale. Need active knowledge sharing.",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Data-driven improvement! Metrics and feedback drive iteration.",
            skillsAssessed: [
              "Process Design",
              "Team Management",
              "Process Improvement",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Informal feedback is biased. Need structured data collection.",
            skillsAssessed: ["Process Design"],
          },
        ],
      },
  ...
  },
  {
    ...
    scenario:
      "Your primary AWS region went down (regional outage). All services offline. Customers can't access the product. You have backups in another region but never tested failover. Board is watching. AI adapts based on your DR execution skills.",
    challenges: [
      {
        id: "initial-response",
        phase: "Crisis Declaration",
        situation:
          "Primary region down for 15 minutes. What's your first action?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Too passive. Regional outages can last hours. Need DR plan.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Decisive leadership! Clear process and communication.",
            skillsAssessed: [
              "Crisis Management",
              "Disaster Recovery",
              "Communication",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Too slow. Need coordinated DR plan, not ad-hoc rebuild.",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Best effort recovery! Minimize data loss while being transparent.",
            skillsAssessed: [
              "Disaster Recovery",
              "Technical Analysis",
              "Communication",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Ignores potential data loss. Need to analyze and communicate.",
            skillsAssessed: ["Disaster Recovery"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Extended outage worse than 4 hours data loss. Need risk assessment.",
            skillsAssessed: ["Decision Making"],
          },
        ],
      },
      {
        ...
        situation:
          "DR environment needs DNS updates, database migration, service validation. What order?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Premature. Validate services work before directing traffic.",
            skillsAssessed: ["Disaster Recovery"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Proper DR sequence! Validate before cutover, monitor after.",
            skillsAssessed: [
              "Disaster Recovery",
              "Infrastructure",
              "Crisis Management",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive resilience improvements! Learn and harden systems.",
            skillsAssessed: [
              "Process Improvement",
              "Disaster Recovery",
              "Infrastructure",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Missed learning opportunity. Need systemic improvements.",
            skillsAssessed: ["Process Improvement"],
          },
          {
            id: "opt-3",
  ...
  },
  {
    ...
    scenario:
      "Teams can't debug production issues. Logs scattered across services. No distributed tracing. Metrics dashboard is a mess. You're tasked with implementing unified observability. AI adapts based on your observability design skills.",
    challenges: [
      {
        id: "observability-strategy",
        phase: "Platform Design",
        situation:
          "Choose observability approach for 50+ microservices. What do you implement?",
        correctOptionId: "opt-1",
        learningObjective:
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Complete observability stack! All three pillars integrated.",
            skillsAssessed: [
              "Observability",
              "Platform Engineering",
              "System Design",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Logs alone don't show system behavior or request flows.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "May work but expensive and creates vendor lock-in. Open-source alternative exists.",
            skillsAssessed: ["Platform Engineering"],
          },
        ],
      },
      {
        ...
        situation:
          "How do you instrument 50+ services without disrupting teams?",
        correctOptionId: "opt-2",
        learningObjective:
          "Platform capabilities via shared libraries and auto-instrumentation",
        options: [
          {
            id: "opt-1",
            ...
            outcome: "poor",
            explanation:
              "Too slow and inconsistent. Platform should provide easy tooling.",
            skillsAssessed: ["Platform Engineering"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Platform thinking! Make observability automatic and consistent.",
            skillsAssessed: [
              "Observability",
              "Platform Engineering",
              "Process Design",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Partial visibility creates blind spots. Need comprehensive coverage.",
            skillsAssessed: ["Observability"],
          },
        ],
      },
      {
        ...
        phase: "Alerting & SLOs",
        situation:
          "Teams get alert fatigue from noisy alerts. How do you fix this?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Modern SRE practices! Alert on user impact, not infrastructure blips.",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "No alerts means no incident response. Need better signal, not silence.",
            skillsAssessed: ["Monitoring"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Doesn't solve root cause. SLO-based alerting is more effective.",
            skillsAssessed: ["Monitoring"],
          },
        ],
      },
      {
        ...
        phase: "Team Adoption",
        situation:
          "Observability platform ready. How do you drive adoption across 15 teams?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Too passive. Need active enablement and demonstration of value.",
            skillsAssessed: ["Communication"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Full enablement program! Education, support, and social proof.",
            skillsAssessed: [
              "Platform Engineering",
              "Communication",
              "Process Design",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Mandates create resentment. Better to demonstrate value and support adoption.",
            skillsAssessed: ["Communication"],
          },
        ],
      },
  ...
  },
  {
    ...
    description:
      "Migrate legacy on-premise application to cloud with zero downtime",
    scenario:
      "Your company is migrating a 10-year-old monolithic application from on-premise to AWS. Constraints: zero downtime, data compliance (GDPR), $500k budget, 6-month timeline. AI adapts based on your migration strategy skills.",
    challenges: [
      {
        id: "migration-strategy",
        phase: "Strategy Selection",
        situation:
          "Choose migration approach: lift-and-shift, replatform, or rearchitect?",
        correctOptionId: "opt-2",
        learningObjective:
          "Balance speed, cost, and modernization in migration decisions",
        options: [
          {
            id: "opt-1",
            ...
            outcome: "poor",
            explanation:
              "Too risky and expensive. Big rewrites often fail. Incremental approach is safer.",
          ...
          },
          {
            ...
            outcome: "optimal",
            explanation:
              "Smart hybrid approach! Get cloud benefits quickly, modernize incrementally.",
            skillsAssessed: [
              "Cloud Architecture",
              "Migration Planning",
              "Risk Management",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Misses cloud benefits. Not leveraging managed services wastes opportunity.",
            skillsAssessed: ["Cloud Architecture"],
          },
        ],
      },
      {
        ...
        situation:
          "2TB database needs migration. How do you ensure zero downtime?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Industry best practice! Continuous replication minimizes cutover downtime.",
            skillsAssessed: [
              "Migration Planning",
              "Technical Analysis",
              "Risk Management",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Violates zero-downtime requirement. 2TB takes hours to migrate.",
            skillsAssessed: ["Migration Planning"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Complex with foreign keys. Replication is cleaner solution.",
            skillsAssessed: ["Migration Planning"],
          },
        ],
      },
      {
        ...
        situation:
          "Migration cutover started but latency is 3x expected. What do you do?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Perfect! Always have tested rollback plan for migrations.",
            skillsAssessed: [
              "Risk Management",
              "Migration Planning",
              "Decision Making",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Dangerous! User impact worsens. Rollback and fix properly.",
      ...
      },
      {
        ...
        situation:
          "Migration successful. Cloud costs are 40% higher than projected. How do you optimize?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Wasteful. Optimize cloud usage before abandoning migration.",
            skillsAssessed: ["Cost Optimization"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive cost optimization! Multiple levers for savings.",
            skillsAssessed: [
              "Cost Optimization",
              "Cloud Architecture",
              "Process Improvement",
  ...
  },
  {
    ...
    description:
      "Manage production Kubernetes cluster serving 100+ microservices",
    scenario:
      "Your company runs 100+ microservices on Kubernetes. Cluster has stability issues: pods randomly evicted, nodes hitting resource limits, network policies causing connectivity issues. AI adapts based on your Kubernetes management skills.",
    challenges: [
      {
        id: "resource-management",
        phase: "Resource Optimization",
        situation:
          "Pods getting evicted due to resource pressure. How do you fix this?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive approach! Proper resource management plus capacity.",
            skillsAssessed: [
              "Kubernetes",
              "Platform Engineering",
              "Resource Management",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Dangerous! One bad service can starve entire cluster.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Treats symptom. Need proper resource configuration first.",
            skillsAssessed: ["Resource Management"],
          },
        ],
      },
      {
        ...
        situation:
          "Services can't communicate after network policies enabled. Debugging strategy?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Security regression. Need to fix policies, not remove them.",
            skillsAssessed: ["Kubernetes"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Systematic debugging! Network policies require careful testing.",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Won't fix policy issues. Need to correct policy configuration.",
            skillsAssessed: ["Kubernetes"],
          },
        ],
      },
      {
        ...
        situation:
          "Kubernetes version is 2 versions behind. How do you upgrade safely?",
        correctOptionId: "opt-1",
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Extremely risky. Always test and roll out incrementally.",
            skillsAssessed: ["Risk Management"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Too complex for version upgrade. In-place upgrade is standard.",
            skillsAssessed: ["Kubernetes"],
          },
        ],
      },
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Complete cloud-native observability stack! Industry standard.",
            skillsAssessed: [
              "Kubernetes",
              "Observability",
              "Platform Engineering",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Doesn't scale. Need automated monitoring at this scale.",
            skillsAssessed: ["Observability"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Manual and reactive. Need proactive monitoring and alerting.",
            skillsAssessed: ["Kubernetes"],
          },
        ],
      },
  ...
  },
  {
    ...
    prerequisites: ["Security fundamentals"],
    description:
      "Implement automated compliance controls for SOC 2 certification",
    scenario:
      "Company pursuing SOC 2 Type 2 certification. Manual compliance checks are error-prone and slow. Auditors need evidence of continuous compliance, not point-in-time checks. AI adapts based on your compliance automation skills.",
    challenges: [
      {
        id: "policy-as-code",
        phase: "Automated Controls",
        situation:
          "How do you automate compliance checks across infrastructure?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Comprehensive automation! Policy-as-code at every layer.",
            skillsAssessed: [
              "Compliance",
              "Security Automation",
              "Policy as Code",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Bottleneck and doesn't scale. Automation enables speed with safety.",
      ...
      },
      {
        ...
        situation:
          "Auditors need proof of access controls, encryption, and monitoring. How do you provide this?",
        correctOptionId: "opt-2",
        ...
        options: [
          {
            ...
            outcome: "poor",
            explanation:
              "Not scalable or reliable. Need automated evidence collection.",
            skillsAssessed: ["Compliance"],
          },
          {
            id: "opt-2",
            ...
            outcome: "optimal",
            explanation:
              "Modern compliance! Automated evidence generation for auditors.",
      ...
      },
      {
        ...
        situation:
          "Compliance scan found 50 S3 buckets without encryption. How do you fix this?",
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Safe automation! Automated with human approval for safety.",
            skillsAssessed: [
              "Security Automation",
              "Risk Management",
              "Process Design",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Slow and error-prone. Automation prevents recurrence.",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Shift-left compliance! Catch issues before production.",
            skillsAssessed: [
              "Compliance",
              "Security Automation",
              "Process Design",
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Stifles innovation. Automated compliance enables safe velocity.",
            skillsAssessed: ["Process Design"],
          },
        ],
      },
  ...
  },
  {
    ...
    scenario:
      "Major outage lasted 4 hours, impacted $500k revenue. Teams are defensive, finger-pointing at each other. You need to facilitate a productive post-mortem that drives improvements. AI adapts based on your post-mortem facilitation skills.",
    challenges: [
      {
        id: "blameless-culture",
        phase: "Setting the Tone",
        situation:
          'Post-mortem meeting starts with blame. "QA should have caught this!" How do you respond?',
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Perfect facilitation! Redirect to systemic issues, not individuals.",
            skillsAssessed: [
              "Blameless Culture",
              "Incident Management",
              "Leadership",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Blame destroys psychological safety. No one will be honest.",
            skillsAssessed: ["Leadership"],
          },
          {
            id: "opt-3",
            ...
            outcome: "suboptimal",
            explanation:
              "Too dismissive. Need to actively redirect to productive framing.",
      ...
      },
      {
        ...
        situation:
          "Team members have conflicting memories of event timing. How do you build accurate timeline?",
        correctOptionId: "opt-2",
      ...
      },
      {
        ...
        situation:
          'Initial diagnosis: "developer made a typo." Is this the root cause?',
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Excellent root cause analysis! Dig to systemic issues.",
            skillsAssessed: [
              "Incident Management",
              "Process Improvement",
              "Critical Thinking",
          ...
          },
          {
            ...
            outcome: "poor",
            explanation:
              "Too shallow. Human error is never root cause. Systems should prevent errors.",
            skillsAssessed: ["Incident Management"],
          },
          {
            id: "opt-3",
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "May miss important systemic fixes. Need impact-based prioritization.",
            skillsAssessed: ["Process Improvement"],
          },
        ],
      },
  ...
  },
  {
    ...
    scenario:
      "Engineering team velocity decreasing. Tech debt piling up: legacy code, outdated dependencies, missing tests. Product wants features, engineering wants refactoring time. You need to build consensus. AI adapts based on your technical debt management skills.",
    challenges: [
      {
        id: "debt-quantification",
        phase: "Making Debt Visible",
        situation:
          'Product says "tech debt isn\'t a priority." How do you make the business case?',
        correctOptionId: "opt-1",
        ...
        options: [
          {
            ...
            outcome: "optimal",
            explanation:
              "Business language! Connect tech debt to outcomes leadership cares about.",
            skillsAssessed: [
              "Technical Leadership",
              "Stakeholder Management",
              "Communication",
      ...
      },
      {
        ...
        situation:
          "How do you allocate team capacity between features and tech debt?",
        correctOptionId: "opt-2",
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "Age doesn't equal impact. Prioritize by risk and value.",
            skillsAssessed: ["Prioritization"],
          },
        ],
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            outcome: "suboptimal",
            explanation:
              "False trade-off. Quality and speed can coexist with good practices.",
            skillsAssessed: ["Technical Leadership"],
          },
        ],
      },
