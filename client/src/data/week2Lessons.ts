...
export const week2Lesson1GitBasics: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Learn essential Git commands for tracking changes, collaborating, and managing code versions.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn Git by executing each command step-by-step. You will create a repository, make commits, and work with branches.",
    steps: [
      {
        stepNumber: 1,
        instruction:
          "Configure your Git identity (required before first commit)",
        command:
          'git config --global user.name "Your Name" && git config --global user.email "you@example.com"',
        explanation:
          "Git needs to know who you are for commit attribution. Use --global to set this once for all repositories.",
      ...
      },
      {
        ...
        explanation:
          "Create a workspace for your Git repository. The && operator runs the second command only if the first succeeds.",
        expectedOutput:
          "Directory created, prompt changes to show new location",
        validationCriteria: [
      ...
      },
      {
        ...
        command: "git init",
        explanation:
          "This creates a .git directory that stores all version history. Your directory is now a Git repository.",
        expectedOutput:
      ...
      },
      {
        ...
        explanation:
          "Create a README file with a markdown heading. The > operator redirects output to a new file.",
      ...
      },
      {
        ...
        explanation:
          "Staging (adding) tells Git which changes you want to include in the next commit. Think of it as preparing items for a snapshot.",
        expectedOutput: "No output (silent success)",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "A commit is a snapshot of your project at this moment. The -m flag lets you include a message describing the changes.",
        expectedOutput:
      ...
      },
      {
        ...
        explanation:
          "Branches let you work on new features without affecting the main codebase. This creates a new branch but does not switch to it.",
        expectedOutput: "No output (silent success)",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "Checkout switches your working directory to a different branch. Changes you make now will be on feature-login, not main.",
      ...
      },
      {
        ...
        explanation:
          "Add content to README. The >> operator appends to existing file instead of overwriting.",
      ...
      },
      {
        ...
        command:
          'git add README.md && git commit -m "Add login feature description"',
        explanation:
          "Stage and commit in one line using &&. This records your feature work on the feature-login branch.",
        expectedOutput:
          "[feature-login abc5678] Add login feature description\n 1 file changed, 1 insertion(+)",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "Return to the main branch. Notice that your feature changes disappear from README (they exist only on feature-login).",
      ...
      },
      {
        ...
        explanation:
          "Merge brings changes from feature-login into main. This is how completed features get integrated.",
        expectedOutput:
    ...
    expectedOutcome:
      "You have learned Git fundamentals: repository initialization, staging, committing, branching, merging. You can now track code changes and work on features independently.",
  },

  walk: {
    introduction:
      "Practice Git workflows with fill-in-the-blank exercises. Each scenario requires you to recall and apply the correct commands.",
    exercises: [
      {
        exerciseNumber: 1,
        scenario:
          "You need to start tracking a new project with Git. Create the repository and make your first commit.",
        template:
        ...
        explanation:
          "git init creates repository, git add stages changes, git commit -m records snapshot with message.",
      },
      {
        exerciseNumber: 2,
        scenario:
          "You have uncommitted changes and want to see what has been modified before staging.",
        template:
        ...
        solution:
          'git status\ngit add app.js\ngit commit -m "Update app logic"',
        explanation:
          "git status shows modified files, git diff shows actual changes. Always review before committing.",
      },
      {
        exerciseNumber: 3,
        scenario:
          "Create a new branch for a feature, switch to it, and make a commit.",
        template:
        ...
        explanation:
          "git branch creates new branch, git checkout switches to it. Alternative: git checkout -b combines both.",
      },
      {
        exerciseNumber: 4,
        scenario:
          "You finished a feature branch and need to merge it into main.",
        template:
        ...
        explanation:
          "Switch to target branch (main) first, then merge source branch (feature). -d deletes merged branch.",
      },
      {
        exerciseNumber: 5,
        scenario:
          "View your commit history and check which branch you are currently on.",
        template: "git _____\ngit _____ --oneline\ngit branch",
        blanks: [
          {
            id: "status",
        ...
        solution: "git status\ngit log --oneline\ngit branch",
        explanation:
          "git status shows current state, git log shows history, git branch lists all branches.",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Set up a Git workflow for a web development project with proper branching strategy",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        description:
          "Repository initialized with main branch containing README, .gitignore, and initial commit",
        validationCriteria: [
        ...
        hintIfStuck:
          'Use git init, create files with echo or text editor, git add ., then git commit -m "message"',
      },
      {
        checkpoint: "Feature branches created",
        description:
          "Two feature branches created (feature-frontend and feature-backend) with at least one commit each",
        validationCriteria: [
        ...
        hintIfStuck:
          "Use git checkout -b <branch> to create and switch, make file changes, then commit. Repeat for second branch.",
      },
      {
        checkpoint: "Branches merged successfully",
        description:
          "Successfully merged both feature branches into main and resolved any conflicts",
        validationCriteria: [
        ...
        hintIfStuck:
          "git checkout main, then git merge <branch> for each. If conflict occurs, edit files manually, remove markers, git add conflicted-file, then git commit.",
      },
    ],
    resourcesAllowed: [
      "git --help <command>",
  ...
  runIndependent: {
    objective:
      "Establish a complete Git workflow for a microservices project with branching, tagging, and collaboration practices",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 30,
        passingThreshold:
          "Uses main + develop + at least 2 feature branches. Follows consistent naming convention.",
      },
      {
        criterion: "Commit Quality",
        weight: 25,
        passingThreshold:
          'All commits have clear, descriptive messages. No "WIP" or "fix" messages. Atomic commits (one logical change per commit).',
      },
      {
        criterion: "Merge Management",
        weight: 25,
        passingThreshold:
          "All merges complete successfully. No merge conflict markers left in code. Proper merge direction (feature → develop → main).",
      },
      {
        criterion: "Repository Hygiene",
        weight: 20,
        passingThreshold:
          ".gitignore excludes build artifacts and secrets. No unnecessary files tracked. README documents workflow.",
      },
    ],
  },
