...
export const week12Lesson2DevOpsCareer: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Master DevOps job search: resume optimization, technical interviews, behavioral questions, salary negotiation, and career advancement strategies.",
    learningObjectives: [
    ...
    steps: [
      {
        ...
        commonMistakes: [
          "Applying to all roles without targeting",
          "Not researching company needs",
        ],
      },
      {
        stepNumber: 2,
      ...
      },
      {
        ...
        explanation:
          "System design: clarify requirements, draw architecture, discuss components, address scale/reliability/security. Show tradeoffs, justify decisions.",
      ...
      },
      {
        ...
        commonMistakes: [
          "Generic headline",
          "About section reads like resume",
          "Missing skills",
        ],
      },
      {
  ...
  walk: {
    introduction:
      "Apply career preparation concepts through hands-on exercises.",
    exercises: [
      {
        exerciseNumber: 1,
...
- Automated __SECURITY__ scanning catching vulnerabilities pre-production`,
        ...
        solution:
          'Resume bullets quantify impact: "Reduced deployment time from 2 hours to 15 minutes" (88% improvement), "Decreased costs by 30%". Shows business value, not just technical work.',
        explanation:
          "Quantifiable achievements demonstrate impact more than task descriptions",
      },
      {
        exerciseNumber: 2,
...
**R**esult: Deployment time reduced to __15 MINUTES__ (__88%__ faster), errors decreased __90%__, enabled __15+__ deploys per day`,
        ...
        solution:
          "STAR answer: Situation (2-hour deployments with errors), Task (automate), Action (mapped process, GitOps, CI/CD, tests, training), Result (15min, 88% faster, 90% fewer errors, 15+ deploys/day).",
        explanation:
          "STAR method structures behavioral answers with quantifiable results",
      },
      {
        exerciseNumber: 3,
...
- **Ingress**: __HTTP__ routing to Services`,
        ...
        solution:
          "Kubernetes has control plane (API Server, etcd, Scheduler, Controllers) and worker nodes (kubelet, kube-proxy, runtime). Key resources: Pod, Deployment, Service, Ingress. Clear, structured explanation.",
        explanation:
          "Technical answers should be clear, structured, demonstrating deep understanding",
      },
      {
        exerciseNumber: 4,
...
(Remain __POSITIVE__, data-driven, emphasize __VALUE__)`,
        ...
        solution:
          "Negotiation: Thank them, show excitement. Cite research (levels.fyi), achievements (80% improvement), portfolio. Give range ($130k-$145k). Ask about flexibility. Stay positive, professional.",
        explanation:
          "Salary negotiation requires research, confidence, and professionalism",
      },
      {
        exerciseNumber: 5,
...
- Does the company support __CONFERENCES__?`,
        ...
        solution:
          "Ask about: role expectations (success in 6 months, challenges), technology (tech stack, CI/CD maturity), culture (work-life balance, failure handling), growth (career ladder, mentoring, conferences).",
        explanation:
          "Thoughtful questions show genuine interest and help evaluate fit",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Complete DevOps job search preparation: resume, LinkedIn, GitHub, interview skills, technical prep, and offer negotiation",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck:
          'Resume: use "Reduced X by Y%" format. LinkedIn: headline shows impact. GitHub: pin best projects with professional READMEs. Research companies on levels.fyi, LinkedIn.',
      },
      {
        ...
        hintIfStuck:
          "STAR: Write out 5-7 diverse stories. Technical: Review key concepts, practice explaining aloud. System design: Clarify requirements, draw diagrams, discuss tradeoffs. Mock interview with friend.",
      },
      {
        ...
        hintIfStuck:
          "Research levels.fyi, Glassdoor for salary data. Understand total comp: base + bonus + equity + benefits. Practice negotiation script with friend. Focus on value, not desperation.",
      },
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective:
      "Execute complete DevOps job search: build portfolio, optimize profiles, prepare comprehensively for interviews, apply strategically, and negotiate offers successfully",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 25,
        passingThreshold:
          "Resume with quantified achievements. LinkedIn optimized with headline showing value. GitHub with professional pinned repos. Portfolio project documented. Materials ATS-friendly and customized per role.",
      },
      {
        criterion: "Interview Preparation",
        weight: 30,
        passingThreshold:
          "STAR stories prepared covering diverse scenarios. Technical topics reviewed deeply. System design approach practiced. Questions to ask prepared. Mock interviews completed. Confident communication demonstrated.",
      },
      {
        criterion: "Job Search Strategy",
        weight: 20,
        passingThreshold:
          "Target companies identified (20+). Applications customized and tracked. Networking active (meetups, LinkedIn, open source). Follow-ups systematic. Multiple channels used (LinkedIn, referrals, direct).",
      },
      {
        criterion: "Negotiation Skills",
        weight: 25,
        passingThreshold:
          "Market rates researched (levels.fyi). Total comp understood (base, bonus, equity, benefits). Negotiation script practiced. Confidence in asking for market value. Multiple offers leveraged. Red flags identified.",
      },
    ],
  },
