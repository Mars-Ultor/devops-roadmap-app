...
export const SCENARIO_CHALLENGES: ChallengeScenario[] = [
  // Week 1-4: Beginner Challenges
  {
    ...
    scenario:
      "You need to deploy a basic Node.js web application. The Dockerfile is provided but the container won't start. Users are reporting that the application is not accessible.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 300,
        content:
          "Check the Dockerfile for common issues like missing dependencies or wrong port exposure",
        penalty: 1.0,
        category: "diagnostic",
      },
      {
        ...
        triggerValue: 240,
        content:
          "Look at the package.json to understand what dependencies are needed",
        penalty: 1.2,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    scenario:
      "The development team has been working on multiple features simultaneously. The Git repository has become messy with incorrect branch naming, uncommitted changes, and merge conflicts. Clean up the repository structure.",
    objectives: [
    ...
    hints: [
      {
        ...
        trigger: "request",
        content:
          "Use git branch -a to see all branches, then git branch -m to rename them",
        penalty: 1.0,
        category: "solution",
      },
    ],
...

  {
    ...
    scenario:
      'A Node.js application is failing to connect to the database. The error shows "connection refused". The application should use environment variables for configuration but they\'re not being read properly.',
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 180,
        content:
          "Check how environment variables are accessed in Node.js (process.env.VARIABLE_NAME)",
        penalty: 1.1,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    scenario:
      "Your GitHub Actions workflow is failing. The build step completes successfully but the deployment step fails with permissions errors. The team needs this fixed urgently to deploy a critical hotfix.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 240,
        content:
          "Check the workflow secrets and ensure deployment credentials are properly configured",
        penalty: 1.1,
        category: "diagnostic",
      },
    ],
  ...
  // Week 5-8: Intermediate Challenges
  {
    ...
    scenario:
      'You deployed a web application to Kubernetes but the pods are stuck in "Pending" status. The kubectl describe pod command shows scheduling issues. Users cannot access the application.',
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 240,
        content:
          "Use kubectl describe pod <pod-name> to see detailed scheduling information",
        penalty: 1.2,
        category: "diagnostic",
      },
      {
        ...
        triggerValue: 300,
        content:
          "Check node resources with kubectl describe node and compare with pod requests",
        penalty: 1.4,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    timeLimitSeconds: 600, // 10 minutes
    scenario:
      "Your NGINX load balancer is sending all traffic to a single backend server instead of distributing it across 3 servers. One server is overloaded while the others sit idle.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 300,
        content:
          "Check the upstream block configuration and ensure all servers are listed with proper weights",
        penalty: 1.2,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    description:
      "Fix application performance issues caused by improper connection pooling",
    difficulty: "week5-8",
    type: "daily",
    timeLimitSeconds: 660, // 11 minutes
    scenario:
      'Your application is experiencing intermittent "connection timeout" errors during peak traffic. Database CPU is at 20% but connection errors are spiking. The connection pool settings need optimization.',
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 300,
        content:
          "Check max pool size vs concurrent connections needed. Pool too small causes timeouts.",
        penalty: 1.3,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    scenario:
      "The CI/CD pipeline is failing during the build stage. The error log shows dependency installation issues. Recent code changes introduced new packages that aren't being installed correctly.",
    objectives: [
    ...
    hints: [
      {
        ...
        trigger: "request",
        content:
          "Check the pipeline configuration file for dependency installation steps",
        penalty: 1.2,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    timeLimitSeconds: 660, // 11 minutes
    scenario:
      "Your team is receiving 500+ alerts per day, most of them false positives. Critical alerts are being missed. You need to tune alert thresholds and reduce alert fatigue.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 330,
        content:
          "Use statistical analysis to set thresholds based on historical patterns, not arbitrary values",
        penalty: 1.2,
  ...
  // Week 9-12: Advanced Challenges
  {
    ...
    description:
      "Handle a critical database outage affecting user transactions",
    difficulty: "week5-8",
    type: "weekly",
    timeLimitSeconds: 7200, // 2 hours
    scenario:
      "CRITICAL: Production database is down. Users cannot login, place orders, or access their accounts. The database server shows high CPU usage and connection timeouts. Business impact: $50,000+ per hour in lost revenue.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 1800,
        content:
          "Start with basic database connectivity checks and resource monitoring",
        penalty: 1.3,
        category: "diagnostic",
      },
      {
        ...
        triggerValue: 2700,
        content:
          "Check for long-running queries, connection pool exhaustion, or resource constraints",
        penalty: 1.5,
        category: "diagnostic",
      },
      {
        ...
        trigger: "request",
        content:
          "Consider database restart as last resort - focus on identifying the root cause first",
        penalty: 2.0,
        category: "best_practice",
      },
    ],
  ...
  // Week 9-12: Advanced Challenges
  {
    ...
    scenario:
      "You need to implement a canary deployment strategy using Istio service mesh. Route 10% of traffic to the new version while monitoring for issues. The current configuration is not working properly.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 600,
        content:
          "Create a VirtualService with HTTP route rules and weight-based routing",
        penalty: 1.4,
        category: "solution",
      },
      {
        ...
        triggerValue: 900,
        content:
          "Ensure DestinationRule defines subsets matching your deployment labels",
        penalty: 1.6,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    description:
      "Recover from Terraform state file issues blocking deployments",
    difficulty: "week9-12",
    type: "daily",
    timeLimitSeconds: 900, // 15 minutes
    scenario:
      "Terraform state is out of sync with actual infrastructure. Terraform apply fails with state lock errors and drift detection shows mismatches. Team cannot deploy critical infrastructure changes.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 450,
        content:
          "Use terraform state commands to inspect and fix state issues. Consider terraform refresh.",
        penalty: 1.4,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    description:
      "Emergency patch deployment for critical security vulnerability",
    difficulty: "week9-12",
    type: "daily",
    timeLimitSeconds: 1080, // 18 minutes
    scenario:
      "A critical CVE has been discovered affecting your production containers. You have 2 hours to patch all systems. Security team demands immediate action. Zero-downtime deployment required.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 600,
        content:
          "Use rolling deployment strategy with health checks to ensure zero downtime",
        penalty: 1.5,
        category: "best_practice",
      },
    ],
...

  {
    ...
    timeLimitSeconds: 1200, // 20 minutes
    scenario:
      "Primary AWS region (us-east-1) is experiencing major outage. You need to failover to backup region (us-west-2) immediately to maintain service availability. DNS, databases, and application tiers all need coordination.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 600,
        content:
          "Follow the DR runbook: 1) Stop writes to primary 2) Promote replica 3) Update DNS 4) Start writes",
        penalty: 1.6,
        category: "best_practice",
      },
    ],
...

  {
    ...
    scenario:
      "Your Kubernetes cluster is 3 versions behind and must be upgraded to receive critical security patches. 50+ production workloads running. Zero downtime requirement. Rollback plan required.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 750,
        content:
          "Upgrade control plane first, then worker nodes one at a time with pod drain",
        penalty: 1.5,
        category: "best_practice",
      },
    ],
  ...
  // Weekly Boss Battles - End of week challenges
  {
    ...
    description:
      "Deploy and troubleshoot a multi-container application under time pressure",
    difficulty: "week1-4",
    type: "weekly",
    timeLimitSeconds: 3600, // 1 hour
    scenario:
      "URGENT: The development team pushed a new multi-service application to staging but it's completely broken. You have 1 hour to get it working before the demo to stakeholders. The application has a frontend, backend API, and database that all need to communicate.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 1200,
        content:
          "Check docker-compose.yml for network configuration and port mappings",
        penalty: 1.2,
        category: "diagnostic",
      },
      {
        ...
        triggerValue: 1800,
        content:
          "Use docker logs to see why services are failing. Common issues: wrong env vars, port conflicts",
        penalty: 1.4,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    description:
      "Recover from a cascading failure in production Kubernetes cluster",
    difficulty: "week9-12",
    type: "weekly",
    timeLimitSeconds: 7200, // 2 hours
    scenario:
      "EMERGENCY: Production Kubernetes cluster experiencing cascading failures. Multiple pods in CrashLoopBackOff, nodes becoming NotReady, and services are intermittently unavailable. Customer support is flooded with complaints. The cluster was fine 2 hours ago.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 2400,
        content:
          "Check cluster events, node status, and pod logs to find the initial failure point",
        penalty: 1.4,
        category: "diagnostic",
      },
      {
        ...
        triggerValue: 3600,
        content:
          "Common triggers: resource exhaustion, failed deployments, network issues, or cert expiration",
        penalty: 1.6,
        category: "diagnostic",
      },
    ],
    ...
    hints: [
      {
        ...
        triggerValue: 3600,
        content:
          "Follow DR runbook: 1) Verify backups 2) Promote DB replicas 3) Update DNS 4) Validate services",
        penalty: 1.5,
        category: "best_practice",
      },
      {
        ...
        triggerValue: 5400,
        content:
          "Critical path: Database promotion, DNS propagation, service health checks. Parallelize where possible.",
        penalty: 1.7,
        category: "solution",
      },
    ],
  ...
  // Capstone Challenge
  {
    ...
    description:
      "Handle a catastrophic production outage affecting millions of users",
    difficulty: "week13-16",
    type: "capstone",
    timeLimitSeconds: 14400, // 4 hours
    scenario:
      "CRITICAL INCIDENT: Global production outage affecting 2M+ users. Complete service unavailability across all regions. Revenue loss: $200,000/hour. Social media blowing up with user complaints. Executive team demanding immediate updates. You are the incident commander.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 1800,
        content:
          "Start with the incident response checklist: alert team, establish timeline, gather initial data",
        penalty: 1.5,
        category: "best_practice",
      },
      {
        ...
        triggerValue: 3600,
        content:
          "Focus on high-level symptoms first - check global load balancers, DNS, and core infrastructure",
        penalty: 1.8,
        category: "diagnostic",
      },
      {
        ...
        triggerValue: 5400,
        content:
          "Consider infrastructure-level issues: region failures, network outages, or configuration changes",
        penalty: 2.0,
        category: "diagnostic",
      },
    ],
  ...
  // Additional Daily Drills - Week 1-4 (Beginner)
  {
    ...
    timeLimitSeconds: 480, // 8 minutes
    scenario:
      "Your Node.js application is failing to connect to the database. The connection string is hardcoded in the source code, but it should use environment variables. The app crashes on startup with connection errors.",
    objectives: [
...

  {
    ...
    timeLimitSeconds: 420, // 7 minutes
    scenario:
      'Your web application cannot read its configuration files. The error shows "Permission denied" when trying to access config files. The application user doesn\'t have proper permissions.',
    objectives: [
  ...
  // Additional Daily Drills - Week 5-8 (Intermediate)
  {
    ...
    timeLimitSeconds: 600, // 10 minutes
    scenario:
      "Your multi-service application using Docker Compose is failing because services are starting in the wrong order. The web app starts before the database is ready, causing connection failures.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 240,
        content:
          "Use depends_on with healthcheck conditions in docker-compose.yml",
        penalty: 1.2,
        category: "solution",
      },
    ],
...

  {
    ...
    timeLimitSeconds: 540, // 9 minutes
    scenario:
      "Your feature branch has merge conflicts with main branch. Multiple developers modified the same files. You need to resolve conflicts and complete the merge without breaking functionality.",
    objectives: [
    ...
    hints: [
      {
        ...
        trigger: "request",
        content:
          "Use git status to see conflicted files, then edit them manually",
        penalty: 1.0,
        category: "solution",
      },
      {
        ...
        triggerValue: 300,
        content:
          "Look for <<<<<<< HEAD, =======, and >>>>>>> markers in conflicted files",
        penalty: 1.2,
        category: "solution",
      },
    ],
  ...
  // Additional Daily Drills - Week 9-12 (Advanced)
  {
    ...
    timeLimitSeconds: 720, // 12 minutes
    scenario:
      "Production pods are being killed by Kubernetes due to out-of-memory errors. The application needs proper resource limits and requests configured to prevent OOM kills while ensuring efficient resource usage.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 360,
        content:
          "Use kubectl top pods to monitor resource usage, set limits 20-50% above normal usage",
        penalty: 1.3,
        category: "diagnostic",
      },
    ],
...

  {
    ...
    scenario:
      "Your monitoring system is missing critical alerts. You need to create Prometheus alerting rules for service availability, error rates, and resource usage. Current alerts are either too noisy or missing important issues.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 420,
        content:
          "Use PromQL queries to test alert conditions before creating rules",
        penalty: 1.4,
        category: "solution",
      },
    ],
    resources: [
      ...
      },
      {
        ...
        content:
          "kubectl exec -it prometheus-pod -- promtool check rules /etc/prometheus/alerts.yml",
        available: true,
      },
    ],
  ...
  // Additional Daily Drills - Week 13-16 (Expert)
  {
    ...
    scenario:
      "Your primary cloud provider is experiencing region-wide outage. You must failover your entire application stack to a secondary cloud provider. This involves DNS updates, database replication, and service migration with zero data loss.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 900,
        content:
          "Use global DNS services (Route53, Cloudflare) for instant failover",
        penalty: 2.0,
        category: "strategy",
      },
    ],
...

  {
    ...
    timeLimitSeconds: 1500, // 25 minutes
    scenario:
      "Your organization needs a self-service platform for developers to deploy applications. Create a GitOps-based pipeline that automatically provisions infrastructure, deploys applications, and manages environments based on pull requests.",
    objectives: [
    ...
    hints: [
      {
        ...
        triggerValue: 750,
        content:
          "Use ArgoCD for GitOps, Crossplane for infrastructure provisioning",
        penalty: 1.8,
...
export function getRecommendedScenarios(
  ...
  return SCENARIO_CHALLENGES.filter((scenario) => {
    ...
    const hasWeaknessTag = [...scenarioTags].some((tag) =>
      userWeaknesses.has(tag),
    );
    const hasStrengthTag = [...scenarioTags].some((tag) =>
      userStrengths.has(tag),
    );

    return (
      hasWeaknessTag || (hasStrengthTag && scenario.estimatedDifficulty <= 3)
    );
