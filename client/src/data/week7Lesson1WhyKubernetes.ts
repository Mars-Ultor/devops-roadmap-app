...
export const week7Lesson1WhyKubernetes: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Understand the problems Kubernetes solves and when to use container orchestration.",
    learningObjectives: [
  ...
  crawl: {
    ...
    steps: [
      ...
      },
      {
        ...
        expectedOutput:
          "Cluster architecture diagram with control plane and nodes",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          'echo "Deployment: Controller for stateless applications\\n- Desired state: \\"I want 3 replicas of my app\\"\\n- Creates ReplicaSet to maintain pod count\\n- Self-healing: Replaces failed pods automatically\\n- Scaling: Change replica count easily\\n- Rolling updates: Update pods with zero downtime\\n- Rollback: Revert to previous version if issues"',
        explanation:
          'Deployments are the standard way to run stateless applications in Kubernetes. You declare desired state ("I want 3 replicas") and the Deployment controller maintains it. If a pod crashes, Deployment creates a new one. Need more capacity? Change replicas to 5. Updates happen gradually (rolling update) - new pods start before old ones stop, ensuring zero downtime. If update fails, rollback to previous version. This is production-ready automation.',
    ...
    expectedOutcome:
      "Understand the problems Kubernetes solves, its architecture, core concepts (Pods, Deployments, Services), and when to use it vs alternatives.",
  },
  walk: {
    introduction:
      "Apply your Kubernetes knowledge to scenario-based exercises that test your understanding of orchestration concepts.",
    exercises: [
      {
        exerciseNumber: 1,
        scenario:
          "Your company runs 10 microservices on Docker. Each service runs on 3 servers for redundancy. Developers manually SSH to servers to deploy updates. Last week, a server crashed and 3 services went down until someone noticed. Explain how Kubernetes would solve these problems.",
        ...
        blanks: [
          {
            ...
            correctValue:
              "Slow, error-prone, inconsistent deployments across servers, no audit trail, requires access to production servers",
          ...
          },
          {
            ...
            correctValue:
              "Services stay down until someone notices and manually restarts them, leading to extended outages and manual intervention",
          ...
          },
          {
            ...
            correctValue:
              "Must manually configure load balancers when adding/removing servers, static configuration, can't adapt to failures",
          ...
          },
          {
            ...
            correctValue:
              "Must stop old version before starting new, causing downtime, or coordinate complex blue-green deployment manually",
          ...
          },
          {
            ...
            correctValue:
              "Declarative desired state (replicas: 3), automatic scheduling across nodes, consistent deployment process via kubectl or CI/CD",
            validationPattern:
              "declarative|desired.*state|replicas|schedule|kubectl|ci.*cd",
          },
          {
            ...
            correctValue:
              "Deployment controller automatically restarts failed pods, maintains desired replica count, recovers from node failures without manual intervention",
            validationPattern:
              "automatic|restart|replica|controller|maintain|recover",
          },
          {
            id: "service_solution",
            ...
            correctValue:
              "Stable DNS name and IP, automatic load balancing across healthy pods, dynamic endpoint updates as pods come and go",
            validationPattern:
              "dns|stable|load.*balanc|endpoint|dynamic|healthy",
          },
          {
            id: "rolling_solution",
            ...
            correctValue:
              "Start new pods before stopping old ones, gradually shift traffic, ensure minimum available pods throughout update, zero downtime",
            validationPattern:
              "gradual|before.*stop|traffic|minimum.*available|zero.*downtime",
          },
        ],
...
4. Rolling updates: Start new pods before stopping old ones, gradually shift traffic, ensure minimum available pods throughout update, zero downtime`,
        explanation:
          "Kubernetes transforms operational burden into declarative configuration. Instead of manually managing servers and services, you declare desired state and K8s maintains it automatically. Self-healing, load balancing, and zero-downtime deployments are built-in.",
      },
      {
        exerciseNumber: 2,
        scenario:
          "Compare Kubernetes architecture to traditional application deployment. Fill in the components and their purposes.",
        ...
        blanks: [
          {
            ...
            correctValue:
              "Distribute traffic across app servers, manually configured with server IPs",
            validationPattern:
              "distribut.*traffic|load.*balanc|server.*ip|manual",
          },
          {
            ...
            correctValue:
              "Run application processes, manually started/stopped, no automatic recovery",
          ...
          },
          {
            ...
            correctValue:
              "Human checks logs/metrics to detect issues, manual intervention to restart services",
          ...
          },
          {
            ...
            correctValue:
              "Human decides to add servers, manual provisioning and configuration",
          ...
          },
          {
            ...
            correctValue:
              "REST API for all cluster operations, authentication, authorization, admission control, stores in etcd",
          ...
          },
          {
            ...
            correctValue:
              "Decides which node to run each pod on based on resources, constraints, affinity rules",
          ...
          },
          {
            ...
            correctValue:
              "Maintains desired state by creating/updating/deleting resources, handles Deployments, ReplicaSets, Services",
            validationPattern:
              "desired.*state|maintain|create|update|reconcile|deployment|replicaset",
          },
          {
            id: "k8s_kubelet",
            ...
            correctValue:
              "Agent ensuring containers described in pods are running and healthy on the node",
          ...
          },
          {
            ...
            correctValue:
              "Stable network endpoint and load balancing for dynamic pods, DNS name and virtual IP",
          ...
          },
          {
            ...
            correctValue:
              "Declarative desired state for pods, manages replicas, rolling updates, self-healing",
            validationPattern:
              "desired.*state|replicas|pod|rolling.*update|self.*heal",
          },
        ],
...
K8s Object - Deployment → Purpose: Declarative desired state for pods, manages replicas, rolling updates, self-healing`,
        explanation:
          "Kubernetes automates what was manual in traditional deployments. The control plane components provide intelligence (scheduling, state management), while worker node components execute (running containers). K8s objects (Service, Deployment) provide abstractions for networking and lifecycle management.",
      },
      {
        exerciseNumber: 3,
        scenario:
          "You need to decide whether to use Kubernetes for different scenarios. For each, recommend Kubernetes or an alternative, with justification.",
...
Justification: ___________`,
        blanks: [
          ...
          },
          {
            ...
            correctValue:
              "Multiple microservices need orchestration, high scale requires autoscaling, multi-cloud strategy needs portability, managed K8s reduces operational burden",
            validationPattern:
              "microservice|orchestration|scale|autoscal|multi.*cloud|portab|managed",
          },
          {
            ...
            correctValue:
              "Use PaaS like Heroku, Render, Google Cloud Run, or AWS App Runner",
            validationPattern:
              "paas|heroku|render|cloud.*run|app.*runner|simple",
          },
          {
            ...
            correctValue:
              "Simple architecture doesn't need orchestration complexity, PaaS provides easier deployment and management, lower operational burden for small team, adequate scale for 1000 users",
            validationPattern:
              "simple|don.*t.*need|paas|easier|low.*operational|small.*team|adequate|overkill",
          },
          {
            ...
            correctValue:
              "Use serverless (AWS Lambda, Cloud Functions) or managed batch (AWS Batch, Cloud Run Jobs)",
            validationPattern:
              "serverless|lambda|function|batch|cloud.*run.*job",
          },
          {
            ...
            correctValue:
              "Event-driven workload fits serverless model, bursty pattern benefits from automatic scale-to-zero, pay only for processing time, no infrastructure to manage",
            validationPattern:
              "event.*driven|serverless|burst|scale.*zero|pay.*for|no.*infrastructure",
          },
          {
            ...
            correctValue:
              "Use Kubernetes with namespaces for isolation, managed service (EKS/GKE/AKS)",
          ...
          },
          {
            ...
            correctValue:
              "Namespaces provide team isolation, RBAC enables self-service with governance, supports multi-environment, standardized platform across teams, managed service reduces operational burden",
            validationPattern:
              "namespace|isolation|rbac|self.*service|multi.*environment|standard|managed",
          },
        ],
...
Justification: Namespaces provide team isolation, RBAC enables self-service with governance, supports multi-environment, standardized platform across teams, managed service reduces operational burden`,
      ...
      },
      {
        exerciseNumber: 4,
        scenario:
          "Design a Kubernetes deployment strategy for a web application. Fill in the architecture choices.",
...
- Auto-scaling: ___________`,
        blanks: [
          ...
          },
          {
            ...
            correctValue:
              "LoadBalancer Service or Ingress controller (preferred for path routing)",
            validationPattern:
              "loadbalancer|ingress|service.*type.*loadbalancer",
          },
          {
            id: "api_object",
          ...
          },
          {
            ...
            correctValue:
              "ClusterIP Service (internal only, frontend calls service DNS name)",
          ...
          },
          {
            ...
            correctValue:
              "ConfigMap for non-sensitive (DB_HOST), Secret for sensitive (DB_PASSWORD)",
          ...
          },
          {
            ...
            correctValue:
              "StatefulSet (for stateful workloads with persistent identity)",
          ...
          },
          {
            ...
            correctValue:
              "PersistentVolumeClaim (PVC) backed by cloud storage (EBS, Persistent Disk)",
          ...
          },
          {
            ...
            correctValue:
              "ClusterIP Service (internal only, only API can reach it)",
          ...
          },
          {
            ...
            correctValue:
              "Kubernetes reschedules pods from failed node to healthy nodes automatically",
            validationPattern:
              "reschedule|move|healthy.*node|automatic|pod.*recreate",
          },
          {
            id: "zero_downtime",
            ...
            correctValue:
              "Rolling update strategy (start new pods before stopping old, readiness probes ensure traffic only to ready pods)",
            validationPattern:
              "rolling.*update|readiness|probe|gradual|before.*stop",
          },
          {
            id: "autoscaling",
            ...
            correctValue:
              "HorizontalPodAutoscaler (HPA) based on CPU/memory or custom metrics",
            validationPattern:
              "horizontalpodautoscaler|hpa|autoscal|cpu|memory|metric",
          },
        ],
        ...
        blanks: [
          {
            ...
            correctValue:
              "DNS name (myapp.example.com) pointing to cloud load balancer IP",
          ...
          },
          {
            ...
            correctValue:
              "Kubernetes LoadBalancer Service (on NodePort of worker nodes)",
          ...
          },
          {
            ...
            correctValue:
              "Stable endpoint, load balancing across pod replicas, health checking",
          ...
          },
          {
            ...
            correctValue:
              "Database Service DNS name (e.g., postgres.default.svc.cluster.local)",
            validationPattern:
              "service.*dns|postgres|cluster[.]local|dns.*name",
          },
          {
            id: "db_service_type",
          ...
          },
          {
            ...
            correctValue:
              "Same path in reverse: pod → Service → cloud LB → user",
          ...
          },
          {
            ...
            correctValue:
              "Deployment controller creates new pod to replace it, Service routes around crashed pod",
            validationPattern:
              "deployment|create.*new|replace|service.*route|automatic",
          },
          {
            ...
            correctValue:
              "Scheduler reschedules pods from failed node to healthy nodes, Service updates endpoints",
            validationPattern:
              "reschedule|healthy.*node|scheduler|move|endpoint.*update",
          },
        ],
...
- If node fails: Scheduler reschedules pods from failed node to healthy nodes, Service updates endpoints`,
        explanation:
          "Requests flow through layers: DNS → cloud LB → LoadBalancer Service → pod. Services provide stable endpoints despite dynamic pods. Internal services (ClusterIP) enable pod-to-pod communication. Kubernetes continuously monitors desired vs actual state, automatically recovering from pod crashes and node failures.",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Analyze a real application and design a Kubernetes migration strategy with architecture, justification, and risk assessment.",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        description:
          "Analyze existing application: architecture diagram, deployment process, scaling limitations, pain points (manual work, downtime, inconsistency). Clearly articulate problems K8s would solve.",
        validationCriteria: [
        ...
        hintIfStuck:
          "Focus on operational pain: How long do deployments take? How often do things break? What requires manual intervention? What can't you do today that you wish you could?",
      },
      {
        checkpoint: "Kubernetes architecture designed and justified",
        description:
          "Design K8s architecture: map each component to K8s objects, define Services for networking, plan ConfigMaps/Secrets. Justify why K8s vs alternatives. Consider managed K8s vs self-managed.",
        validationCriteria: [
        ...
        hintIfStuck:
          "Start with application tiers: frontend → Deployment + LoadBalancer/Ingress, API → Deployment + ClusterIP Service, database → StatefulSet + PersistentVolume. Use namespaces for environments. Choose managed K8s to reduce operational burden.",
      },
      {
        checkpoint: "Migration and operational plan complete",
        description:
          "Create migration strategy: incremental rollout (parallel run, traffic shift), rollback plan, CI/CD integration. Define operational approach: monitoring, logging, team training, runbooks.",
        validationCriteria: [
        ...
        hintIfStuck:
          "Migration should be gradual: deploy to K8s dev/staging first, validate thoroughly, then gradually shift production traffic (10% → 50% → 100%) with ability to rollback. For operations, use managed services (CloudWatch/Stackdriver for logs, Prometheus for metrics). Train team before production migration.",
      },
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective:
      "Independently create a comprehensive Kubernetes adoption plan for a real or realistic application, including architecture, migration strategy, operational readiness, and business case.",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 25,
        passingThreshold:
          "K8s objects chosen appropriately for each component, Services configured correctly for networking, proper separation of concerns, uses managed K8s service",
      },
      {
        criterion: "Migration Strategy",
        weight: 20,
        passingThreshold:
          "Incremental approach with clear phases, validation gates between phases, rollback plan for each phase, minimal risk to production",
      },
      {
        criterion: "Operational Readiness",
        weight: 20,
        passingThreshold:
          "Monitoring and alerting defined, centralized logging, backup and DR strategy, runbooks for common scenarios, team training plan",
      },
      {
        criterion: "CI/CD Integration",
        weight: 15,
        passingThreshold:
          "Automated build/test/deploy pipeline, deploys to multiple environments, uses GitOps or similar for deployment automation, includes health checks and rollback capability",
      },
      {
        criterion: "Business Case",
        weight: 10,
        passingThreshold:
          "Cost analysis with realistic estimates, ROI calculation with time savings and downtime reduction, clear articulation of benefits beyond cost",
      },
      {
        criterion: "Documentation Quality",
        weight: 10,
        passingThreshold:
          "Clear diagrams, step-by-step procedures, runbooks covering key scenarios, team can follow documentation to execute plan",
      },
    ],
  },
