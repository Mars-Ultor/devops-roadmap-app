...
export const specializedLesson1SecurityIncident: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Master responding to critical security vulnerabilities affecting production systems.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn security incident response fundamentals through guided vulnerability scenario.",
    steps: [
      {
        stepNumber: 1,
        instruction: "Assess vulnerability scope and impact",
        command:
          "Review CVE details, affected systems inventory, and potential data exposure",
        explanation:
          "First step in security incident is understanding what you are dealing with. Review CVE severity, CVSS score, attack vectors, and map to your infrastructure.",
        expectedOutput:
          "Complete vulnerability impact assessment including affected systems, data at risk, and exploitation difficulty",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Isolate affected systems, block exploit vectors, enable enhanced monitoring",
        explanation:
          "Containment must balance security with availability. Use network policies, WAF rules, and monitoring to limit damage while maintaining critical services.",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Brief Security team, notify Compliance, engage external security consultants if needed",
        explanation:
          "Security incidents require coordination across specialized teams. Provide technical details to Security, compliance impact to Legal, and business risk to executives.",
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Assess impact of critical container runtime vulnerability affecting production Kubernetes clusters",
        ...
        startingCondition:
          "CVE published for Docker runtime, affects all versions in use, remote code execution possible",
        successCriteria: [
  ...
  walk: {
    introduction:
      "Apply security incident response skills with decision-making responsibility.",
    exercises: [
      {
        id: "security-walk-ex1",
        title: "Multi-Service Security Incident",
        description:
          "Respond to vulnerability affecting 15 microservices with varying criticality levels",
        difficulty: "advanced",
        estimatedTime: 30,
        objectives: [
        ...
        startingCondition:
          "15 services affected, 3 critical, 7 high-priority, 5 low-priority; patches available but require testing",
        successCriteria: [
  ...
  runGuided: {
    introduction:
      "Lead complex security incidents with guidance on best practices.",
    exercises: [
      {
        id: "security-run-guided-ex1",
        title: "Active Breach Response",
        description:
          "Respond to confirmed security breach with active attacker in environment",
        difficulty: "expert",
        estimatedTime: 45,
        objectives: [
        ...
        startingCondition:
          "Confirmed unauthorized access, attacker has persistence, lateral movement detected, customer data potentially accessed",
        successCriteria: [
  ...
  runIndependent: {
    introduction:
      "Demonstrate security incident response mastery independently.",
    exercises: [
      {
        id: "security-run-independent-ex1",
        title: "Complete Security Incident Lifecycle",
        description:
          "Lead full security incident from detection through remediation, recovery, and post-incident review",
        difficulty: "expert",
        estimatedTime: 60,
        objectives: [
        ...
        startingCondition:
          "Unusual activity detected in production, potential security incident, scope unknown",
        successCriteria: [
...
export const specializedLesson2Performance: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Master diagnosing and resolving complex performance issues in distributed systems.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn performance troubleshooting methodology through guided scenarios.",
    steps: [
      {
        stepNumber: 1,
        instruction: "Establish performance baseline and identify anomalies",
        command:
          "Review metrics: response time, throughput, error rate, resource utilization",
        explanation:
          "Performance troubleshooting starts with data. Compare current metrics against baseline to identify what changed and when.",
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        startingCondition:
          "API response times increased from 100ms to 300ms, error rate normal, CPU and memory usage unchanged",
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Resolve performance issues caused by inefficient database queries",
        difficulty: "advanced",
        estimatedTime: 30,
        objectives: [
        ...
        startingCondition:
          "Database CPU at 90%, slow query log showing problematic queries, application experiencing timeouts",
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Resolve cascading performance failure across microservices architecture",
        difficulty: "expert",
        estimatedTime: 40,
        objectives: [
        ...
        startingCondition:
          "Performance degradation spreading across services, distributed tracing shows complex dependency chains, traffic growing",
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Lead end-to-end performance optimization for high-traffic system",
        difficulty: "expert",
        estimatedTime: 50,
        objectives: [
        ...
        startingCondition:
          "System struggling with 2x traffic increase, multiple performance issues across stack",
        successCriteria: [
...
export const specializedLesson3Platform: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Build internal developer platforms that enable teams to ship faster with reliability.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn platform engineering fundamentals through building developer tools.",
    steps: [
      {
        stepNumber: 1,
        instruction: "Design self-service deployment platform",
        command:
          "Create platform specification for enabling developers to deploy services independently",
        explanation:
          "Platform engineering is about empowering developers with self-service tools while maintaining standards. Design must balance ease-of-use with safety.",
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Design self-service platform for deploying containerized applications",
        difficulty: "intermediate",
        estimatedTime: 25,
        objectives: [
        ...
        startingCondition:
          "Company has 20 development teams manually deploying to Kubernetes, inconsistent practices, security gaps",
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Implement golden path for microservice deployment with automatic best practices",
        difficulty: "advanced",
        estimatedTime: 35,
        objectives: [
        ...
        startingCondition:
          "Platform team tasked with creating standardized deployment path for 50+ microservices",
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Design and implement multi-tenant developer platform supporting multiple teams and environments",
        difficulty: "expert",
        estimatedTime: 45,
        objectives: [
        ...
        startingCondition:
          "Enterprise needs platform supporting 100+ teams across dev, staging, prod environments with cost controls",
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Build production-ready internal developer platform from requirements through operation",
        difficulty: "expert",
        estimatedTime: 60,
        objectives: [
        ...
        startingCondition:
          "Company needs internal developer platform to accelerate development and improve reliability",
        successCriteria: [
