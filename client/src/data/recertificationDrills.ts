...
export const SKILL_DECAY_MODELS: Record<string, SkillDecayModel> = {
  ...
  "kubernetes-fundamentals": {
    ...
    baseRetentionRate: 0.8,
    decayRatePerDay: 0.003,
    recertificationBoost: 0.9,
...
export const RECERTIFICATION_DRILLS: RecertificationDrill[] = [
  // BRONZE LEVEL - Basic Knowledge Verification
  {
    ...
    description:
      "Verify your understanding of basic Docker concepts and commands",
    category: "deployment",
    ...
    questions: [
      ...
      },
      {
        id: "q3",
        question:
          "True or False: Docker containers are immutable once created.",
        type: "true-false",
        correctAnswer: false,
        explanation:
          "Containers can be modified, but changes are lost when the container stops. Images are immutable.",
        difficulty: "basic",
        timeLimitSeconds: 20,
      },
    ],
...

  {
    ...
    questions: [
      ...
      },
      {
        id: "q2",
        question:
          "Which Kubernetes object is used to expose applications running in Pods?",
        type: "multiple-choice",
    ...
    questions: [
      {
        id: "q1",
        question:
          "You have a container that keeps restarting. Which command would you use to investigate?",
        type: "multiple-choice",
        options: [
        ...
        correctAnswer: 3,
        explanation:
          "All these commands are useful for troubleshooting container issues.",
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          "Blue-green deployment: deploy new version alongside old, test, switch traffic, then decommission old.",
        difficulty: "intermediate",
        timeLimitSeconds: 90,
      },
    ],
    ...
    questions: [
      {
        id: "q1",
        question:
          "Which of these is NOT a principle of the principle of least privilege?",
        type: "multiple-choice",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "Using root/admin access for all operations violates least privilege.",
        difficulty: "intermediate",
        timeLimitSeconds: 50,
      },
      {
        id: "q2",
        question:
          "What should you do if you find a high-severity vulnerability in production?",
        type: "scenario",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "Proper vulnerability management requires assessment, planning, testing, and controlled deployment.",
        difficulty: "intermediate",
        timeLimitSeconds: 75,
      },
    ],
    ...
    questions: [
      {
        id: "q1",
        question:
          "You notice increasing error rates but CPU and memory are normal. What should you investigate first?",
        type: "multiple-choice",
        options: [
        ...
        correctAnswer: 0,
        explanation:
          "Connection pool exhaustion often causes errors without high resource usage.",
        difficulty: "advanced",
        timeLimitSeconds: 60,
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "Distributed tracing requires both correlation IDs and proper tracing instrumentation.",
        difficulty: "advanced",
        timeLimitSeconds: 90,
      },
    ],
    ...
    questions: [
      {
        id: "q1",
        question:
          "When designing a multi-region architecture, which factor is most critical for data consistency?",
        type: "multiple-choice",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "CAP theorem (Consistency, Availability, Partition tolerance) is fundamental to multi-region design.",
        difficulty: "advanced",
        timeLimitSeconds: 75,
      },
      {
        id: "q2",
        question:
          "How would you implement chaos engineering in a production environment?",
        type: "scenario",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "Chaos engineering should start small and controlled, with proper monitoring and gradual production rollout.",
        difficulty: "advanced",
  ...
  // MASTER LEVEL - Thought Leadership
  {
    ...
    description:
      "Cutting-edge DevOps practices and organizational transformation",
    category: "recovery",
    ...
    questions: [
      {
        id: "q1",
        question:
          "How would you measure and improve DevOps culture in a large organization?",
        type: "scenario",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "DevOps culture requires measuring both technical and human factors for sustainable improvement.",
        difficulty: "advanced",
