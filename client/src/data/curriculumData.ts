...
export const curriculumData: Week[] = [
    ...
    labs: [
      {
        ...
        description:
          "Practice essential Linux commands in an interactive terminal environment.",
        difficulty: "beginner",
        estimatedTime: 30,
        xp: 100,
        tasks: [
        ...
        tcs: {
          ...
          conditions: {
            timeLimit: 30,
            environment:
              "Linux terminal with standard utilities (bash, coreutils)",
            resources: [
          ...
          standards: [
            {
              id: "std-1",
              description:
                "Successfully navigate to /home directory and confirm location with pwd",
              required: true,
              met: false,
            },
            {
              id: "std-2",
              description:
                "Create directory 'devops-practice' in correct location with proper naming",
              required: true,
              met: false,
            },
            {
              id: "std-3",
              description:
                "Create exactly three text files (file1.txt, file2.txt, file3.txt) in /home",
              required: true,
              met: false,
            },
            {
              id: "std-4",
              description:
                "Move all .txt files into devops-practice directory, leaving no files in /home",
              required: true,
              met: false,
            },
            {
              id: "std-5",
              description:
                "All commands executed without errors or permission issues",
              required: true,
              met: false,
            },
            {
              id: "std-6",
              description:
                "Final directory structure matches expected state (verified with ls -R)",
              required: true,
              met: false,
            },
          ],
        ...
        steps: [
          {
            ...
            description:
              "Use cd command to navigate to /home and verify with pwd",
            status: "in_progress",
          ...
          },
          {
            ...
            description:
              "Create a new directory called 'devops-practice' in /home",
            status: "locked",
            completedValidations: 0,
            validations: [
              {
      ...
      },
      {
        ...
        description:
          "Understand and modify Linux file permissions using chmod and chown.",
        difficulty: "beginner",
        estimatedTime: 25,
        xp: 100,
        tasks: [
        ...
        tcs: {
          ...
          standards: [
            ...
            },
            {
              id: "std-2",
              description:
                "Set executable permission on script.sh (verify with ls -l showing 'x' flag)",
              required: true,
              met: false,
            },
            {
              id: "std-3",
              description:
                "Create directory with correct 755 permissions (rwxr-xr-x)",
              required: true,
              met: false,
            },
            {
          ...
          standards: [
            {
              id: "std-1",
              description:
                "Successfully list all running processes using ps aux or equivalent",
              required: true,
              met: false,
            },
            {
              id: "std-2",
              description:
                "Filter process list using grep to find specific processes",
              required: true,
              met: false,
            },
            {
              id: "std-3",
              description:
                "Start process in background and verify with jobs command",
              required: true,
              met: false,
            },
            {
              id: "std-4",
              description:
                "Identify process PID and terminate using kill command",
              required: true,
              met: false,
            },
            {
              id: "std-5",
              description:
                "Verify process termination (process no longer in ps output)",
              required: true,
              met: false,
            },
          ],
  ...
  // WEEK 2: Version Control with Git & GitHub
  {
    ...
    description:
      "Master Git workflows and collaboration on GitHub - essential for modern DevOps.",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Initialize a repository, make commits, and push to GitHub.",
        difficulty: "beginner",
        estimatedTime: 30,
        xp: 100,
        tasks: [
  ...
  // WEEK 3: Cloud Fundamentals with AWS
  {
    ...
    labs: [
      ...
      },
      {
        ...
        description:
          "Add CloudFront distribution for faster global access and HTTPS.",
        difficulty: "intermediate",
        estimatedTime: 35,
        xp: 150,
        tasks: [
  ...
  // WEEK 4: Containers & Docker
  {
    ...
    description:
      "Master containerization with Docker - the foundation of modern application deployment.",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Pull images, run containers, and understand Docker basics.",
        difficulty: "beginner",
        estimatedTime: 30,
        xp: 100,
        tasks: [
  ...
  // WEEK 5: CI/CD with GitHub Actions
  {
    ...
    description:
      "Automate testing and deployment with continuous integration and delivery pipelines.",
    objectives: [
  ...
  // WEEK 10: Advanced Kubernetes & Cloud Native
  {
    ...
    description:
      "Master advanced Kubernetes patterns and cloud-native architectures.",
    objectives: [
  ...
  // WEEK 11: GitOps & Advanced IaC
  {
    ...
    description:
      "Implement GitOps workflows and advanced infrastructure patterns.",
    objectives: [
  ...
  // WEEK 12: Capstone & Career Preparation
  {
    ...
    description:
      "Complete your capstone project and prepare for your DevOps career.",
    objectives: [
    ...
    project: {
      ...
      description:
        "Build a complete production-ready application with full CI/CD, IaC, monitoring, and security.",
      xp: 1000,
    },
  },
];
...
export const cloudResumeChallenge = {
  ...
  description:
    "Note: This is an optional legacy project. The main curriculum now includes comprehensive projects throughout all 12 weeks.",
