...
export const masterLesson1GeneralistPath: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description: 'AI-powered comprehensive training across all DevOps domains with balanced skill development.',
    learningObjectives: [
  ...
  crawl: {
    introduction: 'Begin your generalist mastery journey with AI-guided skill assessment and personalized path.',
    steps: [
      {
        stepNumber: 1,
        instruction: 'Complete comprehensive skill assessment',
        command: 'Take adaptive assessment covering all DevOps domains: Infrastructure, CI/CD, Observability, Security, Performance',
        explanation: 'AI analyzes your strengths and weaknesses across all domains to create personalized learning path.',
        expectedOutput: 'Skill profile showing competency levels across all domains',
        validationCriteria: [
      ...
      },
      {
        ...
        command: 'Tackle AI-selected scenario matching your current skill level',
        explanation: 'AI selects scenario targeting your learning edge - challenging but achievable. Difficulty adapts based on performance.',
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Complete comprehensive assessment across Infrastructure, CI/CD, Observability, Security, and Performance domains',
        difficulty: 'adaptive',
        estimatedTime: 30,
        objectives: [
  ...
  walk: {
    introduction: 'Progress through personalized learning scenarios with adaptive difficulty.',
    exercises: [
      {
        id: 'master-generalist-walk-ex1',
        title: 'Adaptive Scenario Series',
        description: 'Complete series of 5 scenarios across different domains, difficulty adapts based on performance',
        difficulty: 'adaptive',
        estimatedTime: 40,
        objectives: [
        ...
        startingCondition: 'Initial assessment complete, personalized path defined',
        successCriteria: [
  ...
  runGuided: {
    introduction: 'Tackle complex scenarios requiring integration of multiple domains.',
    exercises: [
      {
        id: 'master-generalist-run-guided-ex1',
        title: 'Multi-Domain Integration Challenge',
        description: 'Solve complex problems requiring expertise across infrastructure, security, performance, and observability simultaneously',
        difficulty: 'adaptive',
        estimatedTime: 50,
        objectives: [
        ...
        startingCondition: 'Complex production issue requiring broad DevOps knowledge to resolve',
        successCriteria: [
  ...
  runIndependent: {
    introduction: 'Demonstrate generalist mastery through comprehensive capstone challenge.',
    exercises: [
      {
        id: 'master-generalist-run-independent-ex1',
        title: 'Generalist Mastery Capstone',
        description: 'Complete comprehensive challenge demonstrating mastery across all DevOps domains',
        difficulty: 'expert',
        estimatedTime: 90,
        objectives: [
        ...
        startingCondition: 'Startup needs complete DevOps platform built by single expert',
        successCriteria: [
...
export const masterLesson2SpecialistPath: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description: 'Deep expertise in chosen specialization: Security, Performance, Platform Engineering, or SRE.',
    learningObjectives: [
  ...
  crawl: {
    introduction: 'Deep dive into your chosen specialization with expert-level scenarios.',
    steps: [
      {
        stepNumber: 1,
        instruction: 'Select specialization track',
        command: 'Choose focus area: DevSecOps, Performance Engineering, Platform Engineering, or Site Reliability Engineering',
        explanation: 'Specialist path focuses deeply on one area. Choose based on interest, aptitude, and career goals.',
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Complete advanced scenarios in chosen specialization to establish expert-level foundation',
        difficulty: 'advanced',
        estimatedTime: 35,
        objectives: [
        ...
        startingCondition: 'Chosen specialization, ready for deep expertise development',
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Complete series of expert-level scenarios in specialization, progressively more complex',
        difficulty: 'expert',
        estimatedTime: 50,
        objectives: [
        ...
        startingCondition: 'Strong foundation in specialization, ready for expert challenges',
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Create comprehensive guide, tool, or framework in specialization that advances field',
        difficulty: 'expert',
        estimatedTime: 60,
        objectives: [
        ...
        startingCondition: 'Expert-level knowledge, ready to contribute to field',
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Complete comprehensive project demonstrating recognized expertise in chosen specialization',
        difficulty: 'expert',
        estimatedTime: 120,
        objectives: [
        ...
        startingCondition: 'Expert-level knowledge, ready to demonstrate mastery',
        successCriteria: [
