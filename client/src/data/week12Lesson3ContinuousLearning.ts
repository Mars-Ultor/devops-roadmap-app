...
export const week12Lesson3ContinuousLearning: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description: 'Master lifelong learning in DevOps: staying current with technology, building community, earning certifications, and advancing your career through continuous improvement.',
    learningObjectives: [
  ...
  crawl: {
    introduction: 'Learn continuous learning skills step-by-step. You will develop habits for staying current, build community connections, pursue certifications, and create career growth plans.',
    expectedOutcome: 'Complete learning plan, community engagement strategy, certification roadmap, open source contribution, career development goals, knowledge sharing habits',
    steps: [
      {
        stepNumber: 1,
        instruction: 'Assess current knowledge and identify gaps',
        command: 'cat > knowledge-assessment.md <<EOF\n# DevOps Knowledge Assessment\n\n## Current Proficiency (1-5 scale)\n\n**Infrastructure as Code:** 4/5\n- Terraform: Expert\n- CloudFormation: Intermediate\n- Pulumi: Beginner\n\n**Container Orchestration:** 5/5\n- Kubernetes: Expert\n- Docker: Expert\n- Helm: Advanced\n\n**CI/CD:** 4/5\n- GitHub Actions: Expert\n- Jenkins: Advanced\n- GitLab CI: Intermediate\n\n**Cloud Platforms:** 4/5\n- AWS: Expert\n- GCP: Advanced\n- Azure: Intermediate\n\n**Monitoring & Observability:** 4/5\n- Prometheus: Expert\n- Grafana: Expert\n- Jaeger: Advanced\n\n## Knowledge Gaps\n1. **Service Mesh:** Istio, Linkerd\n2. **Platform Engineering:** Backstage, Crossplane\n3. **Security:** DevSecOps, compliance\n4. **Emerging Tech:** eBPF, WebAssembly\n\n## Learning Priorities\n- Q1: Service mesh deep dive\n- Q2: Platform engineering patterns\n- Q3: Security certifications\n- Q4: Emerging technologies\nEOF',
        explanation: 'Knowledge assessment identifies strengths (Kubernetes, AWS) and gaps (service mesh, platform engineering). Prioritizes learning based on career goals and market trends.',
  ...
  walk: {
    introduction: 'Apply continuous learning concepts through hands-on exercises.',
    exercises: [
      {
        exerciseNumber: 1,
...
- [ ] Month 3: __CKS__ certification passed`,
        ...
        solution: '3-month plan: Month 1 (Istio service mesh), Month 2 (Backstage/Crossplane platform), Month 3 (CKS certification). Specific weekly goals, resources, tracking. Realistic and achievable.',
        explanation: 'Structured learning plans break down goals into manageable chunks'
      },
      {
        exerciseNumber: 2,
...
- [ ] Attended __MEETUP__`,
        ...
        solution: 'Community plan: Primary (Kubernetes Slack), Secondary (DevOps Reddit), Local (meetups). Progressive contribution: join → ask → answer → share. Builds network and learning.',
        explanation: 'Community engagement provides support, networking, and learning opportunities'
      },
      {
        exerciseNumber: 3,
...
- [ ] __TERRAFORM__ certification earned`,
        ...
        solution: 'Certification strategy: CKA (3 months, $300), AWS SA (2 months, $150), Terraform Associate (1 month, $70). Prioritized by career impact, preparation plan included.',
        explanation: 'Strategic certification pursuit maximizes ROI and career advancement'
      },
      {
        exerciseNumber: 4,
...
- [ ] Month 1: __TWITTER__ engagement increased`,
        ...
        solution: 'Content calendar: LinkedIn (3x/week), Blog (1x/month), Twitter (daily engagement). 80% value, 15% personal, 5% promotion. Consistent posting builds brand.',
        explanation: 'Consistent content creation builds personal brand and professional network'
      },
      {
        exerciseNumber: 5,
...
- [ ] __PROJECTS__ led`,
        ...
        solution: 'Goal tracking: 1-year (certifications, speaking), 3-year (senior role), 5-year (leadership). Quarterly reviews, skills development, success metrics. Measurable and achievable.',
        explanation: 'Structured goal tracking ensures continuous career progression'
      }
    ],
    hints: [
  ...
  runGuided: {
    objective: 'Establish lifelong learning habits, build professional community, pursue strategic certifications, and create career advancement plan',
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        description: 'Daily/weekly learning routine, information sources identified',
        validationCriteria: [
        ...
        hintIfStuck: 'Start small: 30 minutes daily reading, join one community, set one monthly goal. Use tools like Notion for tracking. Find accountability partner.'
      },
      {
        ...
        hintIfStuck: 'Start with Kubernetes Slack and DevOps Reddit. Lurk first, then ask questions. Find local meetups. Start with documentation improvements in open source.'
      },
      {
        checkpoint: 'Career development plan created',
        description: 'Certifications planned, goals set, personal brand strategy',
        validationCriteria: [
        ...
        hintIfStuck: 'Research certifications on levels.fyi. Set SMART goals. Start personal brand with LinkedIn optimization. Identify skills gaps through self-assessment.'
      }
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective: 'Build comprehensive continuous learning system: stay current with technology, actively contribute to community, earn strategic certifications, develop personal brand, and advance career through measurable goals',
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 30,
        passingThreshold: 'Consistent learning habits (daily reading, weekly labs, monthly projects). Skills gaps identified and addressed. Certifications earned strategically. Knowledge current with industry trends.'
      },
      {
        criterion: 'Community & Networking',
        weight: 25,
        passingThreshold: 'Active in multiple communities with meaningful contributions. Open source involvement with code/docs. Professional network built. Speaking opportunities pursued.'
      },
      {
        criterion: 'Career Advancement',
        weight: 25,
        passingThreshold: 'Clear career goals with measurable milestones. Personal brand developed through content. Salary negotiations successful. Leadership opportunities taken.'
      },
      {
        criterion: 'Knowledge Sharing & Impact',
        weight: 20,
        passingThreshold: 'Regular content creation (blog posts, presentations). Mentoring others. Industry contributions recognized. Thought leadership demonstrated.'
      }
    ]
  },
