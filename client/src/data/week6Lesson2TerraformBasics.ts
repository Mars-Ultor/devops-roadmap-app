...
export const week6Lesson2TerraformBasics: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description: 'Learn Terraform fundamentals: providers, resources, variables, state, and basic workflows.',
    learningObjectives: [
  ...
  crawl: {
    introduction: 'Learn Terraform step-by-step: installation, providers, resources, workflow commands, variables, outputs, and state management.',
    steps: [
      {
        stepNumber: 1,
        instruction: 'Install Terraform',
        command: '# macOS\nbrew tap hashicorp/tap\nbrew install hashicorp/tap/terraform\n\n# Windows (PowerShell)\nchoco install terraform\n\n# Linux\nwget https://releases.hashicorp.com/terraform/1.6.0/terraform_1.6.0_linux_amd64.zip\nunzip terraform_1.6.0_linux_amd64.zip\nsudo mv terraform /usr/local/bin/\n\n# Verify installation\nterraform version\n# Output: Terraform v1.6.0',
        explanation: 'Terraform is single binary. Install via package manager or download directly. Verify with terraform version. No dependencies needed.',
        expectedOutput: 'Terraform installed successfully, version command shows 1.6.0 or later.',
        validationCriteria: [
      ...
      },
      {
        ...
        command: 'mkdir terraform-demo && cd terraform-demo\n\ncat > main.tf << \'EOF\'\nterraform {\n  required_providers {\n    aws = {\n      source  = "hashicorp/aws"\n      version = "~> 5.0"\n    }\n  }\n}\n\nprovider "aws" {\n  region = "us-east-1"\n}\n\nresource "aws_instance" "example" {\n  ami           = "ami-0c55b159cbfafe1f0"  # Amazon Linux 2\n  instance_type = "t2.micro"\n\n  tags = {\n    Name = "terraform-example"\n  }\n}\nEOF',
        explanation: 'Terraform configuration in HCL (HashiCorp Configuration Language). terraform{} block declares providers. provider{} configures AWS. resource{} defines EC2 instance. .tf files contain infrastructure code.',
        expectedOutput: 'main.tf file created with provider and EC2 resource configuration.',
        validationCriteria: [
          'main.tf exists',
          'Valid HCL syntax',
          'Provider configured',
      ...
      },
      {
        ...
        command: '# Option 1: Environment variables (recommended for CI/CD)\nexport AWS_ACCESS_KEY_ID="your-access-key"\nexport AWS_SECRET_ACCESS_KEY="your-secret-key"\n\n# Option 2: AWS CLI credentials file (recommended for dev)\naws configure\n# Prompts for access key, secret key, region\n\n# Option 3: IAM instance role (for EC2)\n# No configuration needed\n\n# Verify\naws sts get-caller-identity',
        explanation: 'Terraform needs AWS credentials. Environment variables or AWS CLI config. Never hardcode credentials in .tf files. Verify with AWS STS.',
        expectedOutput: 'AWS credentials configured, get-caller-identity shows your account.',
        validationCriteria: [
      ...
      },
      {
        ...
        explanation: 'terraform init downloads provider plugins (AWS). Creates .terraform directory and lock file. Must run first, and after adding new providers. Safe to run multiple times.',
        expectedOutput: '.terraform/ directory created, providers downloaded, terraform.lock.hcl generated.',
        validationCriteria: [
      ...
      },
      {
        ...
        explanation: 'terraform plan shows what will change. + means create, ~ means modify, - means destroy. (known after apply) are values set by AWS. Always run plan before apply to review changes.',
      ...
      },
      {
        ...
        explanation: 'terraform apply creates infrastructure. Shows plan, requires "yes" confirmation. Creates resources, updates state file. Gives resource IDs when complete.',
        expectedOutput: 'EC2 instance created successfully, state file updated, instance ID displayed.',
        validationCriteria: [
      ...
      },
      {
        ...
        explanation: 'State file maps Terraform code to real resources. Contains resource IDs, attributes, dependencies. Critical file - losing it means losing track of infrastructure. Contains sensitive data. Never commit to Git.',
        expectedOutput: 'Understanding: State file is Terraform\'s database of managed infrastructure.',
        validationCriteria: [
      ...
      },
      {
        ...
        command: 'cat > variables.tf << \'EOF\'\nvariable "region" {\n  description = "AWS region"\n  type        = string\n  default     = "us-east-1"\n}\n\nvariable "instance_type" {\n  description = "EC2 instance type"\n  type        = string\n  default     = "t2.micro"\n}\n\nvariable "instance_name" {\n  description = "Name tag for instance"\n  type        = string\n}\nEOF\n\n# Update main.tf to use variables:\nprovider "aws" {\n  region = var.region\n}\n\nresource "aws_instance" "example" {\n  ami           = "ami-0c55b159cbfafe1f0"\n  instance_type = var.instance_type\n\n  tags = {\n    Name = var.instance_name\n  }\n}',
        explanation: 'Variables make code reusable. Define in variables.tf with type and default. Use with var.name syntax. Some can have defaults, others must be provided. Makes code flexible for different environments.',
        expectedOutput: 'variables.tf created, main.tf updated to use variables.',
        validationCriteria: [
      ...
      },
      {
        ...
        command: '# Option 1: terraform.tfvars file (recommended)\ncat > terraform.tfvars << \'EOF\'\nregion        = "us-west-2"\ninstance_type = "t2.small"\ninstance_name = "my-server"\nEOF\n\n# Option 2: Command line\nterraform apply -var="instance_name=my-server"\n\n# Option 3: Environment variables\nexport TF_VAR_instance_name="my-server"\n\n# Option 4: Interactive prompt (if no value provided)\nterraform apply\n# var.instance_name\n#   Name tag for instance\n#   Enter a value: my-server',
        explanation: 'Multiple ways to provide variable values. terraform.tfvars is most common (committed to Git). Command line for overrides. Environment vars for CI/CD. Prompts for required vars without defaults.',
        expectedOutput: 'Variable values provided, Terraform can use them during apply.',
        validationCriteria: [
      ...
      },
      {
        ...
        command: 'cat > outputs.tf << \'EOF\'\noutput "instance_id" {\n  description = "ID of the EC2 instance"\n  value       = aws_instance.example.id\n}\n\noutput "instance_public_ip" {\n  description = "Public IP of EC2 instance"\n  value       = aws_instance.example.public_ip\n}\n\noutput "instance_url" {\n  description = "URL to access instance"\n  value       = "http://${aws_instance.example.public_ip}"\n}\nEOF\n\nterraform apply\n\nOutputs:\ninstance_id = "i-0123456789abcdef0"\ninstance_public_ip = "54.123.45.67"\ninstance_url = "http://54.123.45.67"',
        explanation: 'Outputs display values after apply. Expose resource attributes (IDs, IPs). Can be used by other Terraform configs or scripts. Helpful for debugging and integration.',
      ...
      },
      {
        ...
        command: '# Change instance type in terraform.tfvars\ninstance_type = "t2.medium"\n\nterraform plan\n# Output:\n  ~ resource "aws_instance" "example" {\n      ~ instance_type = "t2.micro" -> "t2.medium"\n      # (other attributes unchanged)\n    }\n\nPlan: 0 to add, 1 to change, 0 to destroy.\n\nterraform apply\n# AWS will modify instance (may require stop/start)',
        explanation: 'Change code, run plan to see diff. ~ means modify. Terraform determines if resource can be updated in-place or must be recreated. Instance type change may stop instance.',
        expectedOutput: 'Instance type changed, Terraform shows modification in plan.',
        validationCriteria: [
      ...
      },
      {
        ...
        explanation: 'terraform destroy deletes all resources. Requires "yes" confirmation. Removes from AWS and state file. Use for cleanup, tear down environments. Can target specific resources with -target.',
        expectedOutput: 'All resources destroyed, state file empty, AWS resources gone.',
        validationCriteria: [
    ...
    expectedOutcome: 'You can install Terraform, write basic configurations with providers and resources, use variables and outputs, execute init/plan/apply/destroy workflow, and understand state management basics.'
  },
    ...
    exercises: [
      {
        ...
        explanation: 'Complete Terraform configuration with provider, resource, variables, and output.'
      },
      {
        exerciseNumber: 2,
        scenario: 'Define variables with appropriate types and defaults.',
        template: 'variable "region" {\n  description = "AWS region"\n  type        = __STRING__\n  default     = "us-east-1"\n}\n\nvariable "instance_count" {\n  description = "Number of instances"\n  type        = __NUMBER__\n  default     = __ONE__\n}\n\nvariable "instance_tags" {\n  description = "Tags for instances"\n  type        = map(__STRING__)\n  default     = {\n    Environment = "dev"\n    Managed     = "terraform"\n  }\n}\n\nvariable "enable_monitoring" {\n  description = "Enable detailed monitoring"\n  type        = __BOOL__\n  default     = __FALSE__\n}',
        blanks: [
          {
            id: 'STRING',
            label: 'STRING',
        ...
        solution: 'variable "region" {\n  description = "AWS region"\n  type        = string\n  default     = "us-east-1"\n}\n\nvariable "instance_count" {\n  description = "Number of instances"\n  type        = number\n  default     = 1\n}\n\nvariable "instance_tags" {\n  description = "Tags for instances"\n  type        = map(string)\n  default     = {\n    Environment = "dev"\n    Managed     = "terraform"\n  }\n}\n\nvariable "enable_monitoring" {\n  description = "Enable detailed monitoring"\n  type        = bool\n  default     = false\n}',
        explanation: 'Variables with proper types: string, number, map, bool. Defaults for optional values.'
      },
      {
        exerciseNumber: 3,
      ...
      },
      {
        ...
        solution: 'Plan output symbols:\n\n+: Resource will be created\n~: Resource will be modified in-place\n-: Resource will be destroyed\n-/+: Resource must be destroyed and recreated\n\nExample:\nPlan: 1 to add, 0 to change, 0 to destroy.',
        explanation: 'Terraform plan uses symbols to show planned changes: +create, ~modify, -destroy, -/+replace.'
      },
      {
        exerciseNumber: 5,
        ...
        explanation: 'Remote S3 backend with DynamoDB locking enables team collaboration on Terraform.'
      }
    ],
    hints: [
  ...
  runGuided: {
    objective: 'Build multi-resource AWS infrastructure with Terraform including VPC, security groups, EC2 instances, and proper state management',
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck: 'Create VPC first, then subnet (depends on VPC), security group (depends on VPC), finally EC2 (depends on subnet and security group). Use resource.name.id to reference dependencies.'
      },
      {
        ...
        hintIfStuck: 'Create S3 bucket manually first. Enable versioning. Create DynamoDB table with LockID partition key. Add backend "s3" {} block. Run terraform init to migrate local state to S3.'
      },
      {
        ...
        hintIfStuck: 'Document prerequisites (AWS credentials, Terraform version), required variables, how to run (init, plan, apply), how to access resources (SSH to IPs from outputs), how to clean up (destroy).'
      }
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective: 'Build production-ready Terraform project with multi-environment support, modules, remote state, CI/CD integration, and comprehensive documentation',
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 30,
        passingThreshold: 'Complete multi-tier infrastructure (VPC, compute, database, storage). All resources configured properly with security groups, proper networking. Health checks validate deployment. Production-ready configuration.'
      },
      {
        criterion: 'Code Quality and Organization',
        weight: 25,
        passingThreshold: 'Modular design with reusable components. Clear file organization. Variables for all configurable values. Outputs provide useful information. Code is DRY (Don\'t Repeat Yourself). Follows Terraform best practices.'
      },
      {
        criterion: 'State Management and Security',
        weight: 25,
        passingThreshold: 'Remote state in S3 with encryption and locking. State isolated per environment. No secrets in code or state (use AWS Secrets Manager). Proper IAM permissions. Backend configuration versioned.'
      },
      {
        criterion: 'Operational Readiness',
        weight: 20,
        passingThreshold: 'CI/CD pipeline automates plan/apply. Multi-environment deployment works. Documentation enables team to use independently. Can deploy, modify, and destroy reliably. Troubleshooting guide helps resolve common issues.'
      }
    ]
  },
