...
export const week10Lesson3AdvancedDeployments: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Implement advanced deployment strategies including canary deployments, blue-green deployments, and progressive delivery with automated analysis.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn advanced deployment patterns step-by-step. You will implement canary, blue-green, and progressive delivery with automated rollback.",
    expectedOutcome:
      "Complete understanding of canary deployments, blue-green strategy, progressive delivery with Flagger, automated analysis, and safe rollout patterns",
    steps: [
      {
        stepNumber: 1,
        ...
        explanation:
          "Different patterns balance risk, complexity, and resource usage. Canary minimizes risk, blue-green ensures instant rollback, A/B tests features.",
        ...
        commonMistakes: [
          "Using wrong pattern for use case",
      ...
      },
      {
        ...
        command:
          "kubectl create deployment app-v1 --image=myapp:v1 --replicas=9 && kubectl create deployment app-v2 --image=myapp:v2 --replicas=1 && kubectl expose deployment app-v1 --port=80 --target-port=8080 --name=app --selector=app=myapp",
        explanation:
          "Canary deployment: 9 pods v1, 1 pod v2 = 10% traffic to new version. Service selects all pods with app=myapp label. Manual traffic control.",
        ...
        commonMistakes: [
          ...
          "Not matching pod counts to percentages",
        ],
      },
      {
        stepNumber: 3,
        ...
        command:
          "kubectl apply -k github.com/fluxcd/flagger//kustomize/istio && kubectl -n istio-system rollout status deployment/flagger",
        explanation:
          "Flagger automates canary analysis: gradually shifts traffic, monitors metrics, auto-rollback on failures. Works with Istio, Linkerd, App Mesh.",
      ...
      },
      {
        ...
        command:
          "kubectl create deployment podinfo --image=ghcr.io/stefanprodan/podinfo:6.3.0 && kubectl set image deployment/podinfo podinfo=ghcr.io/stefanprodan/podinfo:6.3.0 && kubectl expose deployment podinfo --port=9898 --target-port=9898",
        explanation:
          "Flagger takes over deployment management. Updates image in deployment, Flagger creates canary, shifts traffic gradually based on metrics.",
      ...
      },
      {
        ...
        explanation:
          "Canary spec: 10% traffic increments every 30s, up to 50% max. Checks success rate >99%, latency <500ms. Load test generates traffic. 5 consecutive passes needed.",
      ...
      },
      {
        ...
        command:
          "kubectl set image deployment/podinfo podinfo=ghcr.io/stefanprodan/podinfo:6.3.1 && kubectl describe canary podinfo",
        explanation:
          "Flagger detects image change, starts canary analysis: deploys canary pods, shifts traffic 10→20→30→40→50%, monitors metrics. Auto-rollback if metrics fail.",
      ...
      },
      {
        ...
        command:
          "kubectl get canary podinfo -w && kubectl -n istio-system logs deployment/flagger -f --tail=10",
        explanation:
          "Watch canary phases: Initializing → Waiting → Progressing → Promoting or Rolling Back. Flagger logs show traffic weights, metric analysis, decisions.",
      ...
      },
      {
        ...
        command:
          'kubectl create deployment app-blue --image=myapp:v1 --replicas=3 && kubectl create deployment app-green --image=myapp:v2 --replicas=3 && kubectl create service clusterip app --tcp=80:8080 && kubectl patch service app -p \'{"spec":{"selector":{"version":"blue"}}}\'',
        explanation:
          "Blue-green: two full environments. Service points to blue (v1). After testing green, switch service selector to green. Instant rollback: switch back to blue.",
        ...
        commonMistakes: [
          "Insufficient resources for 2x pods",
      ...
      },
      {
        ...
        command:
          'kubectl patch service app -p \'{"spec":{"selector":{"version":"green"}}}\' && kubectl get endpoints app',
        explanation:
          "Service now routes all traffic to green pods. Zero downtime switch. Monitor for issues. If problems, immediately patch back to blue.",
        ...
        commonMistakes: [
          "Deleting blue too soon",
          "Not monitoring after switch",
        ],
      },
      {
        stepNumber: 10,
        ...
        explanation:
          'A/B testing routes based on user attributes. Users with "x-version: beta" header get v2, others get v1. Test features with specific user segments.',
      ...
      },
      {
        ...
        command:
          "kubectl apply -f - <<EOF\napiVersion: flagger.app/v1beta1\nkind: Canary\nmetadata:\n  name: podinfo\nspec:\n  targetRef:\n    apiVersion: apps/v1\n    kind: Deployment\n    name: podinfo\n  analysis:\n    interval: 1m\n    threshold: 3\n    metrics:\n    - name: error-rate\n      templateRef:\n        name: error-rate\n      thresholdRange:\n        max: 1\n    - name: latency-p99\n      templateRef:\n        name: latency\n      thresholdRange:\n        max: 1000\nEOF",
        explanation:
          "Automated rollback triggers if error rate >1% or p99 latency >1s. After 3 consecutive failures, Flagger scales canary to 0, routes all traffic to primary.",
      ...
      },
      {
        ...
        command:
          "kubectl apply -f - <<EOF\napiVersion: networking.istio.io/v1beta1\nkind: VirtualService\nmetadata:\n  name: shadow-test\nspec:\n  hosts:\n  - myapp\n  http:\n  - route:\n    - destination:\n        host: myapp\n        subset: v1\n      weight: 100\n    mirror:\n      host: myapp\n      subset: v2\n    mirrorPercentage:\n      value: 100\nEOF",
        explanation:
          "Shadow deployment: 100% traffic to v1 (production), 100% mirrored to v2 (test). v2 responses ignored. Test new version with real traffic without user impact.",
  ...
  walk: {
    introduction:
      "Apply advanced deployment patterns through hands-on exercises.",
    exercises: [
      {
        exerciseNumber: 1,
  ...
  analysis:
    ...
    - name: request-duration
      ...
      interval: 1m`,
        ...
        solution:
          "Flagger canary increases traffic 10% every 30s up to 50% max. Requires 5 consecutive metric passes: success rate >99%, latency <500ms. Auto-rollback on failures.",
        explanation:
          "Progressive delivery automates safe rollouts with metric validation",
      },
      {
        exerciseNumber: 2,
...
kubectl patch service app -p '{"spec":{"selector":{"version":"green"}}}'`,
        ...
        solution:
          "Blue-green deployment maintains two full environments. Service selector switches between blue and green. Instant rollback by switching back. Requires 2x resources.",
        explanation:
          "Blue-green enables instant zero-downtime switches and rollbacks",
      },
      {
        exerciseNumber: 3,
  ...
  - route:
    - destination:
      ...
      weight: __100__`,
        ...
        solution:
          'A/B testing routes by header: "x-version: beta" → v2, default → v1. Test features with specific user segments. Track metrics per version for comparison.',
        explanation:
          "A/B testing enables feature experimentation with controlled user groups",
      },
      {
        exerciseNumber: 4,
...
spec:
  ...
  canaryAnalysis:
    ...
    - headers:
        ...
        solution:
          "Automated rollback after 3 consecutive failures. Metrics checked every 1m: error rate <1%, p99 latency <1s. Canary traffic via x-canary header for controlled testing.",
        explanation:
          "Automated rollback prevents bad deployments from affecting users",
      },
      {
        exerciseNumber: 5,
...
spec:
  ...
  - route:
    ...
    mirrorPercentage:
      value: __100__`,
        ...
        solution:
          "Traffic shadowing sends all production traffic to stable, mirrors 100% to canary. Canary responses discarded. Test new version with real traffic without user impact.",
        explanation:
          "Shadowing tests new versions safely with production traffic patterns",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Build production deployment pipeline with automated progressive delivery, canary analysis, blue-green deployments, and safe rollback",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck:
          "Install Flagger with Istio. Create Canary resource with analysis metrics. Update deployment image to trigger canary. Monitor with kubectl get canary -w.",
      },
      {
        ...
        hintIfStuck:
          "Deploy two full environments with version labels. Create service with selector. Test green thoroughly. Switch service selector to green. Monitor traffic. Keep blue for rollback.",
      },
      {
        ...
        hintIfStuck:
          "Configure Flagger Canary with low thresholds. Deploy broken version. Watch Flagger detect metric violations. Verify automatic rollback. Check Flagger logs for decision reasoning.",
      },
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective:
      "Build production-grade deployment pipeline with comprehensive progressive delivery, automated canary analysis, blue-green strategy, A/B testing, and complete observability",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 35,
        passingThreshold:
          "Flagger automating canary deployments. Traffic shifting incrementally (10-20-30-40-50%). Metrics analyzed each step. Load testing active. Promotions automatic on success. Rollback automatic on failure. Multiple apps using pattern.",
      },
      {
        criterion: "Deployment Strategies",
        weight: 25,
        passingThreshold:
          "Canary for gradual rollouts. Blue-green for instant switching. A/B testing for features. Traffic shadowing for testing. Each pattern documented with use cases. Teams know when to use which pattern.",
      },
      {
        criterion: "Automated Analysis & Rollback",
        weight: 25,
        passingThreshold:
          "Metrics monitored: success rate, latency, errors. Thresholds configured appropriately. Failures detected quickly. Rollback automatic within 2 minutes. Alerts on rollback. No manual intervention needed.",
      },
      {
        criterion: "Observability",
        weight: 15,
        passingThreshold:
          "Prometheus scraping deployment metrics. Grafana dashboards showing canary progress. Alerts on metric violations. Logs aggregated for debugging. Traffic patterns visualized. Historical deployment data tracked.",
      },
    ],
  },
