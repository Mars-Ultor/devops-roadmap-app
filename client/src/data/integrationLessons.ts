...
export const integrationLesson1MultiTeam: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description: 'Master coordinating complex incidents requiring multiple specialized teams working together.',
    learningObjectives: [
  ...
  crawl: {
    introduction: 'Learn multi-team coordination through structured incident scenarios.',
    steps: [
      {
        stepNumber: 1,
        instruction: 'Map team responsibilities and dependencies',
        command: 'Create RACI matrix for incident response involving 5 teams',
        explanation: 'Complex incidents require clear understanding of who does what. Map Responsible, Accountable, Consulted, and Informed roles for all teams involved.',
        expectedOutput: 'Complete RACI matrix showing each team role in incident response',
        validationCriteria: [
      ...
      },
      {
        ...
        command: 'Define sync meeting cadence, status update format, and escalation paths',
        explanation: 'Multiple teams need coordinated communication. Define when teams sync, how they share status, and how to escalate blockers.',
        validationCriteria: [
      ...
      },
      {
        ...
        command: 'Assign investigation tracks to teams, define success criteria, schedule check-ins',
        explanation: 'Teams can investigate different hypotheses in parallel. Coordinate without creating duplication or gaps in coverage.',
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Set up coordination structure for incident involving Engineering, SRE, Database, and Network teams',
        ...
        startingCondition: 'Performance degradation affecting multiple services, root cause unclear, requires expertise from 4 different teams',
        successCriteria: [
  ...
  walk: {
    introduction: 'Practice multi-team coordination with realistic decision-making.',
    exercises: [
      {
        id: 'multi-team-walk-ex1',
        title: 'Conflicting Team Priorities',
        description: 'Resolve conflicts when Security wants to shut down services but Product needs them running',
        difficulty: 'advanced',
        estimatedTime: 30,
        objectives: [
        ...
        startingCondition: 'Security vulnerability detected, Security wants immediate shutdown, Product has major customer demo in 2 hours',
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Coordinate incident response across teams in US, EU, and APAC with follow-the-sun coverage',
        difficulty: 'expert',
        estimatedTime: 45,
        objectives: [
        ...
        startingCondition: 'Critical incident requiring 24+ hour response, teams distributed globally, local stakeholders in each region',
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Lead response to major incident affecting entire organization with 10+ teams involved',
        difficulty: 'expert',
        estimatedTime: 60,
        objectives: [
        ...
        startingCondition: 'Major platform outage affecting all services, unclear root cause, high visibility, 10+ teams needed for investigation and recovery',
        successCriteria: [
...
export const integrationLesson2SystemIntegration: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description: 'Handle incidents involving complex integrations between multiple systems and vendors.',
    learningObjectives: [
    ...
    steps: [
      {
        ...
        command: 'Create sequence diagram showing all systems involved in failed transaction',
        explanation: 'Complex integrations require visual mapping. Document each system, API call, and data transformation in the request flow.',
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Debug failed payment flow involving your app, payment gateway, bank API, and fraud detection service',
        difficulty: 'intermediate',
        estimatedTime: 25,
        objectives: [
        ...
        startingCondition: 'Customers reporting failed payments, error messages unclear, involves 4 different systems',
        successCriteria: [
  ...
  walk: {
    introduction: 'Debug realistic integration issues with vendor dependencies.',
    exercises: [
      {
        id: 'integration-walk-ex1',
        title: 'Third-Party API Degradation',
        description: 'Handle performance issues when critical third-party API is slow but not down',
        difficulty: 'advanced',
        estimatedTime: 30,
        objectives: [
        ...
        startingCondition: 'Critical third-party API responding slowly, causing timeouts in your app, vendor support responsive but no ETA',
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Resolve incident involving your infrastructure, AWS, payment processor, and analytics vendor',
        difficulty: 'expert',
        estimatedTime: 40,
        objectives: [
        ...
        startingCondition: 'Transaction failures involving 4 vendors, each blaming others, customer impact growing',
        successCriteria: [
    ...
    exercises: [
      {
        ...
        description: 'Design and implement resilient integration architecture for critical business flow',
        difficulty: 'expert',
        estimatedTime: 50,
        objectives: [
          'Design resilient integration patterns',
        ...
        startingCondition: 'Business requires integrating with 6 external systems for critical checkout flow, SLA requirements strict',
        successCriteria: [
