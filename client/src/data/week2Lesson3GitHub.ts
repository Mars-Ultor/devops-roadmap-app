...
export const week2Lesson3GitHubWorkflow: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Master GitHub collaboration features for professional team development.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn GitHub collaboration step-by-step: creating Pull Requests, reviewing code, managing issues, and team workflows.",
    steps: [
      {
        stepNumber: 1,
        instruction: "Fork a repository (create your own copy)",
        command:
          'Navigate to repository on GitHub → Click "Fork" button → Fork created in your account',
        explanation:
          "Forking creates a complete copy under your account. You can modify freely without affecting original. Essential for contributing to projects you don't own.",
        expectedOutput:
          "Repository copy appears in your GitHub account at github.com/YOUR_USERNAME/repo-name",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "git clone https://github.com/YOUR_USERNAME/repo-name.git && cd repo-name",
        explanation:
          "Clone downloads repository to your computer. You now have: original repo (upstream), your fork (origin), and local copy.",
        expectedOutput:
          'Repository cloned, working directory created, remote "origin" points to your fork',
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "git remote add upstream https://github.com/ORIGINAL_OWNER/repo-name.git && git remote -v",
        explanation:
          "Upstream = original repo you forked from. Lets you pull latest changes from original to keep your fork updated.",
        expectedOutput:
          "git remote -v shows both origin (your fork) and upstream (original repo)",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "Never work directly on main branch. Feature branches isolate your work. Easy to throw away if needed. Keeps main clean.",
      ...
      },
      {
        ...
        command:
          'echo "## Documentation" > README.md && git add README.md && git commit -m "Add documentation section" && git push origin feature/add-documentation',
        explanation:
          "Make changes locally, commit with clear message, push to your fork (origin). Branch now exists on GitHub, ready for Pull Request.",
      ...
      },
      {
        ...
        command:
          'On GitHub: Navigate to original repo → Click "Pull Requests" → "New Pull Request" → Select your fork and branch → Create PR',
        explanation:
          "Pull Request = proposal to merge your changes into original repo. Includes description, discussion thread, and code review tools.",
        expectedOutput:
          "PR created with title, description, and file changes visible",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Reviewer comments on PR → Make requested changes locally → Commit and push → PR automatically updates",
        explanation:
          "Code review is conversation. Reviewers suggest improvements. You make changes in same branch, push, PR updates automatically. Iterate until approved.",
        expectedOutput:
          "PR updated with new commits addressing feedback, discussion thread shows collaboration",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          'Reviewer approves → Click "Merge Pull Request" → Confirm merge → Delete branch (optional)',
        explanation:
          "After approval, maintainer or contributor merges PR. Changes now in main branch. Delete feature branch to keep repository clean.",
        expectedOutput:
          'PR merged, changes in main branch, PR marked as "Merged", optional branch deletion',
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          'On GitHub: "Issues" tab → "New Issue" → Title + description → Labels, assignee, milestone → Create',
        explanation:
          "Issues track bugs, features, questions. Structured with title, description, labels, assignees. Can link to PRs. Searchable history.",
        expectedOutput:
          "Issue created with number (#123), title, description, metadata",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          'In PR description: "Closes #123" or "Fixes #456" → GitHub auto-links and auto-closes issue when PR merges',
        explanation:
          "Linking PR to issue provides traceability. When PR merges, issue automatically closes. Clear connection between problem and solution.",
        expectedOutput:
          "PR description shows clickable issue link, issue shows linked PR, issue closes on merge",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          'Open PR → "Files changed" tab → Click line to comment → Suggest improvements → "Review changes" → Approve/Request changes',
        explanation:
          "Code review improves quality and shares knowledge. Comment on specific lines. Ask questions. Suggest improvements. Approve when ready.",
        expectedOutput:
          "Review submitted with comments, suggestions, and approval status",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "Original repo gets updated by others. Sync your fork to stay current. Fetch updates, merge into your main, push to your fork.",
        expectedOutput:
          "Your fork's main branch matches upstream, ready to create new feature branches",
        validationCriteria: [
    ...
    expectedOutcome:
      "You can fork repositories, create PRs, conduct code reviews, manage issues, link PRs to issues, and keep forks synchronized. You understand complete GitHub collaboration workflow.",
  },
    ...
    exercises: [
      {
        ...
        explanation:
          "Standard open-source contribution workflow: Fork → Clone → Branch → Commit → Push → PR → Review → Merge.",
      },
      {
        exerciseNumber: 2,
        scenario:
          "A team member submitted a PR. How do you conduct a thorough code review?",
        template:
        ...
        explanation:
          "Thorough code review catches bugs, improves quality, shares knowledge, and maintains standards.",
      },
      {
        exerciseNumber: 3,
        scenario:
          "You discovered a bug. Create an issue with all necessary information.",
        template:
        ...
        explanation:
          "Well-written issues help developers understand and fix bugs faster. Complete information is crucial.",
      },
      {
        exerciseNumber: 4,
      ...
      },
      {
        ...
        explanation:
          "Keep fork synchronized with upstream to avoid massive merge conflicts later.",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Contribute to an open-source project following complete GitHub workflow",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck:
          'Start with beginner-friendly projects: first-contributions, good-first-issues.com, or your favorite tool\'s "help wanted" label',
      },
      {
        ...
        hintIfStuck:
          "Don't take feedback personally. Reviewers help improve code quality. Thank them for their time.",
      },
      {
        ...
        hintIfStuck:
          "Write blog post or README documenting: project chosen, changes made, review process, lessons learned, what you'd do differently",
      },
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective:
      "Create comprehensive GitHub collaboration guidelines for a development team, including PR templates, code review checklist, and workflow documentation",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 30,
        passingThreshold:
          "Templates, checklists, guidelines cover all aspects of collaboration. Nothing major missing. Ready for team to use immediately.",
      },
      {
        criterion: "Practicality",
        weight: 25,
        passingThreshold:
          "Guidelines are realistic and actionable. Not bureaucratic overhead. Templates actually help developers. Checklists catch real issues.",
      },
      {
        criterion: "Quality Standards",
        weight: 25,
        passingThreshold:
          "Code review checklist ensures quality. PR template requires necessary information. Standards are clear and enforceable.",
      },
      {
        criterion: "Documentation Quality",
        weight: 20,
        passingThreshold:
          "Guidelines are clear, well-organized, with examples. New team members can follow easily. Diagrams clarify complex workflows.",
      },
    ],
  },
