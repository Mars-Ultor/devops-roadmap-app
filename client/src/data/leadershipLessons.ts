...
export const leadershipLesson1CrisisCommunication: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Master effective communication during major production incidents affecting millions of users.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "You will learn crisis communication fundamentals by working through a simulated major outage with guided decision points.",
    steps: [
      {
        stepNumber: 1,
        instruction: "Establish the incident command structure",
        command:
          "Review incident command roles and select your communication strategy",
        explanation:
          "The first critical action in any major incident is establishing clear command structure. As incident commander, you must define who communicates what to whom.",
        expectedOutput:
          "Clear role assignments: Incident Commander, Technical Lead, Communications Lead, Scribe",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Create incident notification template addressing impact, actions, and timeline",
        explanation:
          "First communication sets the tone. Include: what happened, impact scope, immediate actions, estimated timeline, next update time.",
        expectedOutput:
          "Professional incident notification with all key elements",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Review three different team reports and synthesize consistent message",
        explanation:
          "Teams often provide conflicting information during incidents. Your job is to verify facts, reconcile differences, and provide one clear truth.",
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Set up complete incident command structure for a database outage affecting 1M users",
        difficulty: "beginner",
        estimatedTime: 15,
        objectives: [
        ...
        startingCondition:
          "Major database outage detected, users experiencing errors, executives asking questions",
        successCriteria: [
  ...
  walk: {
    introduction:
      "Apply crisis communication skills with less guidance. You will make decisions and receive feedback.",
    steps: [
      {
        stepNumber: 1,
        instruction: "Lead a cross-functional incident response meeting",
        command:
          "Facilitate 15-minute status sync with Engineering, Product, Support, and Executive teams",
        explanation:
          "Different teams need different information at different levels of detail. Balance technical accuracy with business clarity.",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Respond to executive request for immediate update while engineers are debugging",
        explanation:
          "Executives need answers, but engineers need focus. Learn to provide meaningful updates without disrupting technical work.",
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Coordinate response across Engineering, SRE, Security, and Customer Success during security incident",
        ...
        startingCondition:
          "Potential data breach detected, scope unknown, customers asking questions, media inquiring",
        successCriteria: [
  ...
  runGuided: {
    introduction:
      "Lead realistic crisis scenarios with minimal guidance. Apply leadership principles under pressure.",
    exercises: [
      {
        id: "crisis-comm-run-guided-ex1",
        title: "Multi-Vendor Outage Coordination",
        description:
          "Lead incident response when outage involves AWS, database vendor, and CDN provider simultaneously",
        difficulty: "advanced",
        estimatedTime: 30,
        objectives: [
        ...
        startingCondition:
          "Cascading failure affecting multiple vendors, 4-hour outage, customer churn risk, team exhausted",
        successCriteria: [
  ...
  runIndependent: {
    introduction:
      "Demonstrate mastery by leading complex, realistic crisis scenarios independently. No hints provided.",
    exercises: [
      {
        id: "crisis-comm-run-independent-ex1",
        title: "Complete Incident Command Exercise",
        description:
          "Lead full incident lifecycle from detection through resolution and post-mortem for major production outage",
        difficulty: "expert",
        estimatedTime: 45,
        objectives: [
        ...
        startingCondition:
          "Major production outage, unclear root cause, multiple systems affected, high customer impact, executive escalation",
        successCriteria: [
...
export const leadershipLesson2TeamCoordination: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Master coordinating multiple teams during complex incidents and learning effective delegation under pressure.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn delegation fundamentals and team coordination through structured scenarios.",
    steps: [
      {
        stepNumber: 1,
        instruction: "Assess team capabilities and assign roles",
        command:
          "Review team member skills and assign incident response roles based on strengths",
        explanation:
          "Effective delegation starts with knowing your team. Match tasks to skills while considering capacity and stress levels.",
        validationCriteria: [
    ...
    exercises: [
      {
        ...
        description:
          "Assign 8 team members to incident response roles based on their skills and availability",
        difficulty: "beginner",
        estimatedTime: 15,
        objectives: [
        ...
        startingCondition:
          "Team of 8 with varying experience levels, 12-hour incident expected",
        successCriteria: [
  ...
  walk: {
    introduction:
      "Practice delegation and coordination with real-time decision making.",
    exercises: [
      {
        id: "team-coord-walk-ex1",
        title: "Parallel Investigation Coordination",
        description:
          "Coordinate three parallel investigation streams for complex performance degradation",
        difficulty: "intermediate",
        estimatedTime: 25,
        objectives: [
        ...
        startingCondition:
          "Performance degradation with three possible root causes, need to investigate all simultaneously",
        successCriteria: [
  ...
  runGuided: {
    introduction:
      "Lead complex multi-team coordination scenarios with guidance.",
    exercises: [
      {
        id: "team-coord-run-guided-ex1",
        title: "Cross-Team Crisis Coordination",
        description:
          "Coordinate response across Engineering, SRE, Security, Database, and Infrastructure teams",
        difficulty: "advanced",
        estimatedTime: 30,
        objectives: [
        ...
        startingCondition:
          "Complex incident requiring coordination of 5 specialized teams, competing priorities, resource constraints",
        successCriteria: [
  ...
  runIndependent: {
    introduction:
      "Demonstrate mastery of multi-team coordination independently.",
    exercises: [
      {
        id: "team-coord-run-independent-ex1",
        title: "Large-Scale Incident Coordination",
        description:
          "Coordinate response to major incident affecting 10+ teams across multiple time zones",
        difficulty: "expert",
        estimatedTime: 40,
        objectives: [
        ...
        startingCondition:
          "Global outage requiring coordination across US, EU, and APAC teams for 24+ hours",
        successCriteria: [
