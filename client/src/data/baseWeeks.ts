...
export const baseWeeks: Week[] = [
  {
    ...
    description:
      "Master the fundamentals of DevOps culture, Linux systems, and basic tooling",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Practice essential Linux commands for file management, process control, and system navigation",
        difficulty: "beginner",
        estimatedTime: 45,
        xp: 100,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Learn Git fundamentals for source code management and collaboration",
        difficulty: "beginner",
        estimatedTime: 60,
        xp: 150,
        tasks: [
  ...
  },
  {
    ...
    description:
      "Automate tasks with Bash scripting and understand infrastructure as code principles",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Create Bash scripts for system automation and task scheduling",
  ...
  },
  {
    ...
    description:
      "Master container technology for application packaging and deployment",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Build, run, and manage Docker containers for application deployment",
        difficulty: "intermediate",
        estimatedTime: 90,
        xp: 250,
        tasks: [
    ...
    labs: [
      {
        ...
        description:
          "Create comprehensive CI/CD pipelines using GitHub Actions",
        difficulty: "intermediate",
        estimatedTime: 120,
        xp: 300,
        tasks: [
  ...
  },
  {
    ...
    description:
      "Manage infrastructure through code using Terraform and configuration management",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Set up Elasticsearch, Logstash, and Kibana for log aggregation and analysis",
        difficulty: "advanced",
        estimatedTime: 200,
        xp: 600,
        tasks: [
    ...
    labs: [
      {
        ...
        description:
          "Create a secure CI/CD pipeline with automated security testing",
        difficulty: "advanced",
        estimatedTime: 220,
        xp: 700,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Implement a comprehensive zero trust security model for cloud infrastructure",
        difficulty: "advanced",
        estimatedTime: 260,
        xp: 850,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Build automated compliance monitoring and audit systems for enterprise environments",
        difficulty: "advanced",
        estimatedTime: 240,
        xp: 800,
        tasks: [
  ...
  },
  {
    ...
    description:
      "Design and deploy microservices architectures with service mesh",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Deploy and manage microservices on Kubernetes with Istio service mesh",
        difficulty: "advanced",
        estimatedTime: 250,
        xp: 800,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Implement chaos engineering practices to build resilient distributed systems",
        difficulty: "advanced",
        estimatedTime: 280,
        xp: 950,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Build event-driven architectures with message queues and streaming platforms",
        difficulty: "advanced",
        estimatedTime: 300,
        xp: 1000,
        tasks: [
    ...
    labs: [
      {
        ...
        description:
          "Implement advanced deployment strategies and cloud-native patterns",
        difficulty: "advanced",
        estimatedTime: 280,
        xp: 900,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Design and implement multi-cloud and hybrid cloud architectures",
        difficulty: "advanced",
        estimatedTime: 320,
        xp: 1100,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Implement advanced cloud-native database and storage solutions",
        difficulty: "advanced",
        estimatedTime: 290,
        xp: 1000,
        tasks: [
    ...
    labs: [
      {
        ...
        description:
          "Implement GitOps workflows for Kubernetes application management",
        difficulty: "advanced",
        estimatedTime: 300,
        xp: 1000,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Build an internal developer platform for self-service infrastructure and deployments",
        difficulty: "advanced",
        estimatedTime: 350,
        xp: 1200,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Implement policy as code for infrastructure and application governance",
        difficulty: "advanced",
        estimatedTime: 320,
        xp: 1100,
        tasks: [
  ...
  },
  {
    ...
    description:
      "Apply all skills in a comprehensive capstone project and prepare for DevOps careers",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Design and implement a complete DevOps solution for a complex application",
        difficulty: "advanced",
        estimatedTime: 400,
        xp: 1500,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Build and manage production incident response and post-mortem processes",
        difficulty: "advanced",
        estimatedTime: 280,
        xp: 1000,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Implement SRE practices for reliable, scalable production systems",
        difficulty: "advanced",
        estimatedTime: 350,
        xp: 1300,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Lead DevOps transformation initiatives in large enterprise environments",
        difficulty: "advanced",
        estimatedTime: 380,
        xp: 1400,
        tasks: [
  ...
  },
  {
    ...
    description:
      "Explore cutting-edge technologies shaping the future of DevOps and cloud-native development",
    objectives: [
    ...
    labs: [
      {
        ...
        description:
          "Implement artificial intelligence and machine learning in DevOps operations",
        difficulty: "advanced",
        estimatedTime: 320,
        xp: 1200,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Build and deploy applications using WebAssembly and edge computing platforms",
        difficulty: "advanced",
        estimatedTime: 300,
        xp: 1100,
        tasks: [
      ...
      },
      {
        ...
        description:
          "Prepare DevOps practices for quantum computing and post-quantum cryptography",
        difficulty: "advanced",
        estimatedTime: 350,
        xp: 1300,
        tasks: [
