...
export const week3Lesson1CloudConcepts: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Understand cloud computing models, service types, and benefits for modern infrastructure.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn cloud computing concepts step-by-step: service models, deployment types, major providers, and core benefits.",
    steps: [
      {
        stepNumber: 1,
        instruction:
          "Understand the problem: Traditional infrastructure limitations",
        command:
          "Traditional setup: Buy physical servers → Install in data center → Manage hardware → Scale manually → Pay upfront costs",
        explanation:
          "Before cloud: expensive capital investment, long provisioning time (weeks/months), limited scalability, manual maintenance. You own hardware, responsible for failures.",
        expectedOutput:
          "Understanding: Physical servers = high cost, slow setup, inflexible capacity, hardware maintenance burden",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Cloud model: Provision virtual resources instantly → Pay only for usage → Scale automatically → No hardware management",
        explanation:
          "Cloud = rent compute/storage/services from provider. Instant provisioning (minutes not months). Pay-as-you-go (OpEx not CapEx). Provider manages hardware.",
        expectedOutput:
          "Understanding: Cloud offers speed, flexibility, operational expenses instead of capital expenses",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "IaaS = rent virtual machines. You control OS and software. Provider handles physical hardware. Maximum flexibility, maximum responsibility.",
        expectedOutput:
          "Understanding: IaaS gives you virtual servers with full control but requires OS management",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "PaaS = deploy code, provider handles infrastructure. No OS management. Focus on application logic. Less control, less maintenance.",
        expectedOutput:
          "Understanding: PaaS lets you deploy code without managing servers or OS",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Example: Gmail, Salesforce, Office 365, GitHub\nYou manage: Your data within the application\nProvider manages: Everything (application, OS, infrastructure)",
        explanation:
          "SaaS = use software via web browser. No installation, no management. Provider handles everything. You just use the application.",
        expectedOutput:
          "Understanding: SaaS is ready-to-use applications with zero infrastructure management",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "AWS, Azure, GCP = public clouds\nCharacteristics: Shared infrastructure, pay-per-use, internet-accessible, managed by provider",
        explanation:
          "Public cloud = provider owns infrastructure, multiple customers share (isolated virtually). Most cost-effective. Accessible from anywhere. Provider secures physical infrastructure.",
        expectedOutput:
          "Understanding: Public cloud is shared, managed infrastructure with pay-as-you-go pricing",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "Private cloud = cloud capabilities (automation, self-service) but dedicated to one organization. More control, more expensive. For compliance, security, or regulatory needs.",
        expectedOutput:
          "Understanding: Private cloud offers cloud benefits with dedicated infrastructure",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Example: Sensitive data in private cloud, web tier in public cloud\nBenefits: Flexibility, compliance, cost optimization, disaster recovery",
        explanation:
          "Hybrid = public + private clouds integrated. Run workloads where they fit best. Keep sensitive data private, scale public. Complex but powerful.",
        expectedOutput:
          "Understanding: Hybrid cloud combines public and private for flexibility and compliance",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "Scale out (add more servers) or scale up (bigger servers). Elastic scaling automatically adjusts. Only pay for what you need. Traffic spikes don't crash your app.",
        expectedOutput:
          "Understanding: Cloud scales to meet demand automatically, reducing waste and preventing outages",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "Multiple Availability Zones = data centers in different locations\nAutomatic failover = if one zone fails, traffic routes to another\nBackups = automated, geo-redundant",
        explanation:
          "Cloud providers have infrastructure in multiple regions and zones. Your app can survive data center failures. Backups stored in multiple locations. Higher uptime than single data center.",
        expectedOutput:
          "Understanding: Cloud provides built-in redundancy and disaster recovery capabilities",
        validationCriteria: [
      ...
      },
      {
        ...
        command:
          "AWS: Largest, most services, complex pricing\nAzure: Microsoft ecosystem, hybrid focus\nGCP: Data/ML strength, Kubernetes origins\nAll offer: Compute, storage, networking, databases, serverless",
        explanation:
          "AWS dominates market share. Azure integrates with Windows/Office. GCP excels at data analytics and containers. All have similar core services with different names.",
        expectedOutput:
          "Understanding: Major cloud providers have similar capabilities with different strengths",
        validationCriteria: [
      ...
      },
      {
        ...
        explanation:
          "Cloud costs vary by usage. On-demand = flexible, expensive. Reserved = commitment, cheaper. Spot = interruptible, cheapest. Must monitor spending or costs spiral.",
        expectedOutput:
          "Understanding: Cloud offers flexible pricing models requiring active cost management",
        validationCriteria: [
    ...
    expectedOutcome:
      "You understand cloud service models (IaaS/PaaS/SaaS), deployment types (public/private/hybrid), major providers, scalability benefits, and cost models. You can explain when cloud makes sense and what model fits different needs.",
  },

  walk: {
    introduction:
      "Apply cloud concepts through scenario-based decision-making exercises.",
    exercises: [
      {
        exerciseNumber: 1,
        scenario:
          "Your startup needs to deploy a web application quickly. Choose the cloud model.",
        template:
          "Requirement: Fast deployment, focus on code, minimal ops team\nBest choice: __PAAS__\nReason: __NO_SERVER_MANAGEMENT__, __FASTER_DEPLOYMENT__\nExamples: __HEROKU__, __ELASTIC_BEANSTALK__",
        blanks: [
          {
            id: "PAAS",
            label: "PAAS",
          ...
          },
          {
            ...
            validationPattern:
              ".*(no.*server|managed.*infrastructure|automatic).*",
          },
          {
        ...
        explanation:
          "PaaS lets startups deploy code without managing infrastructure. Faster time-to-market. Small teams focus on product, not servers.",
      },
      {
        exerciseNumber: 2,
        scenario:
          "Bank needs cloud but must keep customer data on-premises for compliance.",
        template:
          "Requirement: __COMPLIANCE__, sensitive data\nDeployment model: __HYBRID__\nStrategy: Customer data in __PRIVATE__ cloud, __PUBLIC__ cloud for non-sensitive workloads",
        blanks: [
          {
            id: "COMPLIANCE",
            label: "COMPLIANCE",
        ...
        solution:
          "Requirement: Compliance, sensitive data\nDeployment model: Hybrid\nStrategy: Customer data in Private cloud, Public cloud for non-sensitive workloads",
        explanation:
          "Hybrid cloud meets compliance (private for sensitive data) while leveraging public cloud benefits for other workloads.",
      },
      {
        exerciseNumber: 3,
        scenario:
          "E-commerce site has 10x traffic during Black Friday. What cloud benefit helps?",
        template:
          "Problem: __TRAFFIC_SPIKES__ during holidays\nCloud benefit: __ELASTICITY__\nSolution: __AUTO_SCALING__ adds servers during peak, __SCALES_DOWN__ after\nCost benefit: Only pay for __ACTUAL_USAGE__",
        blanks: [
          {
            id: "TRAFFIC_SPIKES",
        ...
        solution:
          "Problem: Traffic spikes during holidays\nCloud benefit: Elasticity\nSolution: Auto-scaling adds servers during peak, Scales down after\nCost benefit: Only pay for Actual usage",
        explanation:
          "Cloud elasticity handles variable demand automatically. No over-provisioning for peak capacity. Pay only during high traffic.",
      },
      {
        exerciseNumber: 4,
        scenario:
          "Choose between AWS, Azure, and GCP for different organizations.",
        template:
          "Microsoft-heavy enterprise: __AZURE__ (integrates with __ACTIVE_DIRECTORY__, Office 365)\nData analytics startup: __GCP__ (strengths in __BIGQUERY__, ML)\nNeed most services/flexibility: __AWS__ (largest __SERVICE_CATALOG__)",
        blanks: [
          {
            id: "AZURE",
            label: "AZURE",
      ...
      },
      {
        ...
        solution:
          "Current: On-demand instances (most expensive)\nOptimization: Reserved instances (commit 1-3 years, save 30-70%)\nFurther savings: Use Spot instances for Batch workloads (save up to 90%)\nMust implement: Cost monitoring and alerts",
        explanation:
          "Cloud costs optimize through pricing models: Reserved for steady workloads, Spot for fault-tolerant jobs, monitoring to prevent waste.",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Analyze your organization's current infrastructure and create cloud migration strategy",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck:
          "Use real organization (your workplace) or fictional company (e-commerce with 50 servers, growing 30% annually, manual deployments taking days)",
      },
      {
        ...
        hintIfStuck:
          "Simple web apps → PaaS. Legacy monoliths → IaaS initially. Email → SaaS (Office 365/Gmail). Databases → Managed database services.",
      },
      {
        ...
        hintIfStuck:
          "Lock-in mitigation: Use open standards (Kubernetes, PostgreSQL). Cost control: Set billing alerts, use reserved instances, implement auto-shutdown for dev environments.",
      },
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective:
      "Create comprehensive cloud adoption proposal for executive leadership, including business case, technical strategy, cost analysis, and migration roadmap",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 30,
        passingThreshold:
          "Proposal clearly connects cloud migration to business outcomes. Executives understand value proposition. Financial analysis is thorough and credible.",
      },
      {
        criterion: "Technical Soundness",
        weight: 30,
        passingThreshold:
          "Workload mapping is appropriate. Service model choices justified. Provider selection criteria clear. Migration approach is realistic and low-risk.",
      },
      {
        criterion: "Risk Management",
        weight: 20,
        passingThreshold:
          "Major risks identified (cost overruns, vendor lock-in, security, skills). Mitigation strategies are practical. Disaster recovery addressed.",
      },
      {
        criterion: "Completeness",
        weight: 20,
        passingThreshold:
          "All required sections present. Timeline realistic. Metrics defined. Team readiness addressed. Nothing major missing for decision-making.",
      },
    ],
  },
