...
export const week11Lesson3PlatformEngineering: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description: 'Build internal developer platforms (IDPs) with self-service capabilities, golden paths, and excellent developer experience.',
    learningObjectives: [
  ...
  crawl: {
    introduction: 'Learn platform engineering step-by-step. You will build internal developer platforms, create self-service capabilities, and improve developer experience.',
    expectedOutcome: 'Complete understanding of platform engineering principles, internal developer platforms, self-service portals, golden paths, developer productivity, and platform abstractions',
    steps: [
      {
        stepNumber: 1,
        instruction: 'Understand platform engineering principles',
        command: 'echo "Platform Engineering:\n1. Self-Service - Developers provision resources without tickets\n2. Golden Paths - Opinionated, paved roads for common tasks\n3. Abstraction - Hide complexity, expose capabilities\n4. Developer Experience - Fast, reliable, delightful workflows\n5. Product Thinking - Platform as product with users (developers)"',
        explanation: 'Platform engineering builds internal platforms reducing cognitive load. Developers self-serve infrastructure, follow golden paths, ship faster.',
        ...
        commonMistakes: ['Building platforms without user feedback', 'Over-engineering abstractions']
      },
      {
        stepNumber: 2,
        instruction: 'Install Backstage developer portal',
        command: 'npx @backstage/create-app@latest && cd backstage && yarn dev',
        explanation: 'Backstage is open-source developer portal (created by Spotify). Service catalog, documentation, scaffolding templates, integrations with tools.',
      ...
      },
      {
        ...
        command: 'cat > catalog-info.yaml <<EOF\napiVersion: backstage.io/v1alpha1\nkind: Component\nmetadata:\n  name: user-service\n  description: User authentication and management service\n  annotations:\n    github.com/project-slug: myorg/user-service\n    backstage.io/techdocs-ref: dir:.\nspec:\n  type: service\n  lifecycle: production\n  owner: backend-team\n  system: authentication\n  providesApis:\n    - user-api\n  consumesApis:\n    - postgres-db\nEOF',
        explanation: 'Service catalog tracks all services: ownership, dependencies, APIs, lifecycle. Developers discover services, understand system architecture.',
      ...
      },
      {
        ...
        command: 'kubectl create namespace crossplane-system && helm repo add crossplane-stable https://charts.crossplane.io/stable && helm install crossplane --namespace crossplane-system crossplane-stable/crossplane && kubectl wait --for=condition=available --timeout=300s deployment/crossplane -n crossplane-system',
        explanation: 'Crossplane provisions cloud resources via Kubernetes APIs. Developers create database with kubectl apply, Crossplane provisions RDS. Self-service infrastructure.',
        ...
        commonMistakes: ['Missing cloud provider credentials', 'Wrong Crossplane version']
      },
      {
        stepNumber: 6,
        ...
        explanation: 'Composite Resource Definition (XRD) defines PostgreSQL API. Developers request database with simple YAML, Crossplane provisions RDS with all complexity hidden.',
        ...
        commonMistakes: ['Exposing too much complexity', 'No sensible defaults']
      },
      {
        stepNumber: 7,
        instruction: 'Developer self-serves database',
        command: 'kubectl apply -f - <<EOF\napiVersion: database.example.org/v1alpha1\nkind: PostgreSQLInstance\nmetadata:\n  name: myapp-db\n  namespace: default\nspec:\n  parameters:\n    storageGB: 20\n    version: "14.7"\nEOF\nkubectl get postgresqlinstance myapp-db -w',
        explanation: 'Developer provisions PostgreSQL with 3 lines. Crossplane creates RDS, manages credentials, connection strings. No AWS console, no tickets.',
        ...
        commonMistakes: ['No RBAC limiting who can provision', 'Missing cost controls']
      },
      {
        stepNumber: 8,
        instruction: 'Create platform portal with documentation',
        command: 'cat > docs/platform/getting-started.md <<EOF\n# Platform Getting Started\n\n## Create New Service\n1. Go to Backstage → Create\n2. Select "Node.js Microservice" template\n3. Fill form: service name, team owner\n4. Click Create\n\nPlatform auto-creates:\n- Git repository\n- CI/CD pipeline\n- Kubernetes manifests\n- ArgoCD application\n- Service catalog entry\n\n## Provision Database\n\\`\\`\\`yaml\napiVersion: database.example.org/v1alpha1\nkind: PostgreSQLInstance\nmetadata:\n  name: myapp-db\nspec:\n  parameters:\n    storageGB: 20\n    version: "14.7"\n\\`\\`\\`\n\n## Deploy to Staging\n\\`\\`\\`bash\ngit commit -m "Feature"\ngit push origin main\n# ArgoCD auto-deploys to staging\n\\`\\`\\`\nEOF',
        explanation: 'Platform documentation shows golden paths. Developers follow guides, self-serve infrastructure, ship faster. Clear, opinionated workflows.',
      ...
      },
      {
        ...
        commonMistakes: ['Not measuring developer experience', 'Ignoring feedback']
      },
      {
        stepNumber: 10,
        ...
        explanation: 'Platform health dashboard shows service creation time, build success, deployment frequency. Platform team monitors, improves continuously.',
      ...
      },
      {
        ...
        explanation: 'ResourceQuotas limit team resource usage. LimitRanges prevent runaway containers. Track costs per team, provide visibility, enforce budgets.',
      ...
      },
      {
        ...
        command: 'cat > platform-feedback.yaml <<EOF\nFeedback Channels:\n  Slack: #platform-support\n    - Questions answered within 1 hour\n    - Feature requests tracked\n  \n  Office Hours: Tuesdays 2-3pm\n    - Platform team available\n    - Live troubleshooting\n  \n  Quarterly Survey:\n    - Developer satisfaction (NPS)\n    - Pain points\n    - Feature requests\n  \n  Metrics:\n    - Service creation failures\n    - Support ticket trends\n    - Adoption metrics\n\nImprovement Loop:\n  1. Collect feedback (surveys, metrics, support)\n  2. Prioritize improvements\n  3. Ship changes\n  4. Measure impact\n  5. Repeat\nEOF',
        explanation: 'Platform teams listen to developers: surveys, Slack, office hours, metrics. Continuous improvement based on user feedback.',
...
spec:
  ...
  dependsOn:
    - resource:__POSTGRES-DB__`,
        ...
        solution: 'Backstage catalog tracks service metadata: ownership (payments-team), lifecycle (production), APIs provided/consumed, dependencies. Enables service discovery and architecture understanding.',
        explanation: 'Service catalogs provide visibility into microservices architecture'
      },
      {
        exerciseNumber: 2,
  ...
  - name: __V1ALPHA1__
    ...
    schema:
      openAPIV3Schema:
        ...
        solution: 'Crossplane XRD defines simplified S3 API. Developers provision bucket with single parameter (public: true/false). Complexity hidden, safe defaults enforced.',
        explanation: 'Platform abstractions simplify infrastructure provisioning'
      },
      {
        exerciseNumber: 3,
  ...
  steps:
    ...
    - id: publish
      ...
      input:
        ...
        solution: 'Backstage template scaffolds new microservices. Developers fill form (name, owner), template creates Git repo with skeleton code, CI/CD, K8s manifests. Golden path automation.',
        explanation: 'Software templates automate service creation following best practices'
      },
      {
        exerciseNumber: 4,
...
spec:
  ...
  - max:
    ...
    type: __CONTAINER__`,
        ...
        solution: 'ResourceQuota limits namespace resources: 100 CPU cores, 200Gi memory, 50 PVCs, 5 LoadBalancers. LimitRange constrains container sizes: 100m-4 CPU, 128Mi-8Gi memory. Prevents cost overruns.',
        explanation: 'Resource quotas and limits control costs and prevent waste'
      },
      {
        exerciseNumber: 5,
  ...
  Developer Satisfaction:
    ...
    Measurement: quarterly_survey_nps`,
        ...
        solution: 'Platform SLOs measure success: provisioning speed (<5min), build success (>95%), deployment frequency (>10/day), uptime (99.9%), developer satisfaction (NPS>40). Data-driven improvements.',
  ...
  runGuided: {
    objective: 'Build production internal developer platform with self-service, golden paths, developer portal, and excellent developer experience',
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck: 'Install Backstage with npx create-app. Create catalog-info.yaml for each service. Register components. Integrate GitHub for auto-discovery. Add TechDocs plugin.'
      },
      {
        ...
        hintIfStuck: 'Install Crossplane and AWS provider. Create XRDs for PostgreSQL, S3. Define Compositions mapping to cloud resources. Add RBAC limiting provisioning. Test with kubectl apply.'
      },
      {
        ...
        hintIfStuck: 'Create Backstage Template with parameters. Skeleton includes app code, Dockerfile, CI/CD, K8s manifests. Steps: fetch template, publish to Git, register catalog, create ArgoCD app.'
      }
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective: 'Build production-grade internal developer platform with comprehensive self-service, automated golden paths, excellent developer experience, complete observability, and continuous improvement',
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 30,
        passingThreshold: 'Developers provision infrastructure without tickets. Crossplane XRDs for common resources. Backstage templates for workflows. RBAC enforcing guardrails. Cost controls active. Provisioning <5 minutes.'
      },
      {
        criterion: 'Developer Experience',
        weight: 30,
        passingThreshold: 'Service creation automated end-to-end. Clear documentation with examples. Build success >95%. Deployment frequency >10/day. Developer satisfaction NPS >40. Fast feedback on failures.'
      },
      {
        criterion: 'Platform Operations',
        weight: 20,
        passingThreshold: 'SLOs defined and tracked. Metrics dashboards showing health. Alerts on degradation. Cost visibility per team. Security controls enforced. Audit logging active. Backup and DR tested.'
      },
      {
        criterion: 'Continuous Improvement',
        weight: 20,
        passingThreshold: 'Regular developer surveys. Feedback channels active (Slack, office hours). Improvements prioritized by data. Changelog communicated. Adoption growing. Platform team responsive.'
      }
    ]
  },
