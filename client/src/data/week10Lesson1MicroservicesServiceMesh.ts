...
export const week10Lesson1MicroservicesServiceMesh: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Design microservices architectures and implement service mesh with Istio for traffic management, security, and observability.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Learn microservices and service mesh step-by-step. You will design microservices, deploy Istio, and configure traffic management.",
    expectedOutcome:
      "Complete understanding of microservices architecture patterns, service mesh concepts, Istio installation and configuration, traffic routing, mTLS, and distributed tracing",
    steps: [
      {
        stepNumber: 1,
        instruction: "Understand microservices architecture principles",
        command:
          'echo "Microservices Principles:\n1. Single Responsibility - Each service does one thing well\n2. Autonomous - Services deployed independently\n3. Decentralized - No central orchestration\n4. Resilient - Failures isolated and handled\n5. Observable - Comprehensive logging and monitoring\n6. API-First - Well-defined contracts"',
        explanation:
          "Microservices break monoliths into small, independent services. Each service has its own database, can be deployed separately, and communicates via APIs.",
      ...
      },
      {
        ...
        explanation:
          "Istio provides traffic management, security, and observability without changing application code. It uses sidecar proxies (Envoy) injected into each pod.",
      ...
      },
      {
        ...
        explanation:
          "Sidecar injection adds Envoy proxy container to every pod. The proxy intercepts all network traffic for traffic management and telemetry.",
        ...
        commonMistakes: [
          "Forgetting to restart pods after labeling",
          "Injection disabled",
        ],
      },
      {
        ...
        explanation:
          "Bookinfo app has 4 microservices: productpage (Python), details (Ruby), reviews (Java, 3 versions), ratings (Node.js). Demonstrates polyglot microservices.",
      ...
      },
      {
        ...
        explanation:
          "Gateway configures load balancer for external traffic. VirtualService routes traffic from Gateway to internal services.",
      ...
      },
      {
        ...
        explanation:
          'VirtualService routes 80% traffic to v1, 20% to v3 (canary). User "jason" always gets v2. DestinationRule defines service subsets based on labels.',
      ...
      },
      {
        ...
        explanation:
          "PeerAuthentication enforces mutual TLS between all services. STRICT mode requires mTLS, PERMISSIVE allows both encrypted and plaintext.",
        ...
        commonMistakes: [
          "Breaking external services",
          "Legacy apps not compatible",
        ],
      },
      {
        stepNumber: 8,
        ...
        explanation:
          "Timeout prevents hanging requests (1s total). Retries handle transient failures (3 attempts, 500ms each). RetryOn specifies error conditions.",
      ...
      },
      {
        ...
        explanation:
          "Circuit breaker limits connections and requests to prevent cascading failures. Outlier detection ejects unhealthy instances after 5 consecutive errors.",
      ...
      },
      {
        ...
        command:
          "kubectl apply -f https://raw.githubusercontent.com/istio/istio/release-1.20/samples/addons/jaeger.yaml && kubectl rollout status deployment/jaeger -n istio-system",
        explanation:
          "Jaeger collects traces from Envoy sidecars. Shows request flow through microservices, latencies, and failures. No application changes needed.",
      ...
      },
      {
        ...
        command:
          "kubectl apply -f https://raw.githubusercontent.com/istio/istio/release-1.20/samples/addons/kiali.yaml && kubectl rollout status deployment/kiali -n istio-system",
        explanation:
          "Kiali visualizes service mesh topology, traffic flow, health, and configuration. Shows which services communicate, error rates, latencies.",
      ...
      },
      {
        ...
        command:
          "kubectl apply -f - <<EOF\napiVersion: networking.istio.io/v1beta1\nkind: VirtualService\nmetadata:\n  name: reviews-mirror\nspec:\n  hosts:\n  - reviews\n  http:\n  - route:\n    - destination:\n        host: reviews\n        subset: v1\n      weight: 100\n    mirror:\n      host: reviews\n      subset: v3\n    mirrorPercentage:\n      value: 10.0\nEOF",
        explanation:
          "Traffic mirroring sends copy of production traffic to v3 for testing. 100% goes to v1 (production), 10% mirrored to v3. v3 responses discarded.",
  ...
  walk: {
    introduction:
      "Apply microservices and service mesh through hands-on exercises.",
    exercises: [
      {
        exerciseNumber: 1,
  ...
  - name: v2
    labels:
      version: v2`,
        ...
        solution:
          "VirtualService routes 90% to v1, 10% to v2 (canary deployment). DestinationRule defines subsets based on version labels. Use for gradual rollouts.",
        explanation:
          "Weighted routing enables safe canary deployments and A/B testing",
      },
      {
        exerciseNumber: 2,
  ...
  trafficPolicy:
    ...
    outlierDetection:
      ...
      maxEjectionPercent: 50`,
        ...
        solution:
          "Circuit breaker limits connections (100), requests per connection (2). Outlier detection ejects instances after 5 consecutive errors, checked every 30s. Prevents cascading failures.",
        explanation:
          "Circuit breakers protect services from overload and cascading failures",
      },
      {
        exerciseNumber: 3,
...
spec:
  ...
  - from:
    ...
    - operation:
        ...
        solution:
          "PeerAuthentication enforces STRICT mTLS (all traffic encrypted). AuthorizationPolicy allows only frontend service account to access backend with GET/POST. Implements zero-trust security.",
        explanation:
          "mTLS + authorization policies create zero-trust service-to-service security",
      },
      {
        exerciseNumber: 4,
...
spec:
  ...
  - timeout: __2S__
    ...
    - destination:
        ...
        solution:
          "Timeout limits total request to 2s. Retries up to 3 times with 500ms per attempt on 5xx errors, resets, connection failures. Handles transient failures without application code changes.",
        explanation:
          "Timeout and retry policies improve resilience without code changes",
      },
      {
        exerciseNumber: 5,
...
spec:
  ...
  - route:
    ...
    mirrorPercentage:
      value: __20.0__`,
        ...
        solution:
          "All production traffic (100%) goes to stable version. 20% is mirrored to canary for shadow testing. Canary responses ignored. Test new version with real traffic without affecting users.",
        explanation:
          "Traffic mirroring tests new versions with production traffic safely",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Build production microservices platform with Istio service mesh, traffic management, security, and observability",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck:
          "Install Istio with demo profile. Label namespace for injection. Deploy sample app. Verify 2 containers per pod. Install addons: Prometheus, Jaeger, Kiali.",
      },
      {
        ...
        hintIfStuck:
          "Create DestinationRule with v1/v2 subsets. VirtualService weights: 90/10. Monitor metrics. Increase canary weight gradually. Roll back if errors spike.",
      },
      {
        ...
        hintIfStuck:
          "Enable PeerAuthentication with STRICT mTLS. Create AuthorizationPolicy for service access. Add circuit breaker in DestinationRule. Configure timeout and retry in VirtualService.",
      },
    ],
    resourcesAllowed: [
      "Istio documentation",
  ...
  runIndependent: {
    objective:
      "Build production-grade microservices platform with complete service mesh, advanced traffic management, zero-trust security, comprehensive observability, and automated resilience",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 25,
        passingThreshold:
          "Istio control plane stable. Sidecars in all pods. Ingress/egress gateways configured. Namespaces organized. Resource limits set. Addons deployed (Prometheus, Jaeger, Kiali).",
      },
      {
        criterion: "Traffic Management",
        weight: 30,
        passingThreshold:
          "Canary deployments with weighted routing. A/B testing with header-based routing. Traffic mirroring for shadow testing. Gateway routing rules. Gradual rollout automation. Rollback capability.",
      },
      {
        criterion: "Security & Resilience",
        weight: 25,
        passingThreshold:
          "STRICT mTLS enforced. AuthorizationPolicy for access control. Circuit breakers preventing cascade failures. Timeouts and retries configured. Rate limiting active. No security misconfigurations.",
      },
      {
        criterion: "Observability",
        weight: 20,
        passingThreshold:
          "Distributed tracing tracking requests across services. Metrics exported to Prometheus. Kiali showing real-time topology. Grafana dashboards for traffic, errors, latency. Alerts on anomalies. Logs centralized.",
      },
    ],
  },
