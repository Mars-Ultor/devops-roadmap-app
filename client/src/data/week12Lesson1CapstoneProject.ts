...
export const week12Lesson1CapstoneProject: LeveledLessonContent = {
  ...
  baseLesson: {
    ...
    description:
      "Build comprehensive DevOps portfolio project demonstrating cloud infrastructure, CI/CD, monitoring, security, and platform engineering skills.",
    learningObjectives: [
  ...
  crawl: {
    introduction:
      "Build your capstone DevOps portfolio project step-by-step. You will create production-grade infrastructure, CI/CD pipelines, monitoring, and comprehensive documentation.",
    expectedOutcome:
      "Complete portfolio project with infrastructure as code, GitOps deployment, observability, security scanning, cost optimization, and professional documentation",
    steps: [
      {
        stepNumber: 1,
        ...
        explanation:
          "Architecture document defines project scope: multi-tier application, cloud-native infrastructure, complete CI/CD, observability, security. Portfolio demonstrates production readiness.",
        ...
        commonMistakes: [
          "Too simple (just deployment)",
          "Too complex (never finish)",
        ],
      },
      {
        stepNumber: 2,
        ...
        command:
          'mkdir -p infrastructure/{modules/{vpc,eks,rds,monitoring},environments/{dev,staging,prod}} && cat > infrastructure/main.tf <<EOF\nterraform {\n  required_version = ">= 1.6"\n  \n  backend "s3" {\n    bucket         = "my-terraform-state"\n    key            = "capstone/terraform.tfstate"\n    region         = "us-east-1"\n    dynamodb_table = "terraform-locks"\n    encrypt        = true\n  }\n  \n  required_providers {\n    aws = {\n      source  = "hashicorp/aws"\n      version = "~> 5.0"\n    }\n    kubernetes = {\n      source  = "hashicorp/kubernetes"\n      version = "~> 2.23"\n    }\n  }\n}\n\nmodule "vpc" {\n  source = "./modules/vpc"\n  \n  environment = var.environment\n  cidr_block  = var.vpc_cidr\n}\n\nmodule "eks" {\n  source = "./modules/eks"\n  \n  environment    = var.environment\n  vpc_id         = module.vpc.vpc_id\n  subnet_ids     = module.vpc.private_subnet_ids\n  cluster_name   = "${var.environment}-cluster"\n}\n\nmodule "rds" {\n  source = "./modules/rds"\n  \n  environment       = var.environment\n  vpc_id            = module.vpc.vpc_id\n  subnet_ids        = module.vpc.database_subnet_ids\n  instance_class    = var.rds_instance_class\n}\nEOF',
        explanation:
          "Terraform workspace with modules for reusability, S3 backend for state, multi-environment support. Demonstrates IaC best practices.",
        ...
        commonMistakes: [
          "No modules (not reusable)",
          "Local state (not collaborative)",
        ],
      },
      {
        stepNumber: 3,
        ...
        command:
          'mkdir -p app/backend && cat > app/backend/Dockerfile <<EOF\n# Multi-stage build for efficiency\nFROM node:20-alpine AS builder\nWORKDIR /app\nCOPY package*.json ./\nRUN npm ci --only=production\nCOPY . .\nRUN npm run build\n\n# Production image\nFROM node:20-alpine\nWORKDIR /app\n\n# Security: non-root user\nRUN addgroup -g 1001 -S nodejs && adduser -S nodejs -u 1001\n\nCOPY --from=builder --chown=nodejs:nodejs /app/dist ./dist\nCOPY --from=builder --chown=nodejs:nodejs /app/node_modules ./node_modules\n\nUSER nodejs\nEXPOSE 3000\n\nHEALTHCHECK --interval=30s --timeout=3s --start-period=5s --retries=3 \\\\\n  CMD node healthcheck.js\n\nCMD ["node", "dist/index.js"]\nEOF',
        explanation:
          "Multi-stage Dockerfile: builder stage compiles, production stage minimal. Non-root user for security, healthcheck for reliability. Production-ready container.",
      ...
      },
      {
        ...
        explanation:
          "CI pipeline: test (unit tests, coverage), security-scan (Trivy), build-push (ECR). Runs on PR, deploys on main merge. Quality gates before deployment.",
      ...
      },
      {
        ...
        command:
          "mkdir -p k8s/{base,overlays/{dev,staging,prod}} && cat > k8s/base/deployment.yaml <<EOF\napiVersion: apps/v1\nkind: Deployment\nmetadata:\n  name: app\nspec:\n  replicas: 2\n  selector:\n    matchLabels:\n      app: backend\n  template:\n    metadata:\n      labels:\n        app: backend\n        version: v1\n    spec:\n      containers:\n      - name: app\n        image: REGISTRY/app:TAG\n        ports:\n        - containerPort: 3000\n        env:\n        - name: NODE_ENV\n          value: production\n        - name: DB_HOST\n          valueFrom:\n            secretKeyRef:\n              name: db-credentials\n              key: host\n        resources:\n          requests:\n            cpu: 100m\n            memory: 128Mi\n          limits:\n            cpu: 500m\n            memory: 512Mi\n        livenessProbe:\n          httpGet:\n            path: /health\n            port: 3000\n          initialDelaySeconds: 30\n          periodSeconds: 10\n        readinessProbe:\n          httpGet:\n            path: /ready\n            port: 3000\n          initialDelaySeconds: 5\n          periodSeconds: 5\nEOF",
        explanation:
          "Kubernetes Deployment with resource limits, health probes, secrets from external store. Kustomize base with environment overlays for DRY configuration.",
      ...
      },
      {
        ...
        explanation:
          "ArgoCD Application with automated sync, self-heal, pruning. Git as single source of truth. Ignores HPA-managed replica count. Production GitOps.",
      ...
      },
      {
        ...
        explanation:
          "Prometheus with 30-day retention, persistent storage, automatic pod discovery. Scrapes app metrics, sends alerts to AlertManager. Grafana for visualization.",
      ...
      },
      {
        ...
        command:
          "cat > logging/loki-stack.yaml <<EOF\nloki:\n  persistence:\n    enabled: true\n    size: 50Gi\n  config:\n    schema_config:\n      configs:\n      - from: 2024-01-01\n        store: boltdb-shipper\n        object_store: s3\n        schema: v11\n        index:\n          prefix: loki_index_\n          period: 24h\n    storage_config:\n      aws:\n        s3: s3://us-east-1/loki-logs\n        bucketnames: loki-logs\n    limits_config:\n      retention_period: 30d\n\npromtail:\n  config:\n    clients:\n    - url: http://loki:3100/loki/api/v1/push\n    snippets:\n      scrapeConfigs: |\n        - job_name: kubernetes-pods\n          kubernetes_sd_configs:\n          - role: pod\n          relabel_configs:\n          - source_labels: [__meta_kubernetes_pod_label_app]\n            target_label: app\n          - source_labels: [__meta_kubernetes_namespace]\n            target_label: namespace\nEOF",
        explanation:
          "Loki for log aggregation with S3 storage, 30-day retention. Promtail collects pod logs, labels with app/namespace. Query logs in Grafana.",
      ...
      },
      {
        ...
        command:
          "cat > tracing/jaeger.yaml <<EOF\napiVersion: jaegertracing.io/v1\nkind: Jaeger\nmetadata:\n  name: jaeger\nspec:\n  strategy: production\n  \n  storage:\n    type: elasticsearch\n    options:\n      es:\n        server-urls: http://elasticsearch:9200\n    esIndexCleaner:\n      enabled: true\n      numberOfDays: 7\n  \n  ingress:\n    enabled: true\n    annotations:\n      kubernetes.io/ingress.class: nginx\n    hosts:\n    - jaeger.example.com\nEOF",
        explanation:
          "Jaeger distributed tracing with Elasticsearch backend, 7-day retention. Traces requests across microservices, identifies bottlenecks. Production observability complete.",
      ...
      },
      {
        ...
        explanation:
          "Professional README showcasing: architecture, tech stack, CI/CD flow, observability, security measures. Clear setup instructions. Demonstrates communication skills.",
  ...
  tags = {
    ...
    Project     = "portfolio"
        ...
        solution:
          "EKS module creates managed Kubernetes cluster with node group: 2-5 t3.medium instances in private subnets. Demonstrates IaC modularity and reusability.",
        explanation:
          "Terraform modules make infrastructure reusable across environments",
      },
      {
        exerciseNumber: 2,
...
spec:
  ...
  syncPolicy:
    ...
    - CreateNamespace=__TRUE__`,
        ...
        solution:
          "ArgoCD Application deploys from Git (main/k8s/overlays/prod) to production namespace. Automated sync with prune and self-heal. GitOps in action.",
        explanation:
  ...
  "dashboard": {
    ...
    "panels": [
      ...
      },
      {
        ...
        solution:
          "SLO dashboard tracks: 99.9% availability (success rate), p95 latency <500ms, error budget remaining (30-day window). SRE practices demonstrated.",
        explanation:
          "SLOs define reliability targets; error budgets balance velocity and stability",
      },
      {
        exerciseNumber: 4,
  ...
  build:
    ...
    steps:
      ...
      - run: docker build -t app:latest .`,
        ...
        solution:
          "CI pipeline: test job (unit tests + coverage), security job (Trivy vulnerability scan), build job (only on main after tests pass). Quality gates enforced.",
        explanation:
          "Automated CI with quality gates ensures code quality before deployment",
      },
      {
        exerciseNumber: 5,
...
- __GITOPS__ deployment`,
        ...
        solution:
          "Professional README documents: architecture, tech stack, CI/CD flow, observability stack, skills demonstrated. Clear, concise, comprehensive. Portfolio-ready.",
        explanation:
          "Documentation demonstrates communication skills and professionalism",
      },
    ],
    hints: [
  ...
  runGuided: {
    objective:
      "Build complete DevOps portfolio project with production infrastructure, CI/CD, monitoring, security, and documentation",
    conceptualGuidance: [
    ...
    checkpoints: [
      {
        ...
        hintIfStuck:
          "Create Terraform modules following DRY principle. Use S3 backend for state. Define variables for environment-specific configs. Apply to dev first, then staging/prod.",
      },
      {
        ...
        hintIfStuck:
          "Create .github/workflows/ci.yml with jobs: test, security, build. Use needs to enforce order. Push images to ECR. ArgoCD watches for new images.",
      },
      {
        ...
        hintIfStuck:
          "Install kube-prometheus-stack. Add Loki-stack. Deploy Jaeger operator. Create Grafana dashboards for SLOs. Configure alerts for SLO violations.",
      },
    ],
    resourcesAllowed: [
  ...
  runIndependent: {
    objective:
      "Build production-grade DevOps portfolio project demonstrating complete infrastructure, CI/CD, observability, security, SRE practices, and professional documentation",
    successCriteria: [
    ...
    evaluationRubric: [
      {
        ...
        weight: 25,
        passingThreshold:
          "Terraform modules for all infrastructure. Remote state with locking. Multi-environment (dev/staging/prod). Resources properly sized and tagged. Security groups restrictive. Costs optimized.",
      },
      {
        criterion: "CI/CD & GitOps",
        weight: 25,
        passingThreshold:
          "Automated CI with tests, coverage, security scanning. Quality gates enforced. GitOps with ArgoCD automated sync. Deployment <10min. Rollback functional. Multi-environment promotion.",
      },
      {
        criterion: "Observability & SRE",
        weight: 25,
        passingThreshold:
          "Complete stack: Prometheus, Grafana, Loki, Jaeger. SLOs defined and tracked. Error budgets calculated. Alerts configured. Dashboards comprehensive. DORA metrics visible.",
      },
      {
        criterion: "Documentation & Presentation",
        weight: 25,
        passingThreshold:
          "Professional README with architecture, setup, monitoring. Portfolio highlights with achievements and metrics. Technical decisions explained. Live demo available. Communication clear.",
      },
    ],
  },
