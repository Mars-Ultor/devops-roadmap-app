...
export const publicRoutes: readonly RouteConfig[] = [
  ...
  { path: '/register', element: <Register />, requiresAuth: false, guestOnly: true },
] as const;
...
export const protectedRoutes: readonly RouteConfig[] = [
  ...
  { path: '/learning-settings', element: <LearningSettings />, requiresAuth: true },
  { path: '/training', element: <Training />, requiresAuth: true },
  { path: '/week/:weekNumber', element: <Week />, requiresAuth: true },
  { path: '/week/:weekNumber/project', element: <ContentGate contentType="general"><WeekProject /></ContentGate>, requiresAuth: true },
  { path: '/week/:weekNumber/assessment', element: <ContentGate contentType="general"><WeekAssessment /></ContentGate>, requiresAuth: true },
  { path: '/lesson/:lessonId/:level', element: <ContentGate contentType="lesson"><MasteryLesson /></ContentGate>, requiresAuth: true },
  { path: '/quiz/:quizId', element: <ContentGate contentType="quiz"><QuizPage /></ContentGate>, requiresAuth: true },
  { path: '/lab/:labId', element: <ContentGate contentType="lab"><Lab /></ContentGate>, requiresAuth: true },
  { path: '/battle-drills', element: <BattleDrills />, requiresAuth: true },
  { path: '/battle-drill/:drillId', element: <BattleDrillSession />, requiresAuth: true },
  ...
  { path: '/accountability', element: <AccountabilityDashboard />, requiresAuth: true },
  { path: '/difficulty', element: <AdaptiveDifficultyDashboard />, requiresAuth: true },
  ...
  { path: '/scenario/:scenarioId', element: <ScenarioExecution />, requiresAuth: true },
  { path: '/ai-coaching', element: <AICoaching />, requiresAuth: true },
  { path: '/recertification', element: <RecertificationDashboard />, requiresAuth: true },
] as const;
