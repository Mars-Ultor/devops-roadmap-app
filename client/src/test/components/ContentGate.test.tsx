...
const AnyContentGate = ContentGate as unknown as (
  props: unknown,
) => ReactElement;
...
describe("ContentGate", () => {
  ...
  it("shows loading state initially", () => {
    ...
    expect(
      screen.getByText("Checking daily drill status..."),
    ).toBeInTheDocument();
  });
  ...
  it("blocks access when daily drill is not completed", async () => {
    ...
    expect(
      screen.getByText("Complete your daily drill to unlock training content"),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("button", { name: /start daily drill/i }),
    ).toBeInTheDocument();
  });
  ...
  it("explains why daily drills matter", async () => {
    ...
    expect(
      screen.getByText(/combat progressive training/i),
    ).toBeInTheDocument();
  });
