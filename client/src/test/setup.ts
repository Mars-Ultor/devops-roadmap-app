...
vi.mock("lucide-react", () => ({
  CheckCircle: () =>
    React.createElement("div", { "data-testid": "check-circle" }),
  CheckCircle2: () =>
    React.createElement("div", { "data-testid": "check-circle-2" }),
  XCircle: () => React.createElement("div", { "data-testid": "x-circle" }),
  AlertTriangle: () =>
    React.createElement("div", { "data-testid": "alert-triangle" }),
  AlertCircle: () =>
    React.createElement("div", { "data-testid": "alert-circle" }),
  ...
  ChevronRight: () =>
    React.createElement("div", { "data-testid": "chevron-right" }),
  ...
  TrendingUp: () =>
    React.createElement("div", { "data-testid": "trending-up" }),
  TrendingDown: () =>
    React.createElement("div", { "data-testid": "trending-down" }),
  ...
  CircleAlert: () =>
    React.createElement("div", { "data-testid": "circle-alert" }),
  Funnel: () => React.createElement("div", { "data-testid": "funnel" }),
  ExternalLink: () =>
    React.createElement("div", { "data-testid": "external-link" }),
  ...
  ArrowRight: () =>
    React.createElement("div", { "data-testid": "arrow-right" }),
  ArrowLeft: () => React.createElement("div", { "data-testid": "arrow-left" }),
  CircleCheckBig: () =>
    React.createElement("div", { "data-testid": "circle-check-big" }),
