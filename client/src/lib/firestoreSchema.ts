 ...
 */
export async function initializeUserTrainingState(userId: string, currentWeek: number = 1) {
  try {
 ...
 */
export async function initializeLessonMastery(userId: string, lessonId: string) {
 ...
 */
export async function initializeBattleDrillPerformance(userId: string, drillId: string) {
  const performanceRef = doc(db, 'battleDrillPerformance', `${userId}_${drillId}`);
 ...
 */
export async function checkDailyDrillStatus(userId: string): Promise<DailyDrill | null> {
 ...
 */
export async function consumeResetToken(userId: string, currentWeek: number): Promise<boolean> {
 ...
 */
export async function refreshPerformanceMetrics(userId: string): Promise<PerformanceMetrics> {
